...
* GUI::                     GUI routines
@end menu
@node Using, Structures, API, API
@section Using Allegro
...
* cpu_capabilities::
@end menu
@node install_allegro, allegro_init, , Using
@subsection install_allegro
@ftable @asis
@item @t{int install_allegro(int system_id, int *errno_ptr, int (*atexit_ptr)());}
...
install_allegro(SYSTEM_AUTODETECT, &errno, atexit);@end example
...
@xref{allegro_exit}.@*
@xref{set_uformat}.@*
@xref{set_config_file}.@*
@node allegro_init, allegro_exit, install_allegro, Using
@subsection allegro_init
@ftable @asis
@item @t{int allegro_init();}
...
@end ftable
See also:@*
@xref{install_allegro}.@*
@xref{allegro_exit}.@*
@xref{Available, Available Allegro examples}.@*
@node allegro_exit, END_OF_MAIN, allegro_init, Using
@subsection allegro_exit
@ftable @asis
@item @t{void allegro_exit();}
...
@xref{exxfade}.@*
@xref{exzbuf}.@*
@node END_OF_MAIN, allegro_id, allegro_exit, Using
@subsection END_OF_MAIN
@ftable @asis
@item @t{Macro END_OF_MAIN()}
...
@{
   ...
   return 0;
@}
END_OF_MAIN()@end example


@end ftable
See also:@*
@xref{Windows, Windows specifics}.@*
@xref{Unix, Unix specifics}.@*
@xref{MacOS, MacOS X specifics}.@*
@xref{Differences, Differences between platforms}.@*
@xref{Available, Available Allegro examples}.@*
@node allegro_id, allegro_error, END_OF_MAIN, Using
@subsection allegro_id
@ftable @asis
@item @t{extern char allegro_id[];}
Text string containing a date and version number for the library, in case 
you want to display these somewhere.

@end ftable
@node allegro_error, ALLEGRO_VERSION, allegro_id, Using
@subsection allegro_error
@ftable @asis
@item @t{extern char allegro_error[ALLEGRO_ERROR_SIZE];}
...
...
   if (some_allegro_function() == ERROR_CODE)
      abort_on_error("Error calling some function!");@end example
...
@xref{install_sound}.@*
@xref{Available, Available Allegro examples}.@*
@node ALLEGRO_VERSION, ALLEGRO_SUB_VERSION, allegro_error, Using
@subsection ALLEGRO_VERSION
@ftable @asis
@item @t{#define ALLEGRO_VERSION}
Defined to the major version of Allegro. From a version number like
4.1.16, this would be defined to the integer 4.

@end ftable
@node ALLEGRO_SUB_VERSION, ALLEGRO_WIP_VERSION, ALLEGRO_VERSION, Using
@subsection ALLEGRO_SUB_VERSION
@ftable @asis
@item @t{#define ALLEGRO_SUB_VERSION}
Defined to the middle version of Allegro. From a version number like
4.1.16, this would be defined to the integer 1.

@end ftable
@node ALLEGRO_WIP_VERSION, ALLEGRO_VERSION_STR, ALLEGRO_SUB_VERSION, Using
@subsection ALLEGRO_WIP_VERSION
@ftable @asis
@item @t{#define ALLEGRO_WIP_VERSION}
Defined to the minor version of Allegro. From a version number like
4.1.16, this would be defined to the integer 16.

@end ftable
@node ALLEGRO_VERSION_STR, ALLEGRO_DATE_STR, ALLEGRO_WIP_VERSION, Using
@subsection ALLEGRO_VERSION_STR
@ftable @asis
@item @t{#define ALLEGRO_VERSION_STR}
...
@end ftable
@node ALLEGRO_DATE_STR, ALLEGRO_DATE, ALLEGRO_VERSION_STR, Using
@subsection ALLEGRO_DATE_STR
@ftable @asis
@item @t{#define ALLEGRO_DATE_STR}
Defined to a text string containing the year this version of Allegro was
released, like `2004'.

@end ftable
@node ALLEGRO_DATE, AL_ID, ALLEGRO_DATE_STR, Using
@subsection ALLEGRO_DATE
@ftable @asis
@item @t{#define ALLEGRO_DATE}
...
allegro_message("Year %d, month %d, day %d\n",
   year, month, day);@end example


@end ftable
@node AL_ID, MAKE_VERSION, ALLEGRO_DATE, Using
@subsection AL_ID
@ftable @asis
@item @t{Macro AL_ID(a,b,c,d)}
...
#define OSTYPE_LINUX       AL_ID('T','U','X',' ')@end example


@end ftable
See also:@*
@xref{DAT_ID}.@*
@node MAKE_VERSION, os_type, AL_ID, Using
@subsection MAKE_VERSION
@ftable @asis
@item @t{Macro MAKE_VERSION(a, b, c)}
...
@end ftable
See also:@*
@xref{ALLEGRO_VERSION}.@*
@xref{ALLEGRO_SUB_VERSION}.@*
@xref{ALLEGRO_WIP_VERSION}.@*
@node os_type, os_version, MAKE_VERSION, Using
@subsection os_type
@ftable @asis
@item @t{extern int os_type;}
...
OSTYPE_BEOS       - BeOS
OSTYPE_MACOS      - MacOS
OSTYPE_MACOSX     - MacOS X@end example
...
@xref{allegro_init}.@*
@xref{os_version}.@*
@xref{os_multitasking}.@*
@node os_version, os_multitasking, os_type, Using
@subsection os_version
@ftable @asis
@item @t{extern int os_version;}
@end ftable
@ftable @asis
@item @t{extern int os_revision;}
...
@xref{os_type}.@*
@xref{os_multitasking}.@*
@node os_multitasking, allegro_message, os_version, Using
@subsection os_multitasking
@ftable @asis
@item @t{extern int os_multitasking;}
...
@xref{os_type}.@*
@xref{os_version}.@*
@node allegro_message, set_window_title, os_multitasking, Using
@subsection allegro_message
@ftable @asis
@item @t{void allegro_message(const char *text_format, ...);}
...
@xref{set_uformat}.@*
@xref{Available, Available Allegro examples}.@*
@node set_window_title, set_close_button_callback, allegro_message, Using
@subsection set_window_title
@ftable @asis
@item @t{void set_window_title(const char *name);}
...
set_window_title("Allegro rules!");@end example
...
@xref{set_uformat}.@*
@xref{exunicod}.@*
@node set_close_button_callback, desktop_color_depth, set_window_title, Using
@subsection set_close_button_callback
@ftable @asis
@item @t{int set_close_button_callback(void (*proc)(void));}
...
@node desktop_color_depth, get_desktop_resolution, set_close_button_callback, Using
@subsection desktop_color_depth
@ftable @asis
@item @t{int desktop_color_depth();}
...
@end ftable
See also:@*
@xref{get_desktop_resolution}.@*
@xref{set_color_depth}.@*
@xref{set_gfx_mode}.@*
@node get_desktop_resolution, check_cpu, desktop_color_depth, Using
@subsection get_desktop_resolution
@ftable @asis
@item @t{int get_desktop_resolution(int *width, int *height);}
...
@xref{set_gfx_mode}.@*
@node check_cpu, cpu_vendor, get_desktop_resolution, Using
@subsection check_cpu
@ftable @asis
@item @t{void check_cpu();}
...
@xref{allegro_init}.@*
@node cpu_vendor, cpu_family, check_cpu, Using
@subsection cpu_vendor
@ftable @asis
@item @t{extern char cpu_vendor[];}
...
@xref{cpu_capabilities}.@*
@xref{allegro_init}.@*
@node cpu_family, cpu_model, cpu_vendor, Using
@subsection cpu_family
@ftable @asis
@item @t{extern int cpu_family;}
...
@xref{cpu_capabilities}.@*
@xref{allegro_init}.@*
@node cpu_model, cpu_capabilities, cpu_family, Using
@subsection cpu_model
@ftable @asis
@item @t{extern int cpu_model;}
...
@xref{cpu_capabilities}.@*
@xref{allegro_init}.@*
@node cpu_capabilities, fixed, cpu_model, Using
@subsection cpu_capabilities
@ftable @asis
@item @t{extern int cpu_capabilities;}
...
@xref{cpu_capabilities}.@*
@xref{allegro_init}.@*
@node Structures, Unicode, Using, API
@section Structures and types defined by Allegro
...
* LZSS_UNPACK_DATA::
@end menu
@node fixed, BITMAP, cpu_capabilities, Structures
@subsection fixed
@ftable @asis
@item @t{typedef long fixed}
...
@end ftable
See also:@*
@xref{Fixed, Fixed point math routines}.@*
@xref{ex12bit}.@*
@xref{ex3buf}.@*
@xref{ex3d}.@*
@xref{excustom}.@*
...
@xref{exstars}.@*
@xref{exupdate}.@*
@node BITMAP, RLE_SPRITE, fixed, Structures
@subsection BITMAP
@ftable @asis
@item @t{typedef struct BITMAP}
@example
...
@xref{create_bitmap}.@*
@xref{set_clip_rect}.@*
@xref{bitmap_color_depth}.@*
@xref{RLE_SPRITE}.@*
@xref{COMPILED_SPRITE}.@*
@xref{Direct, Direct access to video memory}.@*
@xref{Available, Available Allegro examples}.@*
@node RLE_SPRITE, COMPILED_SPRITE, BITMAP, Structures
@subsection RLE_SPRITE
@ftable @asis
@item @t{typedef struct RLE_SPRITE}
@example
...
@xref{BITMAP}.@*
@xref{COMPILED_SPRITE}.@*
@xref{RLE, RLE sprites}.@*
@node COMPILED_SPRITE, JOYSTICK_INFO, RLE_SPRITE, Structures
@subsection COMPILED_SPRITE
@ftable @asis
@item @t{typedef struct COMPILED_SPRITE}
@example
...
@xref{BITMAP}.@*
@xref{RLE_SPRITE}.@*
@xref{Compiled, Compiled sprites}.@*
@node JOYSTICK_INFO, JOYSTICK_BUTTON_INFO, COMPILED_SPRITE, Structures
@subsection JOYSTICK_INFO
@ftable @asis
@item @t{typedef struct JOYSTICK_INFO}
@example
...
See also:@*
@xref{joy}.@*
@xref{Joystick, Joystick routines}.@*
@node JOYSTICK_BUTTON_INFO, JOYSTICK_STICK_INFO, JOYSTICK_INFO, Structures
@subsection JOYSTICK_BUTTON_INFO
@ftable @asis
@item @t{typedef struct JOYSTICK_BUTTON_INFO}
@example
...
@xref{joy}.@*
@xref{Joystick, Joystick routines}.@*
@node JOYSTICK_STICK_INFO, JOYSTICK_AXIS_INFO, JOYSTICK_BUTTON_INFO, Structures
@subsection JOYSTICK_STICK_INFO
@ftable @asis
@item @t{typedef struct JOYSTICK_STICK_INFO}
@example
...
@xref{joy}.@*
@xref{Joystick, Joystick routines}.@*
@node JOYSTICK_AXIS_INFO, GFX_MODE_LIST, JOYSTICK_STICK_INFO, Structures
@subsection JOYSTICK_AXIS_INFO
@ftable @asis
@item @t{typedef struct JOYSTICK_AXIS_INFO}
@example
...
@xref{joy}.@*
@xref{Joystick, Joystick routines}.@*
@node GFX_MODE_LIST, GFX_MODE, JOYSTICK_AXIS_INFO, Structures
@subsection GFX_MODE_LIST
@ftable @asis
@item @t{typedef struct GFX_MODE_LIST}
@example
...
See also:@*
@xref{GFX_MODE}.@*
@xref{get_gfx_mode_list}.@*
@node GFX_MODE, PAL_SIZE, GFX_MODE_LIST, Structures
@subsection GFX_MODE
@ftable @asis
@item @t{typedef struct GFX_MODE}
@example
...
@xref{GFX_MODE_LIST}.@*
@xref{get_gfx_mode_list}.@*
@node PAL_SIZE, PALETTE, GFX_MODE, Structures
@subsection PAL_SIZE
@ftable @asis
@item @t{#define PAL_SIZE}
...
@xref{PALETTE}.@*
@xref{COLOR_MAP}.@*
@node PALETTE, RGB, PAL_SIZE, Structures
@subsection PALETTE
@ftable @asis
@item @t{typedef PALETTE RGB[PAL_SIZE]}
Allegro palettes are arrays of PAL_SIZE RGB entries.

@end ftable
See also:@*
@xref{RGB}.@*
@xref{Palette, Palette routines}.@*
@xref{Available, Available Allegro examples}.@*
@node RGB, V3D, PALETTE, Structures
@subsection RGB
@ftable @asis
@item @t{typedef struct RGB}
@example
...
@xref{extrans}.@*
@xref{extruec}.@*
@node V3D, V3D_f, RGB, Structures
@subsection V3D
@ftable @asis
@item @t{typedef struct V3D}
@example
...
@xref{ex3d}.@*
@node V3D_f, COLOR_MAP, V3D, Structures
@subsection V3D_f
@ftable @asis
@item @t{typedef struct V3D_f}
@example
...
See also:@*
@xref{V3D}.@*
@xref{polygon3d, polygon3d_f}.@*
@xref{Fixed point trig}.@*
@xref{excamera}.@*
@xref{exscn3d}.@*
@xref{exzbuf}.@*
@node COLOR_MAP, RGB_MAP, V3D_f, Structures
@subsection COLOR_MAP
@ftable @asis
@item @t{typedef struct COLOR_MAP}
@example
...
@xref{exshade}.@*
@xref{extrans}.@*
@node RGB_MAP, al_ffblk, COLOR_MAP, Structures
@subsection RGB_MAP
@ftable @asis
@item @t{typedef struct RGB_MAP}
@example
...
@end ftable
See also:@*
@xref{Converting, Converting between color formats}.@*
@xref{create_rgb_table}.@*
@xref{ex3d}.@*
@xref{excolmap}.@*
@xref{exrgbhsv}.@*
@xref{exshade}.@*
@xref{extrans}.@*
@node al_ffblk, DATAFILE, RGB_MAP, Structures
@subsection al_ffblk
@ftable @asis
@item @t{struct al_ffblk}
@example
...
See also:@*
@xref{al_findfirst}.@*
@xref{al_ffblk_get_size}.@*
@node DATAFILE, MATRIX, al_ffblk, Structures
@subsection DATAFILE
@ftable @asis
@item @t{typedef struct DATAFILE}
@example
...
@xref{exsprite}.@*
@xref{exunicod}.@*
@node MATRIX, MATRIX_f, DATAFILE, Structures
@subsection MATRIX
@ftable @asis
@item @t{typedef struct MATRIX}
@example
...
See also:@*
@xref{MATRIX_f}.@*
@xref{3D, 3D math routines}.@*
@xref{ex12bit}.@*
@xref{ex3d}.@*
@xref{exstars}.@*
@node MATRIX_f, QUAT, MATRIX, Structures
@subsection MATRIX_f
@ftable @asis
@item @t{typedef struct MATRIX_f}
@example
...
@xref{exscn3d}.@*
@xref{exzbuf}.@*
@node QUAT, DIALOG, MATRIX_f, Structures
@subsection QUAT
@ftable @asis
@item @t{typedef struct QUAT}
@example
...
@end ftable
See also:@*
@xref{Quaternion, Quaternion math routines}.@*
@xref{exquat}.@*
@node DIALOG, MENU, QUAT, Structures
@subsection DIALOG
@ftable @asis
@item @t{typedef struct DIALOG}
@example
...
See also:@*
@xref{do_dialog}.@*
@xref{GUI, GUI routines}.@*
@xref{excustom}.@*
@xref{exgui}.@*
@xref{exrgbhsv}.@*
@node MENU, DIALOG_PLAYER, DIALOG, Structures
@subsection MENU
@ftable @asis
@item @t{typedef struct MENU}
@example
...
@xref{GUI menus}.@*
@xref{exgui}.@*
@node DIALOG_PLAYER, MENU_PLAYER, MENU, Structures
@subsection DIALOG_PLAYER
@ftable @asis
@item @t{typedef struct DIALOG_PLAYER}
...
@xref{init_dialog}.@*
@xref{update_dialog}.@*
@xref{shutdown_dialog}.@*
@xref{GUI, GUI routines}.@*
@node MENU_PLAYER, FONT, DIALOG_PLAYER, Structures
@subsection MENU_PLAYER
@ftable @asis
@item @t{typedef struct MENU_PLAYER}
A structure which holds GUI data used internally by Allegro. Read the
...
@xref{shutdown_menu}.@*
@xref{GUI menus}.@*
@node FONT, ZBUFFER, MENU_PLAYER, Structures
@subsection FONT
@ftable @asis
@item @t{typedef struct FONT}
...
@xref{exfont}.@*
@xref{exunicod}.@*
@node ZBUFFER, SAMPLE, FONT, Structures
@subsection ZBUFFER
@ftable @asis
@item @t{typedef struct BITMAP ZBUFFER}
...
@end ftable
See also:@*
@xref{Zbuffered rendering}.@*
@xref{BITMAP}.@*
@xref{exzbuf}.@*
@xref{BITMAP}.@*
@node SAMPLE, MIDI, ZBUFFER, Structures
@subsection SAMPLE
@ftable @asis
@item @t{typedef struct SAMPLE}
@example
...
See also:@*
@xref{load_sample}.@*
@xref{Digital, Digital sample routines}.@*
@xref{Voice control}.@*
@xref{exsample}.@*
@node MIDI, AUDIOSTREAM, SAMPLE, Structures
@subsection MIDI
@ftable @asis
@item @t{typedef struct MIDI}
...
See also:@*
@xref{load_midi}.@*
@xref{Music, Music routines (MIDI)}.@*
@xref{exmidi}.@*
@node AUDIOSTREAM, PACKFILE, MIDI, Structures
@subsection AUDIOSTREAM
@ftable @asis
@item @t{typedef struct AUDIOSTREAM}
@example
...
@xref{Audio, Audio stream routines}.@*
@xref{Voice control}.@*
@xref{exstream}.@*
@node PACKFILE, PACKFILE_VTABLE, AUDIOSTREAM, Structures
@subsection PACKFILE
@ftable @asis
@item @t{typedef struct PACKFILE}
...
@end ftable
See also:@*
@xref{File, File and compression routines}.@*
@xref{pack_fopen}.@*
@xref{pack_fopen_chunk}.@*
@xref{pack_fopen_vtable}.@*
@xref{expackf}.@*
@node PACKFILE_VTABLE, LZSS_PACK_DATA, PACKFILE, Structures
@subsection PACKFILE_VTABLE
@ftable @asis
@item @t{typedef struct PACKFILE_VTABLE}
@example
...
@xref{pack_fopen_vtable}.@*
@xref{expackf}.@*
@node LZSS_PACK_DATA, LZSS_UNPACK_DATA, PACKFILE_VTABLE, Structures
@subsection LZSS_PACK_DATA
@ftable @asis
@item @t{typedef struct LZSS_PACK_DATA}
...
@node LZSS_UNPACK_DATA, set_uformat, LZSS_PACK_DATA, Structures
@subsection LZSS_UNPACK_DATA
@ftable @asis
@item @t{typedef struct LZSS_UNPACK_DATA}
...
@node Unicode, Configuration, Structures, API
@section Unicode routines
...
* uvszprintf::
@end menu
@node set_uformat, get_uformat, LZSS_UNPACK_DATA, Unicode
@subsection set_uformat
@ftable @asis
@item @t{void set_uformat(int type);}
...
@xref{allegro_init}.@*
@xref{exunicod}.@*
@node get_uformat, register_uformat, set_uformat, Unicode
@subsection get_uformat
@ftable @asis
@item @t{int get_uformat(void);}
...
See also:@*
@xref{set_uformat}.@*
@node register_uformat, set_ucodepage, get_uformat, Unicode
@subsection register_uformat
@ftable @asis
@item @t{void register_uformat(int type, int (*u_getc)(const char *s), int (*u_getx)(char **s), int (*u_setc)(char *s, int c), int (*u_width)(const char *s), int (*u_cwidth)(int c), int (*u_isok)(int c));}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node set_ucodepage, need_uconvert, register_uformat, Unicode
@subsection set_ucodepage
@ftable @asis
@item @t{void set_ucodepage(const unsigned short *table, const unsigned short *extras);}
...
See also:@*
@xref{set_uformat}.@*
@node need_uconvert, uconvert_size, set_ucodepage, Unicode
@subsection need_uconvert
@ftable @asis
@item @t{int need_uconvert(const char *s, int type, int newtype);}
...
@xref{do_uconvert}.@*
@xref{uconvert}.@*
@node uconvert_size, do_uconvert, need_uconvert, Unicode
@subsection uconvert_size
@ftable @asis
@item @t{int uconvert_size(const char *s, int type, int newtype);}
...
ustrcpy(new_string, old_string);@end example
...
@xref{need_uconvert}.@*
@xref{do_uconvert}.@*
@node do_uconvert, uconvert, uconvert_size, Unicode
@subsection do_uconvert
@ftable @asis
@item @t{void do_uconvert(const char *s, int type, char *buf, int newtype, int size);}
...
See also:@*
@xref{uconvert}.@*
@node uconvert, uconvert_ascii, do_uconvert, Unicode
@subsection uconvert
@ftable @asis
@item @t{char *uconvert(const char *s, int type, char *buf, int newtype, int size);}
...
char *p = uconvert(input_string, U_CURRENT, buffer, U_ASCII, 256);@end example
...
@xref{uconvert}.@*
@xref{uconvert_ascii}.@*
@xref{uconvert_toascii}.@*
@xref{do_uconvert}.@*
@node uconvert_ascii, uconvert_toascii, uconvert, Unicode
@subsection uconvert_ascii
@ftable @asis
@item @t{char *uconvert_ascii(const char *s, char buf[]);}
...
@xref{uconvert}.@*
@xref{exunicod}.@*
@node uconvert_toascii, empty_string, uconvert_ascii, Unicode
@subsection uconvert_toascii
@ftable @asis
@item @t{char *uconvert_toascii(const char *s, char buf[]);}
...
See also:@*
@xref{uconvert}.@*
@node empty_string, ugetc, uconvert_toascii, Unicode
@subsection empty_string
@ftable @asis
@item @t{extern char empty_string[];}
...
@end ftable
@node ugetc, ugetx, empty_string, Unicode
@subsection ugetc
@ftable @asis
@item @t{int ugetc(const char *s);}
Low level helper function for reading Unicode text data. Example:
@example

int first_unicode_letter = ugetc(text_string);@end example
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node ugetx, usetc, ugetc, Unicode
@subsection ugetx
@ftable @asis
@item @t{int ugetx(char **s);}
@end ftable
@ftable @asis
@item @t{int ugetxc(const char **s);}
...
third_letter = ugetx(&p);@end example
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node usetc, uwidth, ugetx, Unicode
@subsection usetc
@ftable @asis
@item @t{int usetc(char *s, int c);}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node uwidth, ucwidth, usetc, Unicode
@subsection uwidth
@ftable @asis
@item @t{int uwidth(const char *s);}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node ucwidth, uisok, uwidth, Unicode
@subsection ucwidth
@ftable @asis
@item @t{int ucwidth(int c);}
Low level helper function for testing Unicode text data.
...
@xref{uwidth}.@*
@xref{uisok}.@*
@node uisok, uoffset, ucwidth, Unicode
@subsection uisok
@ftable @asis
@item @t{int uisok(int c);}
...
@xref{uwidth}.@*
@xref{ucwidth}.@*
@node uoffset, ugetat, uisok, Unicode
@subsection uoffset
@ftable @asis
@item @t{int uoffset(const char *s, int index);}
...
int from_third_letter = uoffset(text_string, 2);@end example
...
@xref{uinsert}.@*
@xref{uremove}.@*
@node ugetat, usetat, uoffset, Unicode
@subsection ugetat
@ftable @asis
@item @t{int ugetat(const char *s, int index);}
...
int third_letter = ugetat(text_string, 2);@end example
...
@xref{uinsert}.@*
@xref{uremove}.@*
@node usetat, uinsert, ugetat, Unicode
@subsection usetat
@ftable @asis
@item @t{int usetat(char *s, int index, int c);}
...
usetat(text_string, 2, letter_a);@end example
...
@xref{uinsert}.@*
@xref{uremove}.@*
@node uinsert, uremove, usetat, Unicode
@subsection uinsert
@ftable @asis
@item @t{int uinsert(char *s, int index, int c);}
...
uinsert(text_string, 0, prefix_letter);@end example
...
@xref{usetat}.@*
@xref{uremove}.@*
@node uremove, ustrsize, uinsert, Unicode
@subsection uremove
@ftable @asis
@item @t{int uremove(char *s, int index);}
...
...
length_in_bytes -= uremove(text_string, -1);@end example
...
@xref{usetat}.@*
@xref{uinsert}.@*
@node ustrsize, ustrsizez, uremove, Unicode
@subsection ustrsize
@ftable @asis
@item @t{int ustrsize(const char *s);}
...
@xref{empty_string}.@*
@xref{exunicod}.@*
@node ustrsizez, uwidth_max, ustrsize, Unicode
@subsection ustrsizez
@ftable @asis
@item @t{int ustrsizez(const char *s);}
...
@xref{empty_string}.@*
@xref{exunicod}.@*
@node uwidth_max, utolower, ustrsizez, Unicode
@subsection uwidth_max
@ftable @asis
@item @t{int uwidth_max(int type);}
...
char *temp_buffer = malloc(256 * uwidth_max(U_UTF8));@end example
...
@xref{uwidth}.@*
@xref{ucwidth}.@*
@node utolower, utoupper, uwidth_max, Unicode
@subsection utolower
@ftable @asis
@item @t{int utolower(int c);}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node utoupper, uisspace, utolower, Unicode
@subsection utoupper
@ftable @asis
@item @t{int utoupper(int c);}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node uisspace, uisdigit, utoupper, Unicode
@subsection uisspace
@ftable @asis
@item @t{int uisspace(int c);}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node uisdigit, ustrdup, uisspace, Unicode
@subsection uisdigit
@ftable @asis
@item @t{int uisdigit(int c);}
...
@xref{ucwidth}.@*
@xref{uisok}.@*
@node ustrdup, _ustrdup, uisdigit, Unicode
@subsection ustrdup
@ftable @asis
@item @t{char *ustrdup(const char *src)}
...
@xref{ustrsizez}.@*
@xref{exconfig}.@*
@node _ustrdup, ustrcpy, ustrdup, Unicode
@subsection _ustrdup
@ftable @asis
@item @t{char *_ustrdup(const char *src, void* (*malloc_func)(size_t))}
...
@xref{ustrsize}.@*
@xref{ustrsizez}.@*
@node ustrcpy, ustrzcpy, _ustrdup, Unicode
@subsection ustrcpy
@ftable @asis
@item @t{char *ustrcpy(char *dest, const char *src);}
...
@xref{ustrncpy}.@*
@xref{exunicod}.@*
@node ustrzcpy, ustrcat, ustrcpy, Unicode
@subsection ustrzcpy
@ftable @asis
@item @t{char *ustrzcpy(char *dest, int size, const char *src);}
This function copies `src' (including the terminating null character) into
...
@xref{ex3buf}.@*
@xref{exgui}.@*
@node ustrcat, ustrzcat, ustrzcpy, Unicode
@subsection ustrcat
@ftable @asis
@item @t{char *ustrcat(char *dest, const char *src);}
...
@xref{ustrncat}.@*
@xref{exunicod}.@*
@node ustrzcat, ustrlen, ustrcat, Unicode
@subsection ustrzcat
@ftable @asis
@item @t{char *ustrzcat(char *dest, int size, const char *src);}
...
@xref{ustrzncat}.@*
@xref{exgui}.@*
@node ustrlen, ustrcmp, ustrzcat, Unicode
@subsection ustrlen
@ftable @asis
@item @t{int ustrlen(const char *s);}
...
@xref{ustrsize}.@*
@xref{ustrsizez}.@*
@node ustrcmp, ustrncpy, ustrlen, Unicode
@subsection ustrcmp
@ftable @asis
@item @t{int ustrcmp(const char *s1, const char *s2);}
...
@xref{ustricmp}.@*
@xref{ustrnicmp}.@*
@node ustrncpy, ustrzncpy, ustrcmp, Unicode
@subsection ustrncpy
@ftable @asis
@item @t{char *ustrncpy(char *dest, const char *src, int n);}
...
@xref{ustrcpy}.@*
@xref{ustrzncpy}.@*
@node ustrzncpy, ustrncat, ustrncpy, Unicode
@subsection ustrzncpy
@ftable @asis
@item @t{char *ustrzncpy(char *dest, int size, const char *src, int n);}
...
@xref{ustrncpy}.@*
@xref{exkeys}.@*
@node ustrncat, ustrzncat, ustrzncpy, Unicode
@subsection ustrncat
@ftable @asis
@item @t{char *ustrncat(char *dest, const char *src, int n);}
...
@xref{ustrcat}.@*
@xref{ustrzncat}.@*
@node ustrzncat, ustrncmp, ustrncat, Unicode
@subsection ustrzncat
@ftable @asis
@item @t{char *ustrzncat(char *dest, int size, const char *src, int n);}
...
@xref{ustrzcat}.@*
@xref{ustrncat}.@*
@node ustrncmp, ustricmp, ustrzncat, Unicode
@subsection ustrncmp
@ftable @asis
@item @t{int ustrncmp(const char *s1, const char *s2, int n);}
...
@xref{ustricmp}.@*
@xref{ustrnicmp}.@*
@node ustricmp, ustrnicmp, ustrncmp, Unicode
@subsection ustricmp
@ftable @asis
@item @t{int ustricmp(const char *s1, const char *s2);}
...
@xref{ustrncmp}.@*
@xref{exconfig}.@*
@node ustrnicmp, ustrlwr, ustricmp, Unicode
@subsection ustrnicmp
@ftable @asis
@item @t{int ustrnicmp(const char *s1, const char *s2, int n);}
...
@xref{ustrcmp}.@*
@xref{ustrncmp}.@*
@node ustrlwr, ustrupr, ustrnicmp, Unicode
@subsection ustrlwr
@ftable @asis
@item @t{char *ustrlwr(char *s);}
This function replaces all upper case letters in `s' with lower case
letters. Example:
@example

char buffer[] = "UPPER CASE STRING";
allegro_message(ustrlwr(buffer));@end example
...
@xref{utolower}.@*
@xref{ustrupr}.@*
@node ustrupr, ustrchr, ustrlwr, Unicode
@subsection ustrupr
@ftable @asis
@item @t{char *ustrupr(char *s);}
This function replaces all lower case letters in `s' with upper case
letters. Example:
@example

char buffer[] = "lower case string";
allegro_message(ustrupr(buffer));@end example
...
@xref{utolower}.@*
@xref{ustrlwr}.@*
@node ustrchr, ustrrchr, ustrupr, Unicode
@subsection ustrchr
@ftable @asis
@item @t{char *ustrchr(const char *s, int c);}
Finds the first occurrence of the character `c' in the string `s'. Example:
@example

char *p = ustrchr("one,two,three,four", ',');@end example
...
@xref{ustrpbrk}.@*
@xref{ustrtok}.@*
@node ustrrchr, ustrstr, ustrchr, Unicode
@subsection ustrrchr
@ftable @asis
@item @t{char *ustrrchr(const char *s, int c);}
Finds the last occurrence of the character `c' in the string `s'. Example:
@example

char *p = ustrrchr("one,two,three,four", ',');@end example
...
@xref{ustrpbrk}.@*
@xref{ustrtok}.@*
@node ustrstr, ustrpbrk, ustrrchr, Unicode
@subsection ustrstr
@ftable @asis
@item @t{char *ustrstr(const char *s1, const char *s2);}
This function finds the first occurrence of string `s2' in string `s1'.
Example:
@example

char *p = ustrstr("hello world", "world");@end example
...
@xref{ustrpbrk}.@*
@xref{ustrtok}.@*
@node ustrpbrk, ustrtok, ustrstr, Unicode
@subsection ustrpbrk
@ftable @asis
@item @t{char *ustrpbrk(const char *s, const char *set);}
This function finds the first character in `s' that matches any character
in `set'. Example:
@example

char *p = ustrpbrk("one,two-three.four", "-. ");@end example
...
@xref{ustrstr}.@*
@xref{ustrtok}.@*
@node ustrtok, ustrtok_r, ustrpbrk, Unicode
@subsection ustrtok
@ftable @asis
@item @t{char *ustrtok(char *s, const char *set);}
...
@xref{ustrpbrk}.@*
@xref{ustrtok_r}.@*
@xref{allegro_message}.@*
@xref{ustrncpy}.@*
@xref{exgui}.@*
@node ustrtok_r, uatof, ustrtok, Unicode
@subsection ustrtok_r
@ftable @asis
@item @t{char *ustrtok_r(char *s, const char *set, char **last);}
...
See also:@*
@xref{ustrtok}.@*
@node uatof, ustrtol, ustrtok_r, Unicode
@subsection uatof
@ftable @asis
@item @t{double uatof(const char *s);}
...
@xref{ustrtol}.@*
@xref{ustrtod}.@*
@node ustrtol, ustrtod, uatof, Unicode
@subsection ustrtol
@ftable @asis
@item @t{long ustrtol(const char *s, char **endp, int base);}
...
int number = ustrtol(string, &endp, 10);@end example
...
@xref{ustrtod}.@*
@xref{uatof}.@*
@node ustrtod, ustrerror, ustrtol, Unicode
@subsection ustrtod
@ftable @asis
@item @t{double ustrtod(const char *s, char **endp);}
...
char *endp, *string = "456.203 askdfg";
double number = ustrtod(string, &endp);@end example
...
@xref{ustrtol}.@*
@xref{uatof}.@*
@node ustrerror, usprintf, ustrtod, Unicode
@subsection ustrerror
@ftable @asis
@item @t{const char *ustrerror(int err);}
...
@xref{uconvert}.@*
@xref{allegro_error}.@*
@node usprintf, uszprintf, ustrerror, Unicode
@subsection usprintf
@ftable @asis
@item @t{int usprintf(char *buf, const char *format, ...);}
...
@xref{uvsprintf}.@*
@xref{exkeys}.@*
@node uszprintf, uvsprintf, usprintf, Unicode
@subsection uszprintf
@ftable @asis
@item @t{int uszprintf(char *buf, int size, const char *format, ...);}
...
int player_score;
...
uszprintf(buffer, sizeof(buffer), "Your score is: %d", player_score);@end example
...
@xref{uvszprintf}.@*
@xref{exgui}.@*
@node uvsprintf, uvszprintf, uszprintf, Unicode
@subsection uvsprintf
@ftable @asis
@item @t{int uvsprintf(char *buf, const char *format, va_list args);}
...
@xref{usprintf}.@*
@xref{uvszprintf}.@*
@node uvszprintf, set_config_file, uvsprintf, Unicode
@subsection uvszprintf
@ftable @asis
@item @t{int uvszprintf(char *buf, int size, const char *format, va_list args);}
...
@xref{uszprintf}.@*
@xref{uvsprintf}.@*
@node Configuration, Mouse, Unicode, API
...
@end menu
@node set_config_file, set_config_data, uvszprintf, Configuration
@subsection set_config_file
@ftable @asis
@item @t{void set_config_file(const char *filename);}
...
@end ftable
See also:@*
@xref{set_config_data}.@*
@xref{override_config_file}.@*
@xref{push_config_state}.@*
@xref{set_uformat}.@*
@xref{Standard config variables}.@*
@xref{set_config_string}.@*
@xref{get_config_string}.@*
@xref{exconfig}.@*
@node set_config_data, override_config_file, set_config_file, Configuration
@subsection set_config_data
@ftable @asis
@item @t{void set_config_data(const char *data, int length);}
...
See also:@*
@xref{set_config_file}.@*
@xref{override_config_data}.@*
@xref{push_config_state}.@*
@xref{Standard config variables}.@*
@xref{set_config_string}.@*
@xref{get_config_string}.@*
@node override_config_file, override_config_data, set_config_data, Configuration
@subsection override_config_file
@ftable @asis
@item @t{void override_config_file(const char *filename);}
 ...
 */
override_config_file(NULL);@end example
...
@xref{override_config_data}.@*
@xref{set_config_file}.@*
@node override_config_data, push_config_state, override_config_file, Configuration
@subsection override_config_data
@ftable @asis
@item @t{void override_config_data(const char *data, int length);}
...
const char *override_data = "[system]\n"
   "language=DE\n"
   "keyboard=ES";
override_config_data(override_data, ustrsize(override_data));@end example
...
@xref{override_config_file}.@*
@xref{set_config_data}.@*
@node push_config_state, pop_config_state, override_config_data, Configuration
@subsection push_config_state
@ftable @asis
@item @t{void push_config_state();}
...
@end ftable
See also:@*
@xref{pop_config_state}.@*
@xref{set_config_file}.@*
@xref{save_joystick_data}.@*
@xref{exconfig}.@*
@node pop_config_state, flush_config_file, push_config_state, Configuration
@subsection pop_config_state
@ftable @asis
@item @t{void pop_config_state();}
...
@xref{push_config_state}.@*
@xref{exconfig}.@*
@node flush_config_file, reload_config_texts, pop_config_state, Configuration
@subsection flush_config_file
@ftable @asis
@item @t{void flush_config_file();}
...
@xref{override_config_file}.@*
@xref{push_config_state}.@*
@node reload_config_texts, hook_config_section, flush_config_file, Configuration
@subsection reload_config_texts
@ftable @asis
@item @t{void reload_config_texts(const char *new_language);}
...
reload_config_texts("FR");@end example


@end ftable
See also:@*
@xref{get_config_text}.@*
@xref{get_config_string}.@*
@xref{Standard config variables}.@*
@node hook_config_section, config_is_hooked, reload_config_texts, Configuration
@subsection hook_config_section
@ftable @asis
@item @t{void hook_config_section(const char *section, int (*intgetter)(const char *name, int def), const char *(*stringgetter)(const char *name, const char *def), void (*stringsetter)(const char *name, const char *value));}
...
@node config_is_hooked, get_config_string, hook_config_section, Configuration
@subsection config_is_hooked
@ftable @asis
@item @t{int config_is_hooked(const char *section);}
...
@node get_config_string, get_config_int, config_is_hooked, Configuration
@subsection get_config_string
@ftable @asis
@item @t{const char *get_config_string(const char *section, const char *name, const char *def);}
...
@xref{set_config_file}.@*
@xref{set_config_string}.@*
@xref{get_config_argv}.@*
@xref{get_config_float}.@*
@xref{get_config_hex}.@*
@xref{get_config_int}.@*
@xref{get_config_id}.@*
@xref{get_config_text}.@*
@xref{exconfig}.@*
@node get_config_int, get_config_hex, get_config_string, Configuration
@subsection get_config_int
@ftable @asis
@item @t{int get_config_int(const char *section, const char *name, int def);}
...
@xref{get_config_id}.@*
@xref{exconfig}.@*
@node get_config_hex, get_config_float, get_config_int, Configuration
@subsection get_config_hex
@ftable @asis
@item @t{int get_config_hex(const char *section, const char *name, int def);}
...
@xref{get_config_int}.@*
@xref{get_config_id}.@*
@node get_config_float, get_config_id, get_config_hex, Configuration
@subsection get_config_float
@ftable @asis
@item @t{float get_config_float(const char *section, const char *name, float def);}
...
See also:@*
@xref{set_config_file}.@*
@xref{set_config_float}.@*
@xref{get_config_string}.@*
@xref{get_config_argv}.@*
@xref{get_config_hex}.@*
@xref{get_config_int}.@*
@xref{get_config_id}.@*
@node get_config_id, get_config_argv, get_config_float, Configuration
@subsection get_config_id
@ftable @asis
@item @t{int get_config_id(const char *section, const char *name, int def);}
...
@xref{get_config_hex}.@*
@xref{get_config_int}.@*
@node get_config_argv, get_config_text, get_config_id, Configuration
@subsection get_config_argv
@ftable @asis
@item @t{char **get_config_argv(const char *section, const char *name, int *argc);}
...
@xref{get_config_id}.@*
@xref{exconfig}.@*
@node get_config_text, set_config_string, get_config_argv, Configuration
@subsection get_config_text
@ftable @asis
@item @t{const char *get_config_text(const char *msg);}
...
See also:@*
@xref{get_config_string}.@*
@xref{reload_config_texts}.@*
@xref{Standard config variables}.@*
@node set_config_string, set_config_int, get_config_text, Configuration
@subsection set_config_string
@ftable @asis
@item @t{void set_config_string(const char *section, const char *name, const char *val);}
...
@xref{set_config_int}.@*
@xref{set_config_id}.@*
@node set_config_int, set_config_hex, set_config_string, Configuration
@subsection set_config_int
@ftable @asis
@item @t{void set_config_int(const char *section, const char *name, int val);}
...
@xref{set_config_hex}.@*
@xref{set_config_id}.@*
@node set_config_hex, set_config_float, set_config_int, Configuration
@subsection set_config_hex
@ftable @asis
@item @t{void set_config_hex(const char *section, const char *name, int val);}
...
@xref{set_config_int}.@*
@xref{set_config_id}.@*
@node set_config_float, set_config_id, set_config_hex, Configuration
@subsection set_config_float
@ftable @asis
@item @t{void set_config_float(const char *section, const char *name, float val);}
...
@xref{set_config_int}.@*
@xref{set_config_id}.@*
@node set_config_id, list_config_entries, set_config_float, Configuration
@subsection set_config_id
@ftable @asis
@item @t{void set_config_id(const char *section, const char *name, int val);}
...
@xref{set_config_hex}.@*
@xref{set_config_int}.@*
@node list_config_entries, list_config_sections, set_config_id, Configuration
@subsection list_config_entries
@ftable @asis
@item @t{int list_config_entries(const char *section, const char ***names);}
...
free_config_entries(&entries);@end example
...
@xref{set_config_file}.@*
@xref{get_config_string}.@*
@xref{list_config_sections}.@*
@xref{free_config_entries}.@*
@node list_config_sections, free_config_entries, list_config_entries, Configuration
@subsection list_config_sections
@ftable @asis
@item @t{int list_config_sections(const char ***names);}
...
@end ftable
See also:@*
@xref{list_config_entries}.@*
@xref{set_config_file}.@*
@xref{get_config_string}.@*
@xref{free_config_entries}.@*
@node free_config_entries, Standard config variables, list_config_sections, Configuration
@subsection free_config_entries
@ftable @asis
@item @t{int free_config_entries(const char ***names);}
...
@xref{list_config_entries}.@*
@xref{list_config_sections}.@*
@node Standard config variables, install_mouse, free_config_entries, Configuration
@subsection Standard config variables
@ftable @asis
@end ftable
...
EV   - Event interfaces (EVDEV)@end example
...
@xref{set_config_string}.@*
@xref{get_config_string}.@*
@node Mouse, Timer, Configuration, API
@section Mouse routines
...
* mouse_callback::
@end menu
@node install_mouse, remove_mouse, Standard config variables, Mouse
@subsection install_mouse
@ftable @asis
@item @t{int install_mouse();}
...
@xref{mouse_x}.@*
@xref{show_mouse}.@*
@xref{get_mouse_mickeys}.@*
@xref{position_mouse}.@*
@xref{set_mouse_range}.@*
@xref{set_mouse_speed}.@*
@xref{Standard config variables}.@*
@xref{Available, Available Allegro examples}.@*
@node remove_mouse, poll_mouse, install_mouse, Mouse
@subsection remove_mouse
@ftable @asis
@item @t{void remove_mouse();}
...
@xref{install_mouse}.@*
@xref{allegro_exit}.@*
@node poll_mouse, mouse_needs_poll, remove_mouse, Mouse
@subsection poll_mouse
@ftable @asis
@item @t{int poll_mouse();}
...
@xref{exspline}.@*
@xref{extrans}.@*
@node mouse_needs_poll, enable_hardware_cursor, poll_mouse, Mouse
@subsection mouse_needs_poll
@ftable @asis
@item @t{int mouse_needs_poll();}
...
@xref{install_mouse}.@*
@xref{mouse_x}.@*
@node enable_hardware_cursor, disable_hardware_cursor, mouse_needs_poll, Mouse
@subsection enable_hardware_cursor
@ftable @asis
@item @t{void enable_hardware_cursor(void);}
...
@xref{get_mouse_mickeys}.@*
@xref{gfx_capabilities}.@*
@xref{disable_hardware_cursor}.@*
@xref{show_os_cursor}.@*
@xref{exsyscur}.@*
@node disable_hardware_cursor, select_mouse_cursor, enable_hardware_cursor, Mouse
@subsection disable_hardware_cursor
@ftable @asis
@item @t{void disable_hardware_cursor(void);}
...
@node select_mouse_cursor, set_mouse_cursor_bitmap, disable_hardware_cursor, Mouse
@subsection select_mouse_cursor
@ftable @asis
@item @t{void select_mouse_cursor(int cursor);}
...
@xref{gfx_capabilities}.@*
@xref{enable_hardware_cursor}.@*
@xref{set_mouse_cursor_bitmap}.@*
@xref{show_os_cursor}.@*
@xref{exsyscur}.@*
@node set_mouse_cursor_bitmap, mouse_x, select_mouse_cursor, Mouse
@subsection set_mouse_cursor_bitmap
@ftable @asis
@item @t{void set_mouse_cursor_bitmap(int cursor, BITMAP *bmp);}
...
@xref{show_os_cursor}.@*
@xref{BITMAP}.@*
@node mouse_x, mouse_sprite, set_mouse_cursor_bitmap, Mouse
@subsection mouse_x
@ftable @asis
@item @t{extern volatile int mouse_x;}
@end ftable
@ftable @asis
@item @t{extern volatile int mouse_y;}
@end ftable
@ftable @asis
@item @t{extern volatile int mouse_z;}
@end ftable
@ftable @asis
@item @t{extern volatile int mouse_w;}
@end ftable
@ftable @asis
@item @t{extern volatile int mouse_b;}
@end ftable
@ftable @asis
@item @t{extern volatile int mouse_pos;}
...
@xref{exspline}.@*
@xref{extrans}.@*
@node mouse_sprite, show_mouse, mouse_x, Mouse
@subsection mouse_sprite
@ftable @asis
@item @t{extern BITMAP *mouse_sprite;}
@end ftable
@ftable @asis
@item @t{extern int mouse_x_focus;}
@end ftable
@ftable @asis
@item @t{extern int mouse_y_focus;}
...
See also:@*
@xref{set_mouse_sprite}.@*
@xref{set_mouse_sprite_focus}.@*
@xref{BITMAP}.@*
@node show_mouse, scare_mouse, mouse_sprite, Mouse
@subsection show_mouse
@ftable @asis
@item @t{void show_mouse(BITMAP *bmp);}
...
@xref{exsyscur}.@*
@xref{BITMAP}.@*
@node scare_mouse, scare_mouse_area, show_mouse, Mouse
@subsection scare_mouse
@ftable @asis
@item @t{void scare_mouse();}
...
See also:@*
@xref{unscare_mouse}.@*
@xref{scare_mouse_area}.@*
@xref{show_mouse}.@*
@node scare_mouse_area, unscare_mouse, scare_mouse, Mouse
@subsection scare_mouse_area
@ftable @asis
@item @t{void scare_mouse_area(int x, int y, int w, int h);}
...
@xref{scare_mouse}.@*
@xref{show_mouse}.@*
@node unscare_mouse, show_os_cursor, scare_mouse_area, Mouse
@subsection unscare_mouse
@ftable @asis
@item @t{void unscare_mouse();}
...
@xref{scare_mouse}.@*
@xref{scare_mouse_area}.@*
@node show_os_cursor, freeze_mouse_flag, unscare_mouse, Mouse
@subsection show_os_cursor
@ftable @asis
@item @t{int show_os_cursor(int cursor);}
...
@xref{show_mouse}.@*
@xref{set_mouse_cursor_bitmap}.@*
@xref{select_mouse_cursor}.@*
@node freeze_mouse_flag, position_mouse, show_os_cursor, Mouse
@subsection freeze_mouse_flag
@ftable @asis
@item @t{extern volatile int freeze_mouse_flag;}
...
See also:@*
@xref{show_mouse}.@*
@node position_mouse, position_mouse_z, freeze_mouse_flag, Mouse
@subsection position_mouse
@ftable @asis
@item @t{void position_mouse(int x, int y);}
...
See also:@*
@xref{install_mouse}.@*
@xref{position_mouse_z}.@*
@xref{set_mouse_range}.@*
@xref{set_mouse_speed}.@*
@xref{position_mouse_w}.@*
@node position_mouse_z, position_mouse_w, position_mouse, Mouse
@subsection position_mouse_z
@ftable @asis
@item @t{void position_mouse_z(int z);}
...
@xref{position_mouse}.@*
@xref{position_mouse_w}.@*
@node position_mouse_w, set_mouse_range, position_mouse_z, Mouse
@subsection position_mouse_w
@ftable @asis
@item @t{void position_mouse_w(int w);}
...
@xref{install_mouse}.@*
@xref{position_mouse}.@*
@node set_mouse_range, set_mouse_speed, position_mouse_w, Mouse
@subsection set_mouse_range
@ftable @asis
@item @t{void set_mouse_range(int x1, int y1, int x2, int y2);}
...
@xref{set_mouse_speed}.@*
@xref{position_mouse}.@*
@node set_mouse_speed, set_mouse_sprite, set_mouse_range, Mouse
@subsection set_mouse_speed
@ftable @asis
@item @t{void set_mouse_speed(int xspeed, int yspeed);}
...
@xref{set_mouse_range}.@*
@xref{position_mouse}.@*
@node set_mouse_sprite, set_mouse_sprite_focus, set_mouse_speed, Mouse
@subsection set_mouse_sprite
@ftable @asis
@item @t{void set_mouse_sprite(BITMAP *sprite);}
...
@xref{exmouse}.@*
@xref{BITMAP}.@*
@node set_mouse_sprite_focus, get_mouse_mickeys, set_mouse_sprite, Mouse
@subsection set_mouse_sprite_focus
@ftable @asis
@item @t{void set_mouse_sprite_focus(int x, int y);}
...
@xref{set_mouse_sprite}.@*
@xref{exmouse}.@*
@node get_mouse_mickeys, mouse_callback, set_mouse_sprite_focus, Mouse
@subsection get_mouse_mickeys
@ftable @asis
@item @t{void get_mouse_mickeys(int *mickeyx, int *mickeyy);}
...
@xref{install_mouse}.@*
@xref{exmouse}.@*
@node mouse_callback, install_timer, get_mouse_mickeys, Mouse
@subsection mouse_callback
@ftable @asis
@item @t{extern void (*mouse_callback)(int flags);}
...
* rest_callback::
@end menu
@node install_timer, remove_timer, mouse_callback, Timer
@subsection install_timer
@ftable @asis
@item @t{int install_timer();}
...
@xref{install_int}.@*
@xref{Available, Available Allegro examples}.@*
@node remove_timer, install_int, install_timer, Timer
@subsection remove_timer
@ftable @asis
@item @t{void remove_timer();}
...
@xref{install_timer}.@*
@xref{allegro_exit}.@*
@node install_int, install_int_ex, remove_timer, Timer
@subsection install_int
@ftable @asis
@item @t{int install_int(void (*proc)(), int speed);}
...
@xref{remove_int}.@*
@xref{install_int_ex}.@*
@xref{install_param_int}.@*
@xref{exscn3d}.@*
@xref{exswitch}.@*
@xref{extimer}.@*
@xref{exzbuf}.@*
@node install_int_ex, LOCK_VARIABLE, install_int, Timer
@subsection install_int_ex
@ftable @asis
@item @t{int install_int_ex(void (*proc)(), int speed);}
...
@xref{remove_int}.@*
@xref{install_int}.@*
@xref{install_param_int_ex}.@*
@xref{excamera}.@*
@xref{exsprite}.@*
@xref{extimer}.@*
@xref{exunicod}.@*
@xref{exupdate}.@*
@node LOCK_VARIABLE, LOCK_FUNCTION, install_int_ex, Timer
@subsection LOCK_VARIABLE
@ftable @asis
@item @t{Macro LOCK_VARIABLE(variable_name);}
...
@xref{exupdate}.@*
@xref{exzbuf}.@*
@node LOCK_FUNCTION, END_OF_FUNCTION, LOCK_VARIABLE, Timer
@subsection LOCK_FUNCTION
@ftable @asis
@item @t{Macro LOCK_FUNCTION(function_name);}
Due to interrupts, you are required to lock all the memory used by your
timer routines. See the description of install_int_ex() for a more
detailed explanation and usage example.
...
@xref{exupdate}.@*
@xref{exzbuf}.@*
@node END_OF_FUNCTION, remove_int, LOCK_FUNCTION, Timer
@subsection END_OF_FUNCTION
@ftable @asis
@item @t{Macro END_OF_FUNCTION(function_name);}
...
@xref{exupdate}.@*
@xref{exzbuf}.@*
@node remove_int, install_param_int, END_OF_FUNCTION, Timer
@subsection remove_int
@ftable @asis
@item @t{void remove_int(void (*proc)());}
...
@xref{install_int}.@*
@xref{install_int_ex}.@*
@xref{remove_param_int}.@*
@node install_param_int, install_param_int_ex, remove_int, Timer
@subsection install_param_int
@ftable @asis
@item @t{int install_param_int(void (*proc)(void *), void *param, int speed);}
...
@xref{install_param_int_ex}.@*
@xref{install_int}.@*
@node install_param_int_ex, remove_param_int, install_param_int, Timer
@subsection install_param_int_ex
@ftable @asis
@item @t{int install_param_int_ex(void (*proc)(void *), void *param, int speed);}
...
@xref{install_param_int}.@*
@xref{install_int_ex}.@*
@node remove_param_int, retrace_count, install_param_int_ex, Timer
@subsection remove_param_int
@ftable @asis
@item @t{void remove_param_int(void (*proc)(void *), void *param);}
...
@xref{install_param_int_ex}.@*
@xref{remove_int}.@*
@node retrace_count, rest, remove_param_int, Timer
@subsection retrace_count
@ftable @asis
@item @t{extern volatile int retrace_count;}
...
@xref{exflip}.@*
@xref{exlights}.@*
@node rest, rest_callback, retrace_count, Timer
@subsection rest
@ftable @asis
@item @t{void rest(unsigned int time);}
...
@xref{extrans}.@*
@xref{exunicod}.@*
@node rest_callback, install_keyboard, rest, Timer
@subsection rest_callback
@ftable @asis
@item @t{void rest_callback(long time, void (*callback)())}
...
@xref{install_timer}.@*
@xref{rest}.@*
@node Keyboard, Joystick, Timer, API
...
* key_led_flag::
@end menu
@node install_keyboard, remove_keyboard, rest_callback, Keyboard
@subsection install_keyboard
@ftable @asis
@item @t{int install_keyboard();}
...
@end ftable
See also:@*
@xref{remove_keyboard}.@*
@xref{poll_keyboard}.@*
@xref{key}.@*
@xref{keypressed}.@*
@xref{readkey}.@*
@xref{ureadkey}.@*
@xref{keyboard_callback}.@*
@xref{keyboard_ucallback}.@*
@xref{keyboard_lowlevel_callback}.@*
@xref{three_finger_flag}.@*
@xref{key_led_flag}.@*
@xref{set_leds}.@*
@xref{set_keyboard_rate}.@*
@xref{set_gfx_mode}.@*
@xref{Standard config variables}.@*
@xref{Available, Available Allegro examples}.@*
@node remove_keyboard, install_keyboard_hooks, install_keyboard, Keyboard
@subsection remove_keyboard
@ftable @asis
@item @t{void remove_keyboard();}
...
@xref{allegro_exit}.@*
@xref{set_config_string}.@*
@node install_keyboard_hooks, poll_keyboard, remove_keyboard, Keyboard
@subsection install_keyboard_hooks
@ftable @asis
@item @t{void install_keyboard_hooks(int (*keypressed)(), int (*readkey)());}
...
@xref{keypressed}.@*
@xref{readkey}.@*
@node poll_keyboard, keyboard_needs_poll, install_keyboard_hooks, Keyboard
@subsection poll_keyboard
@ftable @asis
@item @t{int poll_keyboard();}
...
@xref{exsample}.@*
@xref{exstars}.@*
@node keyboard_needs_poll, key, poll_keyboard, Keyboard
@subsection keyboard_needs_poll
@ftable @asis
@item @t{int keyboard_needs_poll();}
...
@xref{install_keyboard}.@*
@xref{key}.@*
@node key, key_shifts, keyboard_needs_poll, Keyboard
@subsection key
@ftable @asis
@item @t{extern volatile char key[KEY_MAX];}
...
KEY_EQUALS_PAD, KEY_BACKQUOTE, KEY_SEMICOLON, KEY_COMMAND@end example
...
@xref{key_shifts}.@*
@xref{Available, Available Allegro examples}.@*
@node key_shifts, keypressed, key, Keyboard
@subsection key_shifts
@ftable @asis
@item @t{extern volatile int key_shifts;}
...
@xref{excamera}.@*
@xref{exkeys}.@*
@node keypressed, readkey, key_shifts, Keyboard
...
@}
/* So he skipped our title screen. */@end example
...
@xref{ureadkey}.@*
@xref{clear_keybuf}.@*
@xref{simulate_keypress}.@*
@xref{simulate_ukeypress}.@*
@xref{Available, Available Allegro examples}.@*
@node readkey, ureadkey, keypressed, Keyboard
@subsection readkey
@ftable @asis
@item @t{int readkey();}
...
@xref{simulate_keypress}.@*
@xref{Available, Available Allegro examples}.@*
@node ureadkey, scancode_to_ascii, readkey, Keyboard
@subsection ureadkey
@ftable @asis
@item @t{int ureadkey(int *scancode);}
...
@xref{simulate_ukeypress}.@*
@xref{exkeys}.@*
@node scancode_to_ascii, scancode_to_name, ureadkey, Keyboard
@subsection scancode_to_ascii
@ftable @asis
@item @t{int scancode_to_ascii(int scancode);}
...
@node scancode_to_name, simulate_keypress, scancode_to_ascii, Keyboard
@subsection scancode_to_name
@ftable @asis
@item @t{const char *scancode_to_name(int scancode);}
...
allegro_message("You pressed the %s key.", keyname);@end example
...
@xref{exkeys}.@*
@node simulate_keypress, simulate_ukeypress, scancode_to_name, Keyboard
@subsection simulate_keypress
@ftable @asis
@item @t{void simulate_keypress(int key);}
...
@xref{keypressed}.@*
@xref{readkey}.@*
@node simulate_ukeypress, keyboard_callback, simulate_keypress, Keyboard
@subsection simulate_ukeypress
@ftable @asis
@item @t{void simulate_ukeypress(int key, int scancode);}
Stuffs a key into the keyboard buffer, just as if the user had pressed 
...
@xref{keypressed}.@*
@xref{ureadkey}.@*
@node keyboard_callback, keyboard_ucallback, simulate_ukeypress, Keyboard
@subsection keyboard_callback
@ftable @asis
@item @t{extern int (*keyboard_callback)(int key);}
...
...
   ...
   install_keyboard();
   keyboard_callback = enigma_scrambler;@end example
...
@xref{keyboard_ucallback}.@*
@xref{keyboard_lowlevel_callback}.@*
@node keyboard_ucallback, keyboard_lowlevel_callback, keyboard_callback, Keyboard
@subsection keyboard_ucallback
@ftable @asis
@item @t{extern int (*keyboard_ucallback)(int key, int *scancode);}
...
...
   ...
   install_keyboard();
   keyboard_ucallback = silence_g_key;@end example
...
@xref{keyboard_callback}.@*
@xref{keyboard_lowlevel_callback}.@*
@node keyboard_lowlevel_callback, set_leds, keyboard_ucallback, Keyboard
@subsection keyboard_lowlevel_callback
@ftable @asis
@item @t{extern void (*keyboard_lowlevel_callback)(int scancode);}
If set, this function is called by the keyboard handler in response to 
...
@xref{keyboard_ucallback}.@*
@xref{exkeys}.@*
@node set_leds, set_keyboard_rate, keyboard_lowlevel_callback, Keyboard
@subsection set_leds
@ftable @asis
@item @t{void set_leds(int leds);}
...
@xref{install_keyboard}.@*
@xref{key_led_flag}.@*
@node set_keyboard_rate, clear_keybuf, set_leds, Keyboard
@subsection set_keyboard_rate
@ftable @asis
@item @t{void set_keyboard_rate(int delay, int repeat);}
...
@xref{readkey}.@*
@xref{ureadkey}.@*
@node clear_keybuf, three_finger_flag, set_keyboard_rate, Keyboard
@subsection clear_keybuf
@ftable @asis
@item @t{void clear_keybuf();}
...
@xref{ureadkey}.@*
@xref{Available, Available Allegro examples}.@*
@node three_finger_flag, key_led_flag, clear_keybuf, Keyboard
@subsection three_finger_flag
@ftable @asis
@item @t{extern int three_finger_flag;}
...
See also:@*
@xref{install_keyboard}.@*
@node key_led_flag, install_joystick, three_finger_flag, Keyboard
@subsection key_led_flag
@ftable @asis
@item @t{extern int key_led_flag;}
...
@xref{install_keyboard}.@*
@xref{set_leds}.@*
@node Joystick, Graphics, Keyboard, API
@section Joystick routines
...
* initialise_joystick::
@end menu
@node install_joystick, remove_joystick, key_led_flag, Joystick
@subsection install_joystick
@ftable @asis
@item @t{int install_joystick(int type);}
...
if (install_joystick(JOY_TYPE_AUTODETECT) != 0)
   abort_on_error("Error initialising joystick!");@end example
...
@end ftable
See also:@*
@xref{remove_joystick}.@*
@xref{num_joysticks}.@*
@xref{load_joystick_data}.@*
@xref{calibrate_joystick}.@*
@xref{calibrate_joystick_name}.@*
@xref{poll_joystick}.@*
@xref{Standard config variables}.@*
@xref{JOY_TYPE_*/DOS}.@*
@xref{JOY_TYPE_*/Windows}.@*
@xref{JOY_TYPE_*/Linux}.@*
@xref{exjoy}.@*
@node remove_joystick, poll_joystick, install_joystick, Joystick
@subsection remove_joystick
@ftable @asis
@item @t{void remove_joystick();}
...
@xref{allegro_exit}.@*
@node poll_joystick, num_joysticks, remove_joystick, Joystick
@subsection poll_joystick
@ftable @asis
@item @t{int poll_joystick();}
...
@xref{num_joysticks}.@*
@xref{exjoy}.@*
@node num_joysticks, joy, poll_joystick, Joystick
@subsection num_joysticks
@ftable @asis
@item @t{extern int num_joysticks;}
...
@xref{joy}.@*
@xref{exjoy}.@*
@node joy, calibrate_joystick_name, num_joysticks, Joystick
@subsection joy
@ftable @asis
@item @t{extern JOYSTICK_INFO joy[n];}
...
@xref{exjoy}.@*
@xref{JOYSTICK_INFO}.@*
@node calibrate_joystick_name, calibrate_joystick, joy, Joystick
@subsection calibrate_joystick_name
@ftable @asis
@item @t{const char *calibrate_joystick_name(int n);}
...
@xref{num_joysticks}.@*
@xref{exjoy}.@*
@node calibrate_joystick, save_joystick_data, calibrate_joystick_name, Joystick
@subsection calibrate_joystick
@ftable @asis
@item @t{int calibrate_joystick(int n);}
...
@xref{num_joysticks}.@*
@xref{exjoy}.@*
@node save_joystick_data, load_joystick_data, calibrate_joystick, Joystick
@subsection save_joystick_data
@ftable @asis
@item @t{int save_joystick_data(const char *filename);}
...
@xref{load_joystick_data}.@*
@xref{set_config_file}.@*
@node load_joystick_data, initialise_joystick, save_joystick_data, Joystick
@subsection load_joystick_data
@ftable @asis
@item @t{int load_joystick_data(const char *filename);}
...
@xref{save_joystick_data}.@*
@xref{set_config_file}.@*
@node initialise_joystick, set_color_depth, load_joystick_data, Joystick
@subsection initialise_joystick
@ftable @asis
@item @t{int initialise_joystick();}
...
See also:@*
@xref{install_joystick}.@*
@node Graphics, Bitmap, Joystick, API
...
* vsync::
@end menu
@node set_color_depth, get_color_depth, initialise_joystick, Graphics
@subsection set_color_depth
@ftable @asis
@item @t{void set_color_depth(int depth);}
...
@xref{desktop_color_depth}.@*
@xref{Available, Available Allegro examples}.@*
@node get_color_depth, request_refresh_rate, set_color_depth, Graphics
@subsection get_color_depth
@ftable @asis
@item @t{int get_color_depth(void);}
...
@xref{bitmap_color_depth}.@*
@xref{exrgbhsv}.@*
@node request_refresh_rate, get_refresh_rate, get_color_depth, Graphics
@subsection request_refresh_rate
@ftable @asis
@item @t{void request_refresh_rate(int rate);}
...
if (get_refresh_rate() != 60)
   abort_on_error("Couldn't set refresh rate to 60Hz!");@end example


@end ftable
See also:@*
@xref{set_gfx_mode}.@*
@xref{get_refresh_rate}.@*
@node get_refresh_rate, get_gfx_mode_list, request_refresh_rate, Graphics
@subsection get_refresh_rate
@ftable @asis
@item @t{int get_refresh_rate(void);}
...
@node get_gfx_mode_list, destroy_gfx_mode_list, get_refresh_rate, Graphics
@subsection get_gfx_mode_list
@ftable @asis
@item @t{GFX_MODE_LIST *get_gfx_mode_list(int card);}
...
@end ftable
See also:@*
@xref{destroy_gfx_mode_list}.@*
@xref{set_gfx_mode}.@*
@xref{set_color_depth}.@*
@xref{GFX_MODE_LIST}.@*
@node destroy_gfx_mode_list, set_gfx_mode, get_gfx_mode_list, Graphics
@subsection destroy_gfx_mode_list
@ftable @asis
@item @t{void destroy_gfx_mode_list(GFX_MODE_LIST *mode_list);}
...
@xref{set_color_depth}.@*
@xref{GFX_MODE_LIST}.@*
@node set_gfx_mode, set_display_switch_mode, destroy_gfx_mode_list, Graphics
@subsection set_gfx_mode
@ftable @asis
@item @t{int set_gfx_mode(int card, int w, int h, int v_w, int v_h);}
...
@xref{GFX_*/BeOS}.@*
@xref{GFX_*/MacOSX}.@*
@xref{create_video_bitmap}.@*
@xref{get_desktop_resolution}.@*
@xref{SCREEN_W}.@*
@xref{SCREEN_W, SCREEN_H}.@*
@xref{VIRTUAL_W}.@*
@xref{VIRTUAL_W, VIRTUAL_H}.@*
@xref{Available, Available Allegro examples}.@*
@node set_display_switch_mode, set_display_switch_callback, set_gfx_mode, Graphics
@subsection set_display_switch_mode
@ftable @asis
@item @t{int set_display_switch_mode(int mode);}
...
@xref{get_display_switch_mode}.@*
@xref{exmidi}.@*
@xref{exswitch}.@*
@node set_display_switch_callback, remove_display_switch_callback, set_display_switch_mode, Graphics
@subsection set_display_switch_callback
@ftable @asis
@item @t{int set_display_switch_callback(int dir, void (*cb)());}
...
@end ftable
See also:@*
@xref{remove_display_switch_callback}.@*
@xref{set_display_switch_mode}.@*
@xref{exswitch}.@*
@node remove_display_switch_callback, get_display_switch_mode, set_display_switch_callback, Graphics
@subsection remove_display_switch_callback
@ftable @asis
@item @t{void remove_display_switch_callback(void (*cb)());}
...
See also:@*
@xref{set_display_switch_callback}.@*
@node get_display_switch_mode, is_windowed_mode, remove_display_switch_callback, Graphics
@subsection get_display_switch_mode
@ftable @asis
@item @t{int get_display_switch_mode();}
...
@xref{set_display_switch_mode}.@*
@xref{exswitch}.@*
@node is_windowed_mode, gfx_capabilities, get_display_switch_mode, Graphics
@subsection is_windowed_mode
@ftable @asis
@item @t{int is_windowed_mode(void);}
...
See also:@*
@xref{set_gfx_mode}.@*
@node gfx_capabilities, enable_triple_buffer, is_windowed_mode, Graphics
@subsection gfx_capabilities
@ftable @asis
@item @t{extern int gfx_capabilities;}
...
@xref{exsyscur}.@*
@xref{exupdate}.@*
@node enable_triple_buffer, scroll_screen, gfx_capabilities, Graphics
@subsection enable_triple_buffer
@ftable @asis
@item @t{int enable_triple_buffer();}
...
@xref{gfx_capabilities}.@*
@xref{request_scroll}.@*
@xref{request_video_bitmap}.@*
@xref{ex3buf}.@*
@xref{exupdate}.@*
@node scroll_screen, request_scroll, enable_triple_buffer, Graphics
@subsection scroll_screen
@ftable @asis
@item @t{int scroll_screen(int x, int y);}
...
See also:@*
@xref{set_gfx_mode}.@*
@xref{show_video_bitmap}.@*
@xref{request_scroll}.@*
@xref{request_video_bitmap}.@*
@xref{exscroll}.@*
@node request_scroll, poll_scroll, scroll_screen, Graphics
@subsection request_scroll
@ftable @asis
@item @t{int request_scroll(int x, int y);}
...
@xref{gfx_capabilities}.@*
@xref{scroll_screen}.@*
@node poll_scroll, show_video_bitmap, request_scroll, Graphics
@subsection poll_scroll
@ftable @asis
@item @t{int poll_scroll();}
...
@xref{ex3buf}.@*
@xref{exupdate}.@*
@node show_video_bitmap, request_video_bitmap, poll_scroll, Graphics
@subsection show_video_bitmap
@ftable @asis
@item @t{int show_video_bitmap(BITMAP *bitmap);}
...
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node request_video_bitmap, vsync, show_video_bitmap, Graphics
@subsection request_video_bitmap
@ftable @asis
@item @t{int request_video_bitmap(BITMAP *bitmap);}
...
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node vsync, screen, request_video_bitmap, Graphics
@subsection vsync
@ftable @asis
@item @t{void vsync();}
...
@xref{scroll_screen}.@*
@xref{Available, Available Allegro examples}.@*
@node Bitmap, Loading, Graphics, API
@section Bitmap objects
...
* is_inside_bitmap::
@end menu
@node screen, SCREEN_W, vsync, Bitmap
@subsection screen
@ftable @asis
@item @t{extern BITMAP *screen;}
...
blit(bmp, screen, 0, 0, 0, 0, 320, 200);@end example
...
See also:@*
@xref{set_gfx_mode}.@*
@xref{is_screen_bitmap}.@*
@xref{create_video_bitmap}.@*
@xref{scroll_screen}.@*
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node SCREEN_W, VIRTUAL_W, screen, Bitmap
@subsection SCREEN_W
@ftable @asis
@item @t{#define SCREEN_W;}
@end ftable
@ftable @asis
@item @t{#define SCREEN_H;}
...
@xref{VIRTUAL_W, VIRTUAL_H}.@*
@xref{Available, Available Allegro examples}.@*
@node VIRTUAL_W, create_bitmap, SCREEN_W, Bitmap
@subsection VIRTUAL_W
@ftable @asis
@item @t{#define VIRTUAL_W;}
@end ftable
@ftable @asis
@item @t{#define VIRTUAL_H;}
...
@xref{SCREEN_W}.@*
@xref{SCREEN_W, SCREEN_H}.@*
@node create_bitmap, create_bitmap_ex, VIRTUAL_W, Bitmap
@subsection create_bitmap
@ftable @asis
@item @t{BITMAP *create_bitmap(int width, int height);}
...
destroy_bitmap(bmp);@end example
...
@end ftable
See also:@*
@xref{create_bitmap_ex}.@*
@xref{create_sub_bitmap}.@*
@xref{create_video_bitmap}.@*
@xref{create_system_bitmap}.@*
@xref{destroy_bitmap}.@*
@xref{set_color_depth}.@*
@xref{is_memory_bitmap}.@*
@xref{clear_bitmap}.@*
@xref{clear_to_color}.@*
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node create_bitmap_ex, create_sub_bitmap, create_bitmap, Bitmap
@subsection create_bitmap_ex
@ftable @asis
@item @t{BITMAP *create_bitmap_ex(int color_depth, int width, int height);}
...
@xref{extrans}.@*
@xref{BITMAP}.@*
@node create_sub_bitmap, create_video_bitmap, create_bitmap_ex, Bitmap
@subsection create_sub_bitmap
@ftable @asis
@item @t{BITMAP *create_sub_bitmap(BITMAP *parent, int x, y, width, height);}
...
@xref{exswitch}.@*
@xref{BITMAP}.@*
@node create_video_bitmap, create_system_bitmap, create_sub_bitmap, Bitmap
@subsection create_video_bitmap
@ftable @asis
@item @t{BITMAP *create_video_bitmap(int width, int height);}
...
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node create_system_bitmap, destroy_bitmap, create_video_bitmap, Bitmap
@subsection create_system_bitmap
@ftable @asis
@item @t{BITMAP *create_system_bitmap(int width, int height);}
...
@xref{create_sub_bitmap}.@*
@xref{destroy_bitmap}.@*
@xref{is_system_bitmap}.@*
@xref{clear_bitmap}.@*
@xref{clear_to_color}.@*
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node destroy_bitmap, lock_bitmap, create_system_bitmap, Bitmap
@subsection destroy_bitmap
@ftable @asis
@item @t{void destroy_bitmap(BITMAP *bitmap);}
...
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node lock_bitmap, bitmap_color_depth, destroy_bitmap, Bitmap
@subsection lock_bitmap
@ftable @asis
@item @t{void lock_bitmap(BITMAP *bitmap);}
...
@end ftable
@xref{BITMAP}.@*
@node bitmap_color_depth, bitmap_mask_color, lock_bitmap, Bitmap
@subsection bitmap_color_depth
@ftable @asis
@item @t{int bitmap_color_depth(BITMAP *bmp);}
...
@xref{exzbuf}.@*
@xref{BITMAP}.@*
@node bitmap_mask_color, is_same_bitmap, bitmap_color_depth, Bitmap
@subsection bitmap_mask_color
@ftable @asis
@item @t{int bitmap_mask_color(BITMAP *bmp);}
...
for (y = 0; y h; y++)
   for (x = 0; x w; x++)
      if (getpixel(bmp, x, y) == bitmap_mask_color(bmp))
         putpixel(bmp, x, y, another_color);@end example
...
@xref{expat}.@*
@xref{BITMAP}.@*
@node is_same_bitmap, is_planar_bitmap, bitmap_mask_color, Bitmap
@subsection is_same_bitmap
@ftable @asis
@item @t{int is_same_bitmap(BITMAP *bmp1, BITMAP *bmp2);}
...
@xref{create_sub_bitmap}.@*
@xref{BITMAP}.@*
@node is_planar_bitmap, is_linear_bitmap, is_same_bitmap, Bitmap
@subsection is_planar_bitmap
@ftable @asis
@item @t{int is_planar_bitmap(BITMAP *bmp);}
Returns TRUE if bmp is a planar (mode-X or Xtended mode) screen bitmap.

@end ftable
See also:@*
@xref{is_linear_bitmap}.@*
@xref{is_memory_bitmap}.@*
@xref{BITMAP}.@*
@node is_linear_bitmap, is_memory_bitmap, is_planar_bitmap, Bitmap
@subsection is_linear_bitmap
@ftable @asis
@item @t{int is_linear_bitmap(BITMAP *bmp);}
...
@end ftable
See also:@*
@xref{is_planar_bitmap}.@*
@xref{is_memory_bitmap}.@*
@xref{BITMAP}.@*
@node is_memory_bitmap, is_screen_bitmap, is_linear_bitmap, Bitmap
@subsection is_memory_bitmap
@ftable @asis
@item @t{int is_memory_bitmap(BITMAP *bmp);}
...
@xref{is_planar_bitmap}.@*
@xref{BITMAP}.@*
@node is_screen_bitmap, is_video_bitmap, is_memory_bitmap, Bitmap
@subsection is_screen_bitmap
@ftable @asis
@item @t{int is_screen_bitmap(BITMAP *bmp);}
...
@xref{create_sub_bitmap}.@*
@xref{BITMAP}.@*
@node is_video_bitmap, is_system_bitmap, is_screen_bitmap, Bitmap
@subsection is_video_bitmap
@ftable @asis
@item @t{int is_video_bitmap(BITMAP *bmp);}
...
@xref{create_sub_bitmap}.@*
@xref{BITMAP}.@*
@node is_system_bitmap, is_sub_bitmap, is_video_bitmap, Bitmap
@subsection is_system_bitmap
@ftable @asis
@item @t{int is_system_bitmap(BITMAP *bmp);}
...
@xref{create_sub_bitmap}.@*
@xref{BITMAP}.@*
@node is_sub_bitmap, acquire_bitmap, is_system_bitmap, Bitmap
@subsection is_sub_bitmap
@ftable @asis
@item @t{int is_sub_bitmap(BITMAP *bmp);}
...
@xref{create_sub_bitmap}.@*
@xref{BITMAP}.@*
@node acquire_bitmap, release_bitmap, is_sub_bitmap, Bitmap
@subsection acquire_bitmap
@ftable @asis
@item @t{void acquire_bitmap(BITMAP *bmp);}
...
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node release_bitmap, acquire_screen, acquire_bitmap, Bitmap
@subsection release_bitmap
@ftable @asis
@item @t{void release_bitmap(BITMAP *bmp);}
...
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node acquire_screen, release_screen, release_bitmap, Bitmap
@subsection acquire_screen
@ftable @asis
@item @t{void acquire_screen();}
...
@xref{release_screen}.@*
@xref{Available, Available Allegro examples}.@*
@node release_screen, set_clip_rect, acquire_screen, Bitmap
@subsection release_screen
@ftable @asis
@item @t{void release_screen();}
...
@xref{acquire_screen}.@*
@xref{Available, Available Allegro examples}.@*
@node set_clip_rect, get_clip_rect, release_screen, Bitmap
@subsection set_clip_rect
@ftable @asis
@item @t{void set_clip_rect(BITMAP *bitmap, int x1, int y1, int x2, int y2);}
...
set_clip_rect(bmp, 0, 0, -1, -1); /* disable drawing on bmp */@end example
...
@xref{excamera}.@*
@xref{BITMAP}.@*
@node get_clip_rect, add_clip_rect, set_clip_rect, Bitmap
@subsection get_clip_rect
@ftable @asis
@item @t{void get_clip_rect(BITMAP *bitmap, int *x1, int *y1, int *x2, int *y2);}
...
@xref{get_clip_state}.@*
@xref{BITMAP}.@*
@node add_clip_rect, set_clip_state, get_clip_rect, Bitmap
@subsection add_clip_rect
@ftable @asis
@item @t{void add_clip_rect(BITMAP *bitmap, int x1, int y1, int x2, int y2);}
...
@xref{get_clip_state}.@*
@xref{BITMAP}.@*
@node set_clip_state, get_clip_state, add_clip_rect, Bitmap
@subsection set_clip_state
@ftable @asis
@item @t{void set_clip_state(BITMAP *bitmap, int state)}
...
@xref{get_clip_state}.@*
@xref{BITMAP}.@*
@node get_clip_state, is_inside_bitmap, set_clip_state, Bitmap
@subsection get_clip_state
@ftable @asis
@item @t{int get_clip_state(BITMAP *bitmap)}
...
@xref{set_clip_state}.@*
@xref{BITMAP}.@*
@node is_inside_bitmap, load_bitmap, get_clip_state, Bitmap
@subsection is_inside_bitmap
@ftable @asis
@item @t{int is_inside_bitmap(BITMAP *bmp, int x, int y, int clip);}
...
@xref{getpixel}.@*
@xref{BITMAP}.@*
@node Loading, Palette, Bitmap, API
@section Loading image files
...
@end menu
@node load_bitmap, load_bmp, is_inside_bitmap, Loading
@subsection load_bitmap
@ftable @asis
@item @t{BITMAP *load_bitmap(const char *filename, RGB *pal);}
...
@xref{destroy_bitmap}.@*
@xref{save_bitmap}.@*
@xref{register_bitmap_file_type}.@*
@xref{set_color_depth}.@*
@xref{set_color_conversion}.@*
@xref{generate_optimized_palette}.@*
@xref{generate_332_palette}.@*
@xref{exaccel}.@*
@xref{exalpha}.@*
@xref{exbitmap}.@*
@xref{exblend}.@*
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node load_bmp, load_bmp_pf, load_bitmap, Loading
@subsection load_bmp
@ftable @asis
@item @t{BITMAP *load_bmp(const char *filename, RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node load_bmp_pf, load_lbm, load_bmp, Loading
@subsection load_bmp_pf
@ftable @asis
@item @t{BITMAP *load_bmp_pf(PACKFILE *f, RGB *pal);}
...
if (!bmp)
   abort_on_error("Error loading mybitmap.bmp");@end example
...
@xref{RGB}.@*
@xref{PACKFILE}.@*
@node load_lbm, load_pcx, load_bmp_pf, Loading
@subsection load_lbm
@ftable @asis
@item @t{BITMAP *load_lbm(const char *filename, RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node load_pcx, load_pcx_pf, load_lbm, Loading
@subsection load_pcx
@ftable @asis
@item @t{BITMAP *load_pcx(const char *filename, RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node load_pcx_pf, load_tga, load_pcx, Loading
@subsection load_pcx_pf
@ftable @asis
@item @t{BITMAP *load_pcx_pf(PACKFILE *f, RGB *pal);}
...
bmp = load_bmp_pf(packfile, pal);
if (!bmp)
   abort_on_error("Error loading mybitmap.pcx");@end example
...
@xref{RGB}.@*
@xref{PACKFILE}.@*
@node load_tga, load_tga_pf, load_pcx_pf, Loading
@subsection load_tga
@ftable @asis
@item @t{BITMAP *load_tga(const char *filename, RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node load_tga_pf, save_bitmap, load_tga, Loading
@subsection load_tga_pf
@ftable @asis
@item @t{BITMAP *load_tga_pf(PACKFILE *f, RGB *pal);}
...
bmp = load_bmp_pf(packfile, pal);
if (!bmp)
   abort_on_error("Error loading mybitmap.tga");@end example
...
@xref{RGB}.@*
@xref{PACKFILE}.@*
@node save_bitmap, save_bmp, load_tga_pf, Loading
@subsection save_bitmap
@ftable @asis
@item @t{int save_bitmap(const char *filename, BITMAP *bmp, const RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node save_bmp, save_bmp_pf, save_bitmap, Loading
@subsection save_bmp
@ftable @asis
@item @t{int save_bmp(const char *filename, BITMAP *bmp, const RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node save_bmp_pf, save_pcx, save_bmp, Loading
@subsection save_bmp_pf
@ftable @asis
@item @t{int save_bmp_pf(PACKFILE *f, BITMAP *bmp, RGB *pal);}
...
@xref{RGB}.@*
@xref{PACKFILE}.@*
@node save_pcx, save_pcx_pf, save_bmp_pf, Loading
@subsection save_pcx
@ftable @asis
@item @t{int save_pcx(const char *filename, BITMAP *bmp, const RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node save_pcx_pf, save_tga, save_pcx, Loading
@subsection save_pcx_pf
@ftable @asis
@item @t{int save_pcx_pf(PACKFILE *f, BITMAP *bmp, RGB *pal);}
...
@xref{RGB}.@*
@xref{PACKFILE}.@*
@node save_tga, save_tga_pf, save_pcx_pf, Loading
@subsection save_tga
@ftable @asis
@item @t{int save_tga(const char *filename, BITMAP *bmp, const RGB *pal);}
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node save_tga_pf, register_bitmap_file_type, save_tga, Loading
@subsection save_tga_pf
@ftable @asis
@item @t{int save_tga_pf(PACKFILE *f, BITMAP *bmp, RGB *pal);}
...
@xref{RGB}.@*
@xref{PACKFILE}.@*
@node register_bitmap_file_type, set_color_conversion, save_tga_pf, Loading
@subsection register_bitmap_file_type
@ftable @asis
@item @t{void register_bitmap_file_type(const char *ext, BITMAP *(*load)(const char *filename, RGB *pal), int (*save)(const char *filename, BITMAP *bmp, const RGB *pal));}
...
@}
   ...
   register_bitmap_file_type("dump", load_dump, save_dump);@end example
...
@xref{BITMAP}.@*
@xref{RGB}.@*
@node set_color_conversion, get_color_conversion, register_bitmap_file_type, Loading
@subsection set_color_conversion
@ftable @asis
@item @t{void set_color_conversion(int mode);}
...
@xref{load_datafile}.@*
@xref{fixup_datafile}.@*
@xref{makecol15_dither}.@*
@xref{get_color_conversion}.@*
@xref{exalpha}.@*
@xref{exblend}.@*
@xref{exdata}.@*
@xref{exexedat}.@*
@xref{exlights}.@*
@xref{exxfade}.@*
@node get_color_conversion, set_color, set_color_conversion, Loading
@subsection get_color_conversion
@ftable @asis
@item @t{int get_color_conversion();}
...
See also:@*
@xref{set_color_conversion}.@*
@node Palette, Truecolor, Loading, API
@section Palette routines
...
* desktop_palette::
@end menu
@node set_color, _set_color, get_color_conversion, Palette
@subsection set_color
@ftable @asis
@item @t{void set_color(int index, const RGB *p);}
...
@xref{exscroll}.@*
@xref{RGB}.@*
@node _set_color, set_palette, set_color, Palette
@subsection _set_color
@ftable @asis
@item @t{void _set_color(int index, const RGB *p);}
...
@xref{ex3buf}.@*
@xref{RGB}.@*
@node set_palette, set_palette_range, _set_color, Palette
@subsection set_palette
@ftable @asis
@item @t{void set_palette(const PALETTE p);}
...
set_palette(palette);@end example


@end ftable
See also:@*
@xref{set_gfx_mode}.@*
@xref{set_palette_range}.@*
@xref{set_color}.@*
@xref{get_palette}.@*
@xref{select_palette}.@*
@xref{palette_color}.@*
@xref{Available, Available Allegro examples}.@*
@xref{PALETTE}.@*
@node set_palette_range, get_color, set_palette, Palette
@subsection set_palette_range
@ftable @asis
@item @t{void set_palette_range(const PALETTE p, int from, int to, int vsync);}
...
set_palette_range(palette, 0, 15, 1);@end example


@end ftable
See also:@*
@xref{set_palette}.@*
@xref{get_palette_range}.@*
@xref{exzbuf}.@*
@xref{PALETTE}.@*
@node get_color, get_palette, set_palette_range, Palette
@subsection get_color
@ftable @asis
@item @t{void get_color(int index, RGB *p);}
Retrieves the specified palette entry. Example:
@example

RGB color;
...
get_color(11, &color);@end example
...
@xref{set_color}.@*
@xref{RGB}.@*
@node get_palette, get_palette_range, get_color, Palette
@subsection get_palette
@ftable @asis
@item @t{void get_palette(PALETTE p);}
...
@xref{set_palette}.@*
@xref{PALETTE}.@*
@node get_palette_range, fade_interpolate, get_palette, Palette
@subsection get_palette_range
@ftable @asis
@item @t{void get_palette_range(PALETTE p, int from, int to);}
...
@xref{set_palette_range}.@*
@xref{PALETTE}.@*
@node fade_interpolate, fade_from_range, get_palette_range, Palette
@subsection fade_interpolate
@ftable @asis
@item @t{void fade_interpolate(const PALETTE source, const PALETTE dest, PALETTE output, int pos, int from, int to);}
...
@xref{fade_from}.@*
@xref{PALETTE}.@*
@node fade_from_range, fade_in_range, fade_interpolate, Palette
@subsection fade_from_range
@ftable @asis
@item @t{void fade_from_range(const PALETTE source, const PALETTE dest, int speed, int from, int to);}
...
@xref{fade_from}.@*
@xref{PALETTE}.@*
@node fade_in_range, fade_out_range, fade_from_range, Palette
@subsection fade_in_range
@ftable @asis
@item @t{void fade_in_range(const PALETTE p, int speed, int from, int to);}
...
@xref{fade_in}.@*
@xref{PALETTE}.@*
@node fade_out_range, fade_from, fade_in_range, Palette
@subsection fade_out_range
@ftable @asis
@item @t{void fade_out_range(int speed, int from, int to);}
...
See also:@*
@xref{fade_out}.@*
@node fade_from, fade_in, fade_out_range, Palette
@subsection fade_from
@ftable @asis
@item @t{void fade_from(const PALETTE source, const PALETTE dest, int speed);}
...
@xref{fade_in}.@*
@xref{fade_out}.@*
@xref{fade_interpolate}.@*
@xref{fade_from_range}.@*
@xref{PALETTE}.@*
@node fade_in, fade_out, fade_from, Palette
@subsection fade_in
@ftable @asis
@item @t{void fade_in(const PALETTE p, int speed);}
...
@xref{fade_in_range}.@*
@xref{PALETTE}.@*
@node fade_out, select_palette, fade_in, Palette
@subsection fade_out
@ftable @asis
@item @t{void fade_out(int speed);}
...
@xref{fade_in_range}.@*
@xref{ex12bit}.@*
@node select_palette, unselect_palette, fade_out, Palette
@subsection select_palette
@ftable @asis
@item @t{void select_palette(const PALETTE p);}
...
See also:@*
@xref{set_palette}.@*
@xref{unselect_palette}.@*
@xref{exlights}.@*
@xref{PALETTE}.@*
@node unselect_palette, generate_332_palette, select_palette, Palette
@subsection unselect_palette
@ftable @asis
@item @t{void unselect_palette();}
...
See also:@*
@xref{select_palette}.@*
@node generate_332_palette, generate_optimized_palette, unselect_palette, Palette
@subsection generate_332_palette
@ftable @asis
@item @t{void generate_332_palette(PALETTE pal);}
...
@xref{exupdate}.@*
@xref{PALETTE}.@*
@node generate_optimized_palette, default_palette, generate_332_palette, Palette
@subsection generate_optimized_palette
@ftable @asis
@item @t{int generate_optimized_palette(BITMAP *bmp, PALETTE pal, const char rsvd[PAL_SIZE]);}
...
@xref{BITMAP}.@*
@xref{PALETTE}.@*
@node default_palette, black_palette, generate_optimized_palette, Palette
@subsection default_palette
@ftable @asis
@item @t{extern PALETTE default_palette;}
...
See also:@*
@xref{black_palette}.@*
@xref{desktop_palette}.@*
@xref{exjoy}.@*
@xref{PALETTE}.@*
@node black_palette, desktop_palette, default_palette, Palette
@subsection black_palette
@ftable @asis
@item @t{extern PALETTE black_palette;}
A palette containing solid black colors, used by the fade routines.

@end ftable
See also:@*
@xref{default_palette}.@*
@xref{desktop_palette}.@*
@xref{expal}.@*
@xref{PALETTE}.@*
@node desktop_palette, makecol8, black_palette, Palette
@subsection desktop_palette
@ftable @asis
@item @t{extern PALETTE desktop_palette;}
...
@xref{Available, Available Allegro examples}.@*
@xref{PALETTE}.@*
@node Truecolor, Drawing, Palette, API
@section Truecolor pixel formats
...
* MASK_COLOR_8::
@end menu
@node makecol8, makeacol32, desktop_palette, Truecolor
@subsection makecol8
@ftable @asis
@item @t{int makecol8(int r, int g, int b);}
@end ftable
@ftable @asis
@item @t{int makecol15(int r, int g, int b);}
@end ftable
@ftable @asis
@item @t{int makecol16(int r, int g, int b);}
@end ftable
@ftable @asis
@item @t{int makecol24(int r, int g, int b);}
@end ftable
@ftable @asis
@item @t{int makecol32(int r, int g, int b);}
...
int green_color = makecol16(0, 255, 0);@end example
...
@xref{set_color_depth}.@*
@xref{exrgbhsv}.@*
@node makeacol32, makecol, makecol8, Truecolor
@subsection makeacol32
@ftable @asis
@item @t{int makeacol32(int r, int g, int b, int a);}
...
See also:@*
@xref{makeacol}.@*
@xref{set_alpha_blender}.@*
@xref{set_write_alpha_blender}.@*
@node makecol, makecol_depth, makeacol32, Truecolor
@subsection makecol
@ftable @asis
@item @t{int makecol(int r, int g, int b);}
...
int green_color = makecol(0, 255, 0);@end example
...
@xref{set_color_depth}.@*
@xref{Available, Available Allegro examples}.@*
@node makecol_depth, makeacol, makecol, Truecolor
@subsection makecol_depth
@ftable @asis
@item @t{int makecol_depth(int color_depth, int r, int g, int b);}
Converts colors from a hardware independent format (red, green, and blue 
...
int green_15bit = makecol_depth(15, 0, 255, 0);@end example
...
@xref{rgb_map}.@*
@xref{set_color_depth}.@*
@node makeacol, makecol15_dither, makecol_depth, Truecolor
@subsection makeacol
@ftable @asis
@item @t{int makeacol(int r, int g, int b, int a);}
@end ftable
@ftable @asis
@item @t{int makeacol_depth(int color_depth, int r, int g, int b, int a);}
...
@xref{set_alpha_blender}.@*
@xref{set_write_alpha_blender}.@*
@node makecol15_dither, getr8, makeacol, Truecolor
@subsection makecol15_dither
@ftable @asis
@item @t{int makecol15_dither(int r, int g, int b, int x, int y);}
@end ftable
@ftable @asis
@item @t{int makecol16_dither(int r, int g, int b, int x, int y);}
...
pixel2 = makecol16_dither(255, 192, 64, 1, 0);@end example
...
@xref{makecol8}.@*
@xref{set_color_conversion}.@*
@node getr8, geta32, makecol15_dither, Truecolor
@subsection getr8
@ftable @asis
@item @t{int getr8(int c);}
@end ftable
@ftable @asis
@item @t{int getg8(int c);}
@end ftable
@ftable @asis
@item @t{int getb8(int c);}
@end ftable
@ftable @asis
@item @t{int getr15(int c);}
@end ftable
@ftable @asis
@item @t{int getg15(int c);}
@end ftable
@ftable @asis
@item @t{int getb15(int c);}
@end ftable
@ftable @asis
@item @t{int getr16(int c);}
@end ftable
@ftable @asis
@item @t{int getg16(int c);}
@end ftable
@ftable @asis
@item @t{int getb16(int c);}
@end ftable
@ftable @asis
@item @t{int getr24(int c);}
@end ftable
@ftable @asis
@item @t{int getg24(int c);}
@end ftable
@ftable @asis
@item @t{int getb24(int c);}
@end ftable
@ftable @asis
@item @t{int getr32(int c);}
@end ftable
@ftable @asis
@item @t{int getg32(int c);}
@end ftable
@ftable @asis
@item @t{int getb32(int c);}
...
b = getb15(color_value);@end example
...
@xref{makecol}.@*
@xref{set_color_depth}.@*
@node geta32, getr, getr8, Truecolor
@subsection geta32
@ftable @asis
@item @t{int geta32(int c);}
...
See also:@*
@xref{getr8}.@*
@node getr, getr_depth, geta32, Truecolor
@subsection getr
@ftable @asis
@item @t{int getr(int c);}
@end ftable
@ftable @asis
@item @t{int getg(int c);}
@end ftable
@ftable @asis
@item @t{int getb(int c);}
@end ftable
@ftable @asis
@item @t{int geta(int c);}
...
r = getr(color_value);
g = getg(color_value);
b = getb(color_value);@end example
...
@xref{set_color_depth}.@*
@xref{exalpha}.@*
@node getr_depth, palette_color, getr, Truecolor
@subsection getr_depth
@ftable @asis
@item @t{int getr_depth(int color_depth, int c);}
@end ftable
@ftable @asis
@item @t{int getg_depth(int color_depth, int c);}
@end ftable
@ftable @asis
@item @t{int getb_depth(int color_depth, int c);}
@end ftable
@ftable @asis
@item @t{int geta_depth(int color_depth, int c);}
...
b = getb_depth(bpp, color_value);@end example
...
@xref{set_color_depth}.@*
@xref{exlights}.@*
@node palette_color, MASK_COLOR_8, getr_depth, Truecolor
@subsection palette_color
@ftable @asis
@item @t{extern int palette_color[256];}
...
putpixel(screen, 100, 100, palette_color[2]);@end example
...
@xref{set_color_depth}.@*
@xref{Available, Available Allegro examples}.@*
@node MASK_COLOR_8, clear_bitmap, palette_color, Truecolor
@subsection MASK_COLOR_8
@ftable @asis
@item @t{#define MASK_COLOR_8 0}
@end ftable
@ftable @asis
@item @t{#define MASK_COLOR_15 (5.5.5 pink)}
@end ftable
@ftable @asis
@item @t{#define MASK_COLOR_16 (5.6.5 pink)}
@end ftable
@ftable @asis
@item @t{#define MASK_COLOR_24 (8.8.8 pink)}
@end ftable
@ftable @asis
@item @t{#define MASK_COLOR_32 (8.8.8 pink)}
...
@xref{draw_sprite}.@*
@xref{masked_blit}.@*
@node Drawing, Blitting, Truecolor, API
...
* floodfill::
@end menu
@node clear_bitmap, clear_to_color, MASK_COLOR_8, Drawing
@subsection clear_bitmap
@ftable @asis
@item @t{void clear_bitmap(BITMAP *bitmap);}
...
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node clear_to_color, putpixel, clear_bitmap, Drawing
@subsection clear_to_color
@ftable @asis
@item @t{void clear_to_color(BITMAP *bitmap, int color);}
Clears the bitmap to the specified color. Example:
@example

/* Clear the screen to red. */
clear_to_color(bmp, makecol(255, 0, 0));@end example
...
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node putpixel, _putpixel, clear_to_color, Drawing
@subsection putpixel
@ftable @asis
@item @t{void putpixel(BITMAP *bmp, int x, int y, int color);}
...
putpixel(screen, 10, 30, some_color);@end example
...
@xref{exswitch}.@*
@xref{BITMAP}.@*
@node _putpixel, getpixel, putpixel, Drawing
@subsection _putpixel
@ftable @asis
@item @t{void _putpixel(BITMAP *bmp, int x, int y, int color);}
@end ftable
@ftable @asis
@item @t{void _putpixel15(BITMAP *bmp, int x, int y, int color);}
@end ftable
@ftable @asis
@item @t{void _putpixel16(BITMAP *bmp, int x, int y, int color);}
@end ftable
@ftable @asis
@item @t{void _putpixel24(BITMAP *bmp, int x, int y, int color);}
@end ftable
@ftable @asis
@item @t{void _putpixel32(BITMAP *bmp, int x, int y, int color);}
...
@xref{makecol}.@*
@xref{BITMAP}.@*
@node getpixel, _getpixel, _putpixel, Drawing
@subsection getpixel
@ftable @asis
@item @t{int getpixel(BITMAP *bmp, int x, int y);}
...
@xref{putpixel}.@*
@xref{_getpixel}.@*
@xref{is_inside_bitmap}.@*
@xref{getr}.@*
@xref{getr, getg}.@*
@xref{getr, getb}.@*
@xref{getr, geta}.@*
@xref{Truecolor, Truecolor pixel formats}.@*
@xref{Palette, Palette routines}.@*
@xref{ex12bit}.@*
@xref{exalpha}.@*
@xref{exflame}.@*
@xref{exlights}.@*
@xref{BITMAP}.@*
@node _getpixel, vline, getpixel, Drawing
@subsection _getpixel
@ftable @asis
@item @t{int _getpixel(BITMAP *bmp, int x, int y);}
@end ftable
@ftable @asis
@item @t{int _getpixel15(BITMAP *bmp, int x, int y);}
@end ftable
@ftable @asis
@item @t{int _getpixel16(BITMAP *bmp, int x, int y);}
@end ftable
@ftable @asis
@item @t{int _getpixel24(BITMAP *bmp, int x, int y);}
@end ftable
@ftable @asis
@item @t{int _getpixel32(BITMAP *bmp, int x, int y);}
...
@xref{getpixel}.@*
@xref{BITMAP}.@*
@node vline, hline, _getpixel, Drawing
@subsection vline
@ftable @asis
@item @t{void vline(BITMAP *bmp, int x, int y1, int y2, int color);}
...
@xref{extruec}.@*
@xref{BITMAP}.@*
@node hline, do_line, vline, Drawing
@subsection hline
@ftable @asis
@item @t{void hline(BITMAP *bmp, int x1, int y, int x2, int color);}
...
@xref{exsprite}.@*
@xref{BITMAP}.@*
@node do_line, line, hline, Drawing
@subsection do_line
@ftable @asis
@item @t{void do_line(BITMAP *bmp, int x1, y1, x2, y2, int d,  void (*proc)(BITMAP *bmp, int x, int y, int d));}
...
@}
   ...
   do_line(screen, 0, 0, SCREEN_W-1, SCREEN_H-2,
           dust_strength, draw_dust_particle);@end example
...
@xref{line}.@*
@xref{BITMAP}.@*
@node line, fastline, do_line, Drawing
@subsection line
@ftable @asis
@item @t{void line(BITMAP *bmp, int x1, int y1, int x2, int y2, int color);}
...
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node fastline, triangle, line, Drawing
@subsection fastline
@ftable @asis
@item @t{void fastline(BITMAP *bmp, int x1, int y1, int x2, int y2, int color);}
...
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node triangle, polygon, fastline, Drawing
@subsection triangle
@ftable @asis
@item @t{void triangle(BITMAP *bmp, int x1, y1, x2, y2, x3, y3, int color);}
...
@xref{exupdate}.@*
@xref{BITMAP}.@*
@node polygon, rect, triangle, Drawing
@subsection polygon
@ftable @asis
@item @t{void polygon(BITMAP *bmp, int vertices, const int *points, int color);}
...
polygon(screen, 6, points, makecol(0, 0, 0));@end example
...
@xref{excamera}.@*
@xref{BITMAP}.@*
@node rect, rectfill, polygon, Drawing
@subsection rect
@ftable @asis
@item @t{void rect(BITMAP *bmp, int x1, int y1, int x2, int y2, int color);}
...
@xref{excamera}.@*
@xref{BITMAP}.@*
@node rectfill, do_circle, rect, Drawing
@subsection rectfill
@ftable @asis
@item @t{void rectfill(BITMAP *bmp, int x1, int y1, int x2, int y2, int color);}
...
@xref{extrans}.@*
@xref{BITMAP}.@*
@node do_circle, circle, rectfill, Drawing
@subsection do_circle
@ftable @asis
@item @t{void do_circle(BITMAP *bmp, int x, int y, int radius, int d, void (*proc)(BITMAP *bmp, int x, int y, int d));}
...
@}
   ...
   do_circle(screen, SCREEN_W/2, SCREEN_H/2,
             ...
             draw_explosion_ring);@end example
...
@xref{circlefill}.@*
@xref{BITMAP}.@*
@node circle, circlefill, do_circle, Drawing
@subsection circle
@ftable @asis
@item @t{void circle(BITMAP *bmp, int x, int y, int radius, int color);}
...
@xref{exsprite}.@*
@xref{BITMAP}.@*
@node circlefill, do_ellipse, circle, Drawing
@subsection circlefill
@ftable @asis
@item @t{void circlefill(BITMAP *bmp, int x, int y, int radius, int color);}
...
@xref{extrans}.@*
@xref{BITMAP}.@*
@node do_ellipse, ellipse, circlefill, Drawing
@subsection do_ellipse
@ftable @asis
@item @t{void do_ellipse(BITMAP *bmp, int x, int y, int rx, ry, int d, void (*proc)(BITMAP *bmp, int x, int y, int d));}
...
@xref{ellipsefill}.@*
@xref{BITMAP}.@*
@node ellipse, ellipsefill, do_ellipse, Drawing
@subsection ellipse
@ftable @asis
@item @t{void ellipse(BITMAP *bmp, int x, int y, int rx, int ry, int color);}
...
@xref{makecol}.@*
@xref{BITMAP}.@*
@node ellipsefill, do_arc, ellipse, Drawing
@subsection ellipsefill
@ftable @asis
@item @t{void ellipsefill(BITMAP *bmp, int x, int y, int rx, int ry, int color);}
...
@xref{ex12bit}.@*
@xref{BITMAP}.@*
@node do_arc, arc, ellipsefill, Drawing
@subsection do_arc
@ftable @asis
@item @t{void do_arc(BITMAP *bmp, int x, int y, fixed a1, fixed a2, int r, int d, void (*proc)(BITMAP *bmp, int x, int y, int d));}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node arc, calc_spline, do_arc, Drawing
@subsection arc
@ftable @asis
@item @t{void arc(BITMAP *bmp, int x, y, fixed ang1, ang2, int r, int color);}
...
arc(screen, SCREEN_W/2, SCREEN_H/2,
    itofix(-21), itofix(43), 50, makecol(0, 0, 0));@end example
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node calc_spline, spline, arc, Drawing
@subsection calc_spline
@ftable @asis
@item @t{void calc_spline(const int points[8], int npts, int *x, int *y);}
...
@xref{spline}.@*
@xref{exspline}.@*
@node spline, floodfill, calc_spline, Drawing
@subsection spline
@ftable @asis
@item @t{void spline(BITMAP *bmp, const int points[8], int color);}
...
@xref{exspline}.@*
@xref{BITMAP}.@*
@node floodfill, blit, spline, Drawing
@subsection floodfill
@ftable @asis
@item @t{void floodfill(BITMAP *bmp, int x, int y, int color);}
...
@xref{makecol}.@*
@xref{BITMAP}.@*
@node Blitting, RLE, Drawing, API
@section Blitting and sprites
...
@end menu
@node blit, stretch_blit, floodfill, Blitting
@subsection blit
@ftable @asis
@item @t{void blit(BITMAP *source, BITMAP *dest, int source_x, int source_y, int dest_x, int dest_y, int width, int height);}
...
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@node stretch_blit, masked_blit, blit, Blitting
@subsection stretch_blit
@ftable @asis
@item @t{void stretch_blit(BITMAP *source, BITMAP *dest, int source_x, source_y, source_width, source_height, int dest_x, dest_y, dest_width, dest_height);}
...
stretch_blit(bmp, screen, 0, 0, bmp->w, bmp->h,
             0, 0, SCREEN_W, SCREEN_H);@end example


@end ftable
See also:@*
@xref{blit}.@*
@xref{masked_stretch_blit}.@*
@xref{stretch_sprite}.@*
@xref{exalpha}.@*
@xref{exconfig}.@*
@xref{exscale}.@*
@xref{extrans}.@*
@xref{BITMAP}.@*
@node masked_blit, masked_stretch_blit, stretch_blit, Blitting
@subsection masked_blit
@ftable @asis
@item @t{void masked_blit(BITMAP *source, BITMAP *dest, int source_x, int source_y, int dest_x, int dest_y, int width, int height);}
...
masked_blit(hud_overlay, screen, 0, 0, 0, 0,
            hud_overlay->w, hud_overlay->h);@end example
...
@xref{expat}.@*
@xref{BITMAP}.@*
@node masked_stretch_blit, draw_sprite, masked_blit, Blitting
@subsection masked_stretch_blit
@ftable @asis
@item @t{void masked_stretch_blit(BITMAP *source, BITMAP *dest, int source_x, source_y, source_w, source_h, int dest_x, dest_y, dest_w, dest_h);}
...
@xref{stretch_sprite}.@*
@xref{BITMAP}.@*
@node draw_sprite, stretch_sprite, masked_stretch_blit, Blitting
@subsection draw_sprite
@ftable @asis
@item @t{void draw_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y);}
...
BITMAP *spaceship;
...
draw_sprite(screen, spaceship, x, y);@end example
...
@end ftable
See also:@*
@xref{draw_sprite_v_flip}.@*
@xref{draw_trans_sprite}.@*
@xref{draw_lit_sprite}.@*
@xref{draw_gouraud_sprite}.@*
@xref{stretch_sprite}.@*
@xref{rotate_sprite}.@*
@xref{draw_character_ex}.@*
@xref{draw_rle_sprite}.@*
@xref{draw_compiled_sprite}.@*
@xref{masked_blit}.@*
@xref{blit}.@*
@xref{bitmap_mask_color}.@*
@xref{exsprite}.@*
@xref{BITMAP}.@*
@node stretch_sprite, draw_sprite_v_flip, draw_sprite, Blitting
@subsection stretch_sprite
@ftable @asis
@item @t{void stretch_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, int w, int h);}
...
@xref{bitmap_mask_color}.@*
@xref{BITMAP}.@*
@node draw_sprite_v_flip, draw_trans_sprite, stretch_sprite, Blitting
@subsection draw_sprite_v_flip
@ftable @asis
@item @t{void draw_sprite_v_flip(BITMAP *bmp, BITMAP *sprite, int x, int y);}
@end ftable
@ftable @asis
@item @t{void draw_sprite_h_flip(BITMAP *bmp, BITMAP *sprite, int x, int y);}
@end ftable
@ftable @asis
@item @t{void draw_sprite_vh_flip(BITMAP *bmp, BITMAP *sprite, int x, int y);}
...
if (key[KEY_RIGHT])
   ...
   draw_sprite(screen, hero_idle, pos_x, pos_y);@end example
...
@xref{exsprite}.@*
@xref{BITMAP}.@*
@node draw_trans_sprite, draw_lit_sprite, draw_sprite_v_flip, Blitting
@subsection draw_trans_sprite
@ftable @asis
@item @t{void draw_trans_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y);}
...
draw_trans_sprite(buffer, ghost_sprite, x, y);@end example
...
@xref{draw_sprite}.@*
@xref{draw_lit_sprite}.@*
@xref{draw_trans_rle_sprite}.@*
@xref{color_map}.@*
@xref{set_trans_blender}.@*
@xref{set_alpha_blender}.@*
@xref{set_write_alpha_blender}.@*
@xref{bitmap_mask_color}.@*
@xref{exalpha}.@*
...
@xref{exxfade}.@*
@xref{BITMAP}.@*
@node draw_lit_sprite, draw_gouraud_sprite, draw_trans_sprite, Blitting
@subsection draw_lit_sprite
@ftable @asis
@item @t{void draw_lit_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, int color);}
...
draw_lit_sprite(buffer, colored_cape, x, y, 64);@end example
...
@xref{draw_trans_sprite}.@*
@xref{draw_gouraud_sprite}.@*
@xref{draw_lit_rle_sprite}.@*
@xref{color_map}.@*
@xref{set_trans_blender}.@*
@xref{bitmap_mask_color}.@*
@xref{exblend}.@*
@xref{BITMAP}.@*
@node draw_gouraud_sprite, draw_character_ex, draw_lit_sprite, Blitting
@subsection draw_gouraud_sprite
@ftable @asis
@item @t{void draw_gouraud_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, int c1, int c2, int c3, int c4);}
...
draw_gouraud_sprite(buffer, menacing_spy, x, y,
                    ...
                    light_strength_on_corner_4);@end example
...
@xref{exshade}.@*
@xref{BITMAP}.@*
@node draw_character_ex, rotate_sprite, draw_gouraud_sprite, Blitting
@subsection draw_character_ex
@ftable @asis
@item @t{void draw_character_ex(BITMAP *bmp, BITMAP *sprite, int x, int y, color, bg);}
Draws a copy of the sprite bitmap onto the destination bitmap at the 
...
@xref{bitmap_mask_color}.@*
@xref{BITMAP}.@*
@node rotate_sprite, rotate_sprite_v_flip, draw_character_ex, Blitting
@subsection rotate_sprite
@ftable @asis
@item @t{void rotate_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, fixed angle);}
...
See also:@*
@xref{draw_sprite}.@*
@xref{rotate_scaled_sprite}.@*
@xref{rotate_sprite_v_flip}.@*
@xref{rotate_scaled_sprite_v_flip}.@*
@xref{pivot_sprite}.@*
@xref{pivot_sprite_v_flip}.@*
@xref{pivot_scaled_sprite}.@*
@xref{pivot_scaled_sprite_v_flip}.@*
@xref{itofix}.@*
@xref{Fixed point trig}.@*
@xref{exsprite}.@*
@xref{fixed}.@*
@xref{BITMAP}.@*
@node rotate_sprite_v_flip, rotate_scaled_sprite, rotate_sprite, Blitting
@subsection rotate_sprite_v_flip
@ftable @asis
@item @t{void rotate_sprite_v_flip(BITMAP *bmp, BITMAP *sprite, int x, int y, fixed angle);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node rotate_scaled_sprite, rotate_scaled_sprite_v_flip, rotate_sprite_v_flip, Blitting
@subsection rotate_scaled_sprite
@ftable @asis
@item @t{void rotate_scaled_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, fixed angle, fixed scale);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node rotate_scaled_sprite_v_flip, pivot_sprite, rotate_scaled_sprite, Blitting
@subsection rotate_scaled_sprite_v_flip
@ftable @asis
@item @t{void rotate_scaled_sprite_v_flip(BITMAP *bmp, BITMAP *sprite, int x, int y, fixed angle, fixed scale);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node pivot_sprite, pivot_sprite_v_flip, rotate_scaled_sprite_v_flip, Blitting
@subsection pivot_sprite
@ftable @asis
@item @t{void pivot_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, int cx, int cy, fixed angle);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node pivot_sprite_v_flip, pivot_scaled_sprite, pivot_sprite, Blitting
@subsection pivot_sprite_v_flip
@ftable @asis
@item @t{void pivot_sprite_v_flip(BITMAP *bmp, BITMAP *sprite, int x, int y, int cx, int cy, fixed angle);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node pivot_scaled_sprite, pivot_scaled_sprite_v_flip, pivot_sprite_v_flip, Blitting
@subsection pivot_scaled_sprite
@ftable @asis
@item @t{void pivot_scaled_sprite(BITMAP *bmp, BITMAP *sprite, int x, int y, int cx, int cy, fixed angle, fixed scale);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node pivot_scaled_sprite_v_flip, get_rle_sprite, pivot_scaled_sprite, Blitting
@subsection pivot_scaled_sprite_v_flip
@ftable @asis
@item @t{void pivot_scaled_sprite_v_flip(BITMAP *bmp, BITMAP *sprite, int x, int y, int cx, int cy, fixed angle, fixed scale);}
...
@xref{fixed}.@*
@xref{BITMAP}.@*
@node RLE, Compiled, Blitting, API
@section RLE sprites
...
* draw_lit_rle_sprite::
@end menu
@node get_rle_sprite, destroy_rle_sprite, pivot_scaled_sprite_v_flip, RLE
@subsection get_rle_sprite
@ftable @asis
@item @t{RLE_SPRITE *get_rle_sprite(BITMAP *bitmap);}
...
...
/* Destroy it when we don't need it any more. */
destroy_rle_sprite(rle);@end example
...
See also:@*
@xref{draw_rle_sprite}.@*
@xref{destroy_rle_sprite}.@*
@xref{BITMAP}.@*
@xref{RLE_SPRITE}.@*
@node destroy_rle_sprite, draw_rle_sprite, get_rle_sprite, RLE
@subsection destroy_rle_sprite
@ftable @asis
@item @t{void destroy_rle_sprite(RLE_SPRITE *sprite);}
...
@xref{get_rle_sprite}.@*
@xref{RLE_SPRITE}.@*
@node draw_rle_sprite, draw_trans_rle_sprite, destroy_rle_sprite, RLE
@subsection draw_rle_sprite
@ftable @asis
@item @t{void draw_rle_sprite(BITMAP *bmp, const RLE_SPRITE *sprite, int x, int y);}
Draws an RLE sprite onto a bitmap at the specified position. Example:
@example

RLE_SPRITE *rle_sprite;
...
draw_rle_sprite(screen, rle_sprite, 100, 100);@end example
...
@xref{BITMAP}.@*
@xref{RLE_SPRITE}.@*
@node draw_trans_rle_sprite, draw_lit_rle_sprite, draw_rle_sprite, RLE
@subsection draw_trans_rle_sprite
@ftable @asis
@item @t{void draw_trans_rle_sprite(BITMAP *bmp, const RLE_SPRITE *sprite, int x, int y);}
...
draw_trans_rle_sprite(buffer, rle_ghost_sprite, x, y);@end example
...
@xref{BITMAP}.@*
@xref{RLE_SPRITE}.@*
@node draw_lit_rle_sprite, get_compiled_sprite, draw_trans_rle_sprite, RLE
@subsection draw_lit_rle_sprite
@ftable @asis
@item @t{void draw_lit_rle_sprite(BITMAP *bmp, const RLE_SPRITE *sprite, int x, y, color);}
...
/* Lit the cape with a blueish light. */
draw_lit_rle_sprite(buffer, rle_colored_cape, x, y, 64);@end example
...
@xref{BITMAP}.@*
@xref{RLE_SPRITE}.@*
@node Compiled, Fonts, RLE, API
@section Compiled sprites
...
@end menu
@node get_compiled_sprite, destroy_compiled_sprite, draw_lit_rle_sprite, Compiled
@subsection get_compiled_sprite
@ftable @asis
@item @t{COMPILED_SPRITE *get_compiled_sprite(BITMAP *bitmap, int planar);}
...
See also:@*
@xref{draw_compiled_sprite}.@*
@xref{destroy_compiled_sprite}.@*
@xref{BITMAP}.@*
@xref{COMPILED_SPRITE}.@*
@node destroy_compiled_sprite, draw_compiled_sprite, get_compiled_sprite, Compiled
@subsection destroy_compiled_sprite
@ftable @asis
@item @t{void destroy_compiled_sprite(COMPILED_SPRITE *sprite);}
...
@xref{get_compiled_sprite}.@*
@xref{COMPILED_SPRITE}.@*
@node draw_compiled_sprite, register_font_file_type, destroy_compiled_sprite, Compiled
@subsection draw_compiled_sprite
@ftable @asis
@item @t{void draw_compiled_sprite(BITMAP *bmp, const COMPILED_SPRITE *sprite, int x, int y);}
...
* load_txt_font::
@end menu
@node register_font_file_type, load_font, draw_compiled_sprite, Fonts
@subsection register_font_file_type
@ftable @asis
@item @t{void register_font_file_type(const char *ext, FONT *(*load)(const char *filename, RGB *pal, void *param));}
...
@xref{RGB}.@*
@xref{FONT}.@*
@node load_font, destroy_font, register_font_file_type, Fonts
@subsection load_font
@ftable @asis
@item @t{FONT *load_font(const char *filename, RGB *pal, void *param);}
...
...
destroy_font(myfont);@end example
...
@xref{RGB}.@*
@xref{FONT}.@*
@node destroy_font, make_trans_font, load_font, Fonts
@subsection destroy_font
@ftable @asis
@item @t{void destroy_font(FONT *f);}
...
@xref{exfont}.@*
@xref{FONT}.@*
@node make_trans_font, is_trans_font, destroy_font, Fonts
@subsection make_trans_font
@ftable @asis
@item @t{void make_trans_font(FONT *f);}
...
make_trans_font(f);
set_alpha_blender();
textprintf_centre_ex(screen, f, 320, 240, -1, -1, "Anti-aliased Font!");@end example
...
@xref{draw_trans_sprite}.@*
@xref{FONT}.@*
@node is_trans_font, is_color_font, make_trans_font, Fonts
@subsection is_trans_font
@ftable @asis
@item @t{int is_trans_font(FONT *f)}
...
@end ftable
See also:@*
@xref{make_trans_font}.@*
@xref{is_color_font}.@*
@xref{is_mono_font}.@*
@xref{FONT}.@*
@node is_color_font, is_mono_font, is_trans_font, Fonts
@subsection is_color_font
@ftable @asis
@item @t{int is_color_font(FONT *f)}
...
@xref{is_mono_font}.@*
@xref{FONT}.@*
@node is_mono_font, font_has_alpha, is_color_font, Fonts
@subsection is_mono_font
@ftable @asis
@item @t{int is_mono_font(FONT *f)}
...
@xref{is_color_font}.@*
@xref{FONT}.@*
@node font_has_alpha, is_compatible_font, is_mono_font, Fonts
@subsection font_has_alpha
@ftable @asis
@item @t{int font_has_alpha(FONT *f)}
...
@xref{is_trans_font}.@*
@xref{FONT}.@*
@node is_compatible_font, get_font_ranges, font_has_alpha, Fonts
@subsection is_compatible_font
@ftable @asis
@item @t{int *is_compatible_font(FONT *f1, FONT *f2)}
...
@xref{is_mono_font}.@*
@xref{FONT}.@*
@node get_font_ranges, get_font_range_begin, is_compatible_font, Fonts
@subsection get_font_ranges
@ftable @asis
@item @t{int get_font_ranges(FONT *f)}
...
for (n = 0; n < range; n++)
   printf("Range %d from 0x%03x - 0x%03x\n",
          ...
          get_font_range_end(f, n));@end example
...
@xref{transpose_font}.@*
@xref{FONT}.@*
@node get_font_range_begin, get_font_range_end, get_font_ranges, Fonts
@subsection get_font_range_begin
@ftable @asis
@item @t{int get_font_range_begin(FONT *f, int range)}
...
printf("The font has a character range of %d - %d\n",
       ...
       get_font_range_end(font, -1));@end example
...
@end ftable
See also:@*
@xref{get_font_ranges}.@*
@xref{get_font_range_end}.@*
@xref{transpose_font}.@*
@xref{FONT}.@*
@node get_font_range_end, extract_font_range, get_font_range_begin, Fonts
@subsection get_font_range_end
@ftable @asis
@item @t{int get_font_range_end(FONT *f, int range)}
...
@xref{transpose_font}.@*
@xref{FONT}.@*
@node extract_font_range, transpose_font, get_font_range_end, Fonts
@subsection extract_font_range
@ftable @asis
@item @t{FONT *extract_font_range(FONT *f, int begin, int end)}
...
destroy_font(fontcopy);@end example
...
@xref{exfont}.@*
@xref{FONT}.@*
@node transpose_font, merge_fonts, extract_font_range, Fonts
@subsection transpose_font
@ftable @asis
@item @t{int transpose_font(FONT *f, int drange)}
...
textout_ex(screen, capitals, "allcaps",
           100, 100, makecol(255,255,255), 0);@end example
...
@xref{get_font_range_end}.@*
@xref{merge_fonts}.@*
@xref{extract_font_range}.@*
@xref{FONT}.@*
@node merge_fonts, load_dat_font, transpose_font, Fonts
@subsection merge_fonts
@ftable @asis
@item @t{FONT *merge_fonts(FONT *f1, FONT *f2)}
...
destroy_font(capitals);
destroy_font(tempfont);@end example
...
@xref{exfont}.@*
@xref{FONT}.@*
@node load_dat_font, load_bios_font, merge_fonts, Fonts
@subsection load_dat_font
@ftable @asis
@item @t{FONT *load_dat_font(const char *filename, RGB *pal, void *param)}
...
f = load_dat_font("fonts.dat", NULL, names);@end example
...
@xref{RGB}.@*
@xref{FONT}.@*
@node load_bios_font, load_grx_font, load_dat_font, Fonts
@subsection load_bios_font
@ftable @asis
@item @t{FONT *load_bios_font(const char *filename, RGB *pal, void *param)}
...
@xref{RGB}.@*
@xref{FONT}.@*
@node load_grx_font, load_grx_or_bios_font, load_bios_font, Fonts
@subsection load_grx_font
@ftable @asis
@item @t{FONT *load_grx_font(const char *filename, RGB *pal, void *param)}
...
@xref{RGB}.@*
@xref{FONT}.@*
@node load_grx_or_bios_font, load_bitmap_font, load_grx_font, Fonts
@subsection load_grx_or_bios_font
@ftable @asis
@item @t{FONT *load_grx_or_bios_font(const char *filename, RGB *pal, void *param)}
...
@xref{RGB}.@*
@xref{FONT}.@*
@node load_bitmap_font, grab_font_from_bitmap, load_grx_or_bios_font, Fonts
@subsection load_bitmap_font
@ftable @asis
@item @t{FONT *load_bitmap_font(const char *filename, RGB *pal, void *param)}
...
@xref{RGB}.@*
@xref{FONT}.@*
@node grab_font_from_bitmap, load_txt_font, load_bitmap_font, Fonts
@subsection grab_font_from_bitmap
@ftable @asis
@item @t{FONT *grab_font_from_bitmap(BITMAP *bmp)}
...
@xref{BITMAP}.@*
@xref{FONT}.@*
@node load_txt_font, font, grab_font_from_bitmap, Fonts
@subsection load_txt_font
@ftable @asis
@item @t{FONT *load_txt_font(const char *filename, RGB *pal, void *param)}
...
@end menu
@node font, allegro_404_char, load_txt_font, Text
@subsection font
@ftable @asis
@item @t{extern FONT *font;}
...
@xref{Available, Available Allegro examples}.@*
@xref{FONT}.@*
@node allegro_404_char, text_length, font, Text
@subsection allegro_404_char
@ftable @asis
@item @t{extern int allegro_404_char;}
...
allegro_404_char = '*';@end example


@end ftable
See also:@*
@xref{font}.@*
@node text_length, text_height, allegro_404_char, Text
@subsection text_length
@ftable @asis
@item @t{int text_length(const FONT *f, const char *str);}
Returns the length (in pixels) of a string in the specified font. Example:
@example

int width = text_length(font, "I love spam");
...
bmp = create_bitmap(width, height);@end example
...
@xref{exunicod}.@*
@xref{FONT}.@*
@node text_height, textout_ex, text_length, Text
@subsection text_height
@ftable @asis
@item @t{int text_height(const FONT *f)}
...
@xref{exunicod}.@*
@xref{FONT}.@*
@node textout_ex, textout_centre_ex, text_height, Text
@subsection textout_ex
@ftable @asis
@item @t{void textout_ex(BITMAP *bmp, const FONT *f, const char *s, int x, int y, int color, int bg);}
...
@xref{textout_right_ex}.@*
@xref{textout_justify_ex}.@*
@xref{textprintf_ex}.@*
@xref{text_height}.@*
@xref{text_length}.@*
@xref{Available, Available Allegro examples}.@*
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textout_centre_ex, textout_right_ex, textout_ex, Text
@subsection textout_centre_ex
@ftable @asis
@item @t{void textout_centre_ex(BITMAP *bmp, const FONT *f, const char *s, int x, y, int color, int bg);}
...
textout_centre_ex(screen, font, "GAME OVER",
                  ...
                  makecol(255, 0, 0), makecol(0, 0, 0));@end example
...
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textout_right_ex, textout_justify_ex, textout_centre_ex, Text
@subsection textout_right_ex
@ftable @asis
@item @t{void textout_right_ex(BITMAP *bmp, const FONT *f, const char *s, int x, int y, int color, int bg);}
Like textout_ex(), but interprets the x coordinate as the right rather
than the left edge of the string. Example:
@example

textout_right_ex(screen, font, "Look at this color!",
                 SCREEN_W - 10, 10, my_yellow, -1);@end example


@end ftable
See also:@*
@xref{textout_ex}.@*
@xref{textprintf_right_ex}.@*
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textout_justify_ex, textprintf_ex, textout_right_ex, Text
@subsection textout_justify_ex
@ftable @asis
@item @t{void textout_justify_ex(BITMAP *bmp, const FONT *f, const char *s, int x1, int x2, int y, int diff, int color, int bg);}
...
for (num = 0, y = 0; lines[num]; num++, y += text_height(font))
   textout_justify_ex(screen, font, lines[num], 0, 200,
                      y, 80, makecol(0, 0, 0),
                      makecol(255, 255, 255));@end example


@end ftable
See also:@*
@xref{textout_ex}.@*
@xref{textprintf_justify_ex}.@*
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textprintf_ex, textprintf_centre_ex, textout_justify_ex, Text
@subsection textprintf_ex
@ftable @asis
@item @t{void textprintf_ex(BITMAP *bmp, const FONT *f, int x, int y, int color, int bg, const char *fmt, ...);}
...
textprintf_ex(screen, font, 10, 10, makecol(255, 100, 200),
              -1, "Score: %d", player_score);@end example
...
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textprintf_centre_ex, textprintf_right_ex, textprintf_ex, Text
@subsection textprintf_centre_ex
@ftable @asis
@item @t{void textprintf_centre_ex(BITMAP *bmp, const FONT *f, int x, int y, int color, int bg, const char *fmt, ...);}
...
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textprintf_right_ex, textprintf_justify_ex, textprintf_centre_ex, Text
@subsection textprintf_right_ex
@ftable @asis
@item @t{void textprintf_right_ex(BITMAP *bmp, const FONT *f, int x, y, color, bg, const char *fmt, ...);}
...
textprintf_right_ex(screen, font, SCREEN_W - 10, 10,
                    ...
                    "%d bullets left", player_ammo);@end example
...
@xref{BITMAP}.@*
@xref{FONT}.@*
@node textprintf_justify_ex, POLYTYPE_FLAT, textprintf_right_ex, Text
@subsection textprintf_justify_ex
@ftable @asis
@item @t{void textprintf_justify_ex(BITMAP *bmp, const FONT *f, int x1, x2, y, diff, color, bg, const char *fmt, ...);}
...
@xref{BITMAP}.@*
@xref{FONT}.@*
@node Polygon, Transparency, Text, API
@section Polygon rendering
...
* scene_gap::
@end menu
@node POLYTYPE_FLAT, POLYTYPE_GCOL, textprintf_justify_ex, Polygon
@subsection POLYTYPE_FLAT
@ftable @asis
@item @t{#define POLYTYPE_FLAT}
...
@end ftable
See also:@*
@xref{Polygon, Polygon rendering}.@*
@xref{polygon3d}.@*
@xref{drawing_mode}.@*
@xref{ex3d}.@*
@xref{excamera}.@*
@node POLYTYPE_GCOL, POLYTYPE_GRGB, POLYTYPE_FLAT, Polygon
@subsection POLYTYPE_GCOL
@ftable @asis
@item @t{#define POLYTYPE_GCOL}
...
@xref{exscn3d}.@*
@xref{exzbuf}.@*
@node POLYTYPE_GRGB, POLYTYPE_ATEX, POLYTYPE_GCOL, Polygon
@subsection POLYTYPE_GRGB
@ftable @asis
@item @t{#define POLYTYPE_GRGB}
...
@xref{rgb_map}.@*
@xref{ex3d}.@*
@node POLYTYPE_ATEX, POLYTYPE_PTEX, POLYTYPE_GRGB, Polygon
@subsection POLYTYPE_ATEX
@ftable @asis
@item @t{#define POLYTYPE_ATEX}
...
@xref{polygon3d}.@*
@xref{ex3d}.@*
@node POLYTYPE_PTEX, POLYTYPE_ATEX_MASK, POLYTYPE_ATEX, Polygon
@subsection POLYTYPE_PTEX
@ftable @asis
@item @t{#define POLYTYPE_PTEX}
...
@xref{POLYTYPE_ATEX}.@*
@xref{ex3d}.@*
@node POLYTYPE_ATEX_MASK, POLYTYPE_ATEX_LIT, POLYTYPE_PTEX, Polygon
@subsection POLYTYPE_ATEX_MASK
@ftable @asis
@item @t{#define POLYTYPE_ATEX_MASK}
@end ftable
@ftable @asis
@item @t{#define POLYTYPE_PTEX_MASK}
...
@xref{POLYTYPE_PTEX}.@*
@xref{ex3d}.@*
@node POLYTYPE_ATEX_LIT, POLYTYPE_ATEX_MASK_LIT, POLYTYPE_ATEX_MASK, Polygon
@subsection POLYTYPE_ATEX_LIT
@ftable @asis
@item @t{#define POLYTYPE_ATEX_LIT}
@end ftable
@ftable @asis
@item @t{#define POLYTYPE_PTEX_LIT}
...
@xref{POLYTYPE_PTEX}.@*
@xref{color_map}.@*
@xref{Truecolor transparency}.@*
@xref{ex3d}.@*
@node POLYTYPE_ATEX_MASK_LIT, POLYTYPE_ATEX_TRANS, POLYTYPE_ATEX_LIT, Polygon
@subsection POLYTYPE_ATEX_MASK_LIT
@ftable @asis
@item @t{#define POLYTYPE_ATEX_MASK_LIT}
@end ftable
@ftable @asis
@item @t{#define POLYTYPE_PTEX_MASK_LIT}
...
@xref{Polygon, Polygon rendering}.@*
@xref{polygon3d}.@*
@xref{POLYTYPE_ATEX_LIT}.@*
@xref{POLYTYPE_ATEX_LIT, POLYTYPE_PTEX_LIT}.@*
@xref{ex3d}.@*
@node POLYTYPE_ATEX_TRANS, POLYTYPE_ATEX_MASK_TRANS, POLYTYPE_ATEX_MASK_LIT, Polygon
@subsection POLYTYPE_ATEX_TRANS
@ftable @asis
@item @t{#define POLYTYPE_ATEX_TRANS}
@end ftable
@ftable @asis
@item @t{#define POLYTYPE_PTEX_TRANS}
...
@xref{polygon3d}.@*
@xref{ex3d}.@*
@node POLYTYPE_ATEX_MASK_TRANS, polygon3d, POLYTYPE_ATEX_TRANS, Polygon
@subsection POLYTYPE_ATEX_MASK_TRANS
@ftable @asis
@item @t{#define POLYTYPE_ATEX_MASK_TRANS}
@end ftable
@ftable @asis
@item @t{#define POLYTYPE_PTEX_MASK_TRANS}
...
@xref{polygon3d}.@*
@xref{ex3d}.@*
@node polygon3d, triangle3d, POLYTYPE_ATEX_MASK_TRANS, Polygon
@subsection polygon3d
@ftable @asis
@item @t{void polygon3d(BITMAP *bmp, int type, BITMAP *texture, int vc, V3D *vtx[]);}
@end ftable
@ftable @asis
@item @t{void polygon3d_f(BITMAP *bmp, int type, BITMAP *texture, int vc, V3D_f *vtx[]);}
...
@xref{V3D}.@*
@xref{V3D_f}.@*
@node triangle3d, quad3d, polygon3d, Polygon
@subsection triangle3d
@ftable @asis
@item @t{void triangle3d(BITMAP *bmp, int type, BITMAP *tex, V3D *v1, *v2, *v3);}
@end ftable
@ftable @asis
@item @t{void triangle3d_f(BITMAP *bmp, int type, BITMAP *tex, V3D_f *v1, *v2, *v3);}
...
@xref{V3D}.@*
@xref{V3D_f}.@*
@node quad3d, clip3d_f, triangle3d, Polygon
@subsection quad3d
@ftable @asis
@item @t{void quad3d(BITMAP *bmp, int type, BITMAP *tex, V3D *v1, *v2, *v3, *v4);}
@end ftable
@ftable @asis
@item @t{void quad3d_f(BITMAP *bmp, int type, BITMAP *tex, V3D_f *v1, *v2, *v3, *v4);}
...
@xref{V3D}.@*
@xref{V3D_f}.@*
@node clip3d_f, clip3d, quad3d, Polygon
@subsection clip3d_f
@ftable @asis
@item @t{int clip3d_f(int type, float min_z, float max_z, int vc, const V3D_f *vtx[], V3D_f *vout[], V3D_f *vtmp[], int out[]);}
...
@xref{exscn3d}.@*
@xref{V3D_f}.@*
@node clip3d, Zbuffered rendering, clip3d_f, Polygon
@subsection clip3d
@ftable @asis
@item @t{int clip3d(int type, fixed min_z, fixed max_z, int vc, const V3D *vtx[], V3D *vout[], V3D *vtmp[], int out[]);}
...
@xref{fixed}.@*
@xref{V3D}.@*
@node Zbuffered rendering, create_zbuffer, clip3d, Polygon
@subsection Zbuffered rendering
@ftable @asis
@end ftable
...
polygon3d(bmp, POLYTYPE_ATEX | POLYTYPE_ZBUF, tex, vc, vtx);@end example
...
@node create_zbuffer, create_sub_zbuffer, Zbuffered rendering, Polygon
@subsection create_zbuffer
@ftable @asis
@item @t{ZBUFFER *create_zbuffer(BITMAP *bmp);}
...
@end ftable
See also:@*
@xref{create_sub_zbuffer}.@*
@xref{set_zbuffer}.@*
@xref{clear_zbuffer}.@*
@xref{destroy_zbuffer}.@*
@xref{exzbuf}.@*
@xref{BITMAP}.@*
@xref{ZBUFFER}.@*
@node create_sub_zbuffer, set_zbuffer, create_zbuffer, Polygon
@subsection create_sub_zbuffer
@ftable @asis
@item @t{ZBUFFER *create_sub_zbuffer(ZBUFFER *parent, int x, int y, int width, int height);}
...
@xref{destroy_zbuffer}.@*
@xref{ZBUFFER}.@*
@node set_zbuffer, clear_zbuffer, create_sub_zbuffer, Polygon
@subsection set_zbuffer
@ftable @asis
@item @t{void set_zbuffer(ZBUFFER *zbuf);}
...
@xref{exzbuf}.@*
@xref{ZBUFFER}.@*
@node clear_zbuffer, destroy_zbuffer, set_zbuffer, Polygon
@subsection clear_zbuffer
@ftable @asis
@item @t{void clear_zbuffer(ZBUFFER *zbuf, float z);}
...
@xref{exzbuf}.@*
@xref{ZBUFFER}.@*
@node destroy_zbuffer, Scene rendering, clear_zbuffer, Polygon
@subsection destroy_zbuffer
@ftable @asis
@item @t{void destroy_zbuffer(ZBUFFER *zbuf);}
...
@xref{exzbuf}.@*
@xref{ZBUFFER}.@*
@node Scene rendering, create_scene, destroy_zbuffer, Polygon
...
@}
render_scene();@end example


@node create_scene, clear_scene, Scene rendering, Polygon
@subsection create_scene
@ftable @asis
@item @t{int create_scene(int nedge, int npoly);}
...
@xref{create_zbuffer}.@*
@xref{exscn3d}.@*
@node clear_scene, destroy_scene, create_scene, Polygon
@subsection clear_scene
@ftable @asis
@item @t{void clear_scene(BITMAP *bmp);}
...
@xref{exscn3d}.@*
@xref{BITMAP}.@*
@node destroy_scene, scene_polygon3d, clear_scene, Polygon
@subsection destroy_scene
@ftable @asis
@item @t{void destroy_scene();}
...
@xref{scene_gap}.@*
@xref{exscn3d}.@*
@node scene_polygon3d, render_scene, destroy_scene, Polygon
@subsection scene_polygon3d
@ftable @asis
@item @t{int scene_polygon3d(int type, BITMAP *texture, int vc, V3D *vtx[]);}
@end ftable
@ftable @asis
@item @t{int scene_polygon3d_f(int type, BITMAP *texture, int vc, V3D_f *vtx[]);}
...
@xref{V3D}.@*
@xref{V3D_f}.@*
@node render_scene, scene_gap, scene_polygon3d, Polygon
@subsection render_scene
@ftable @asis
@item @t{void render_scene();}
...
@xref{scene_polygon3d}.@*
@xref{exscn3d}.@*
@node scene_gap, drawing_mode, render_scene, Polygon
@subsection scene_gap
@ftable @asis
@item @t{extern float scene_gap;}
...
@xref{render_scene}.@*
@xref{scene_polygon3d}.@*
@node Transparency, Converting, Polygon, API
@section Transparency and patterned drawing
...
* set_blender_mode_ex::
@end menu
@node drawing_mode, xor_mode, scene_gap, Transparency
@subsection drawing_mode
@ftable @asis
@item @t{void drawing_mode(int mode, BITMAP *pattern, int x_anchor, int y_anchor);}
...
@xref{extrans}.@*
@xref{BITMAP}.@*
@node xor_mode, solid_mode, drawing_mode, Transparency
@subsection xor_mode
@ftable @asis
@item @t{void xor_mode(int on);}
...
@xref{exspline}.@*
@xref{exupdate}.@*
@node solid_mode, 256-color transparency, xor_mode, Transparency
@subsection solid_mode
@ftable @asis
@item @t{void solid_mode();}
...
@xref{exalpha}.@*
@xref{expat}.@*
@node 256-color transparency, color_map, solid_mode, Transparency
@subsection 256-color transparency
@ftable @asis
@end ftable
...
@node color_map, create_trans_table, 256-color transparency, Transparency
@subsection color_map
@ftable @asis
@item @t{extern COLOR_MAP *color_map;}
...
if (!color_map)
   abort_on_error("Not enough memory for color map!");@end example


@end ftable
See also:@*
@xref{create_color_table}.@*
@xref{create_light_table}.@*
@xref{create_trans_table}.@*
@xref{create_blender_table}.@*
@xref{set_trans_blender}.@*
@xref{draw_trans_sprite}.@*
@xref{draw_lit_sprite}.@*
@xref{draw_gouraud_sprite}.@*
...
@xref{extrans}.@*
@xref{COLOR_MAP}.@*
@node create_trans_table, create_light_table, color_map, Transparency
@subsection create_trans_table
@ftable @asis
@item @t{void create_trans_table(COLOR_MAP *table, const PALETTE pal, int r, g, b, void (*callback)(int pos));}
...
create_trans_table(&trans_table, pal, 128, 128, 128, NULL);@end example
...
@xref{PALETTE}.@*
@xref{COLOR_MAP}.@*
@node create_light_table, create_color_table, create_trans_table, Transparency
@subsection create_light_table
@ftable @asis
@item @t{void create_light_table(COLOR_MAP *table, const PALETTE pal, int r, g, b, void (*callback)(int pos));}
Fills the specified color mapping table with lookup data for doing 
...
create_light_table(&light_table, pal, 0, 0, 0, NULL);@end example
...
@xref{PALETTE}.@*
@xref{COLOR_MAP}.@*
@node create_color_table, create_blender_table, create_light_table, Transparency
@subsection create_color_table
@ftable @asis
@item @t{void create_color_table(COLOR_MAP *table, const PALETTE pal, void (*blend)(PALETTE pal, int x, int y, RGB *rgb), void (*callback)(int pos));}
Fills the specified color mapping table with lookup data for doing 
...
...
   ...
   create_color_table(&greyscale_table, pal,
                      return_grey_color, NULL);@end example
...
@xref{RGB}.@*
@xref{COLOR_MAP}.@*
@node create_blender_table, Truecolor transparency, create_color_table, Transparency
@subsection create_blender_table
@ftable @asis
@item @t{void create_blender_table(COLOR_MAP *table, const PALETTE pal, void (*callback)(int pos));}
...
@xref{draw_gouraud_sprite}.@*
@xref{set_trans_blender}.@*
@xref{set_blender_mode}.@*
@xref{PALETTE}.@*
@xref{COLOR_MAP}.@*
@node Truecolor transparency, set_trans_blender, create_blender_table, Transparency
@subsection Truecolor transparency
@ftable @asis
@end ftable
...
unsigned long (*BLENDER_FUNC)(unsigned long x, y, n);@end example
...
@node set_trans_blender, set_alpha_blender, Truecolor transparency, Transparency
@subsection set_trans_blender
@ftable @asis
@item @t{void set_trans_blender(int r, int g, int b, int a);}
...
@xref{draw_lit_sprite}.@*
@xref{drawing_mode}.@*
@xref{set_add_blender}.@*
@xref{set_burn_blender}.@*
@xref{set_color_blender}.@*
@xref{set_difference_blender}.@*
@xref{set_dissolve_blender}.@*
@xref{set_dodge_blender}.@*
@xref{set_hue_blender}.@*
@xref{set_invert_blender}.@*
@xref{set_luminance_blender}.@*
@xref{set_multiply_blender}.@*
@xref{set_saturation_blender}.@*
@xref{set_screen_blender}.@*
@xref{ex3d}.@*
@xref{exblend}.@*
@xref{exshade}.@*
@xref{extrans}.@*
@xref{exxfade}.@*
@node set_alpha_blender, set_write_alpha_blender, set_trans_blender, Transparency
@subsection set_alpha_blender
@ftable @asis
@item @t{void set_alpha_blender();}
...
@xref{exalpha}.@*
@xref{extrans}.@*
@node set_write_alpha_blender, set_add_blender, set_alpha_blender, Transparency
@subsection set_write_alpha_blender
@ftable @asis
@item @t{void set_write_alpha_blender();}
...
@xref{exalpha}.@*
@xref{extrans}.@*
@node set_add_blender, set_burn_blender, set_write_alpha_blender, Transparency
@subsection set_add_blender
@ftable @asis
@item @t{void set_add_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_burn_blender, set_color_blender, set_add_blender, Transparency
@subsection set_burn_blender
@ftable @asis
@item @t{void set_burn_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_color_blender, set_difference_blender, set_burn_blender, Transparency
@subsection set_color_blender
@ftable @asis
@item @t{void set_color_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_difference_blender, set_dissolve_blender, set_color_blender, Transparency
@subsection set_difference_blender
@ftable @asis
@item @t{void set_difference_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_dissolve_blender, set_dodge_blender, set_difference_blender, Transparency
@subsection set_dissolve_blender
@ftable @asis
@item @t{void set_dissolve_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_dodge_blender, set_hue_blender, set_dissolve_blender, Transparency
@subsection set_dodge_blender
@ftable @asis
@item @t{void set_dodge_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_hue_blender, set_invert_blender, set_dodge_blender, Transparency
@subsection set_hue_blender
@ftable @asis
@item @t{void set_hue_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_invert_blender, set_luminance_blender, set_hue_blender, Transparency
@subsection set_invert_blender
@ftable @asis
@item @t{void set_invert_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_luminance_blender, set_multiply_blender, set_invert_blender, Transparency
@subsection set_luminance_blender
@ftable @asis
@item @t{void set_luminance_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_multiply_blender, set_saturation_blender, set_luminance_blender, Transparency
@subsection set_multiply_blender
@ftable @asis
@item @t{void set_multiply_blender(int r, int g, int b, int a);}
...
@xref{drawing_mode}.@*
@xref{exalpha}.@*
@node set_saturation_blender, set_screen_blender, set_multiply_blender, Transparency
@subsection set_saturation_blender
@ftable @asis
@item @t{void set_saturation_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_screen_blender, set_blender_mode, set_saturation_blender, Transparency
@subsection set_screen_blender
@ftable @asis
@item @t{void set_screen_blender(int r, int g, int b, int a);}
...
@xref{set_trans_blender}.@*
@xref{drawing_mode}.@*
@node set_blender_mode, set_blender_mode_ex, set_screen_blender, Transparency
@subsection set_blender_mode
@ftable @asis
@item @t{void set_blender_mode(BLENDER_FUNC b15, b16, b24, int r, g, b, a);}
...
@end ftable
See also:@*
@xref{set_blender_mode_ex}.@*
@xref{set_trans_blender}.@*
@xref{color_map}.@*
@xref{draw_trans_sprite}.@*
@xref{draw_lit_sprite}.@*
@xref{drawing_mode}.@*
@node set_blender_mode_ex, bestfit_color, set_blender_mode, Transparency
@subsection set_blender_mode_ex
@ftable @asis
@item @t{void set_blender_mode_ex(BLENDER_FUNC b15, b16, b24, b32, b15x, b16x, b24x, int r, g, b, a);}
...
@xref{set_blender_mode}.@*
@xref{set_alpha_blender}.@*
@node Converting, Direct, Transparency, API
@section Converting between color formats
...
* hsv_to_rgb::
@end menu
@node bestfit_color, rgb_map, set_blender_mode_ex, Converting
@subsection bestfit_color
@ftable @asis
@item @t{int bestfit_color(const PALETTE pal, int r, int g, int b);}
...
@xref{makecol8}.@*
@xref{PALETTE}.@*
@node rgb_map, create_rgb_table, bestfit_color, Converting
@subsection rgb_map
@ftable @asis
@item @t{extern RGB_MAP *rgb_map;}
...
@xref{extrans}.@*
@xref{RGB_MAP}.@*
@node create_rgb_table, hsv_to_rgb, rgb_map, Converting
@subsection create_rgb_table
@ftable @asis
@item @t{void create_rgb_table(RGB_MAP *table, const PALETTE pal, void (*callback)(int pos));}
...
@xref{PALETTE}.@*
@xref{RGB_MAP}.@*
@node hsv_to_rgb, bmp_write_line, create_rgb_table, Converting
@subsection hsv_to_rgb
@ftable @asis
@item @t{void hsv_to_rgb(float h, float s, float v, int *r, int *g, int *b);}
@end ftable
@ftable @asis
@item @t{void rgb_to_hsv(int r, int g, int b, float *h, float *s, float *v);}
...
@xref{exlights}.@*
@xref{exrgbhsv}.@*
@node Direct, FLIC, Converting, API
@section Direct access to video memory
...
@end menu
@node bmp_write_line, bmp_read_line, hsv_to_rgb, Direct
@subsection bmp_write_line
@ftable @asis
@item @t{unsigned long bmp_write_line(BITMAP *bmp, int line);}
...
@xref{exlights}.@*
@xref{BITMAP}.@*
@node bmp_read_line, bmp_unwrite_line, bmp_write_line, Direct
@subsection bmp_read_line
@ftable @asis
@item @t{unsigned long bmp_read_line(BITMAP *bmp, int line);}
...
@xref{exflame}.@*
@xref{BITMAP}.@*
@node bmp_unwrite_line, More on banked direct memory access, bmp_read_line, Direct
@subsection bmp_unwrite_line
@ftable @asis
@item @t{void bmp_unwrite_line(BITMAP *bmp);}
...
@xref{exlights}.@*
@xref{BITMAP}.@*
@node More on banked direct memory access, play_fli, bmp_unwrite_line, Direct
@subsection More on banked direct memory access
@ftable @asis
...
@node FLIC, Sound, Direct, API
@section FLIC routines
...
* fli_timer::
@end menu
@node play_fli, play_memory_fli, More on banked direct memory access, FLIC
@subsection play_fli
@ftable @asis
@item @t{int play_fli(const char *filename, BITMAP *bmp, int loop, int (*callback)());}
...
...
   int ret = play_fli("animlogo.fli", screen, 1,
                       check_escape_key);
   if (ret == FLI_ERROR)
      abort_on_error("Error playing intro!");@end example
...
@end ftable
See also:@*
@xref{play_memory_fli}.@*
@xref{install_timer}.@*
@xref{fli_frame}.@*
@xref{BITMAP}.@*
@node play_memory_fli, open_fli, play_fli, FLIC
@subsection play_memory_fli
@ftable @asis
@item @t{int play_memory_fli(const void *fli_data, BITMAP *bmp, int loop, int (*callback)());}
...
if (ret == FLI_ERROR)
   abort_on_error("Corrupted animation data?");@end example
...
@xref{fli_frame}.@*
@xref{BITMAP}.@*
@node open_fli, close_fli, play_memory_fli, FLIC
@subsection open_fli
@ftable @asis
@item @t{int open_fli(const char *filename);}
@end ftable
@ftable @asis
@item @t{int open_memory_fli(const void *fli_data);}
...
@xref{fli_bitmap}.@*
@xref{fli_palette}.@*
@node close_fli, next_fli_frame, open_fli, FLIC
@subsection close_fli
@ftable @asis
@item @t{void close_fli();}
...
See also:@*
@xref{open_fli}.@*
@node next_fli_frame, fli_bitmap, close_fli, FLIC
@subsection next_fli_frame
@ftable @asis
@item @t{int next_fli_frame(int loop);}
...
@xref{fli_timer}.@*
@xref{fli_frame}.@*
@node fli_bitmap, fli_palette, next_fli_frame, FLIC
@subsection fli_bitmap
@ftable @asis
@item @t{extern BITMAP *fli_bitmap;}
...
See also:@*
@xref{next_fli_frame}.@*
@xref{fli_bmp_dirty_from}.@*
@xref{fli_palette}.@*
@xref{BITMAP}.@*
@node fli_palette, fli_bmp_dirty_from, fli_bitmap, FLIC
@subsection fli_palette
@ftable @asis
@item @t{extern PALETTE fli_palette;}
Contains the current FLI palette.

@end ftable
See also:@*
@xref{next_fli_frame}.@*
@xref{fli_pal_dirty_from}.@*
@xref{fli_bitmap}.@*
@xref{PALETTE}.@*
@node fli_bmp_dirty_from, fli_pal_dirty_from, fli_palette, FLIC
@subsection fli_bmp_dirty_from
@ftable @asis
@item @t{extern int fli_bmp_dirty_from;}
@end ftable
@ftable @asis
@item @t{extern int fli_bmp_dirty_to;}
...
if (fli_bmp_dirty_from <= fli_bmp_dirty_to)
   blit(fli_bitmap, screen, 0, fli_bmp_dirty_from,
        ...
        fli_bmp_dirty_to - fli_bmp_dirty_from + 1);@end example


@end ftable
See also:@*
@xref{fli_bitmap}.@*
@xref{reset_fli_variables}.@*
@node fli_pal_dirty_from, reset_fli_variables, fli_bmp_dirty_from, FLIC
@subsection fli_pal_dirty_from
@ftable @asis
@item @t{extern int fli_pal_dirty_from;}
@end ftable
@ftable @asis
@item @t{extern int fli_pal_dirty_to;}
These variables are set by next_fli_frame() to indicate which part of the 
...
if (fli_pal_dirty_from <= fli_pal_dirty_to)
   set_palette_range(fli_palette, fli_pal_dirty_from,
                     fli_pal_dirty_to, 1);@end example
...
@xref{fli_palette}.@*
@xref{reset_fli_variables}.@*
@node reset_fli_variables, fli_frame, fli_pal_dirty_from, FLIC
@subsection reset_fli_variables
@ftable @asis
@item @t{void reset_fli_variables();}
...
@xref{fli_bmp_dirty_from}.@*
@xref{fli_pal_dirty_from}.@*
@node fli_frame, fli_timer, reset_fli_variables, FLIC
@subsection fli_frame
@ftable @asis
@item @t{extern int fli_frame;}
...
@xref{play_memory_fli}.@*
@xref{next_fli_frame}.@*
@node fli_timer, detect_digi_driver, fli_frame, FLIC
@subsection fli_timer
@ftable @asis
@item @t{extern volatile int fli_timer;}
...
@xref{install_timer}.@*
@xref{next_fli_frame}.@*
@node Sound, Mixer, FLIC, API
@section Sound init routines
...
* get_hardware_volume::
@end menu
@node detect_digi_driver, detect_midi_driver, fli_timer, Sound
@subsection detect_digi_driver
@ftable @asis
@item @t{int detect_digi_driver(int driver_id);}
...
@xref{DIGI_*/QNX}.@*
@xref{DIGI_*/MacOSX}.@*
@node detect_midi_driver, reserve_voices, detect_digi_driver, Sound
@subsection detect_midi_driver
@ftable @asis
@item @t{int detect_midi_driver(int driver_id);}
...
@xref{MIDI_*/QNX}.@*
@xref{MIDI_*/MacOSX}.@*
@node reserve_voices, set_volume_per_voice, detect_midi_driver, Sound
@subsection reserve_voices
@ftable @asis
@item @t{void reserve_voices(int digi_voices, int midi_voices);}
...
@end ftable
See also:@*
@xref{set_volume_per_voice}.@*
@xref{install_sound}.@*
@xref{detect_digi_driver}.@*
@xref{detect_midi_driver}.@*
@xref{get_mixer_voices}.@*
@node set_volume_per_voice, install_sound, reserve_voices, Sound
@subsection set_volume_per_voice
@ftable @asis
@item @t{void set_volume_per_voice(int scale);}
...
@xref{detect_digi_driver}.@*
@xref{detect_midi_driver}.@*
@node install_sound, remove_sound, set_volume_per_voice, Sound
@subsection install_sound
@ftable @asis
@item @t{int install_sound(int digi, int midi, const char *cfg_path);}
...
@xref{exsprite}.@*
@xref{exstream}.@*
@node remove_sound, set_volume, install_sound, Sound
@subsection remove_sound
@ftable @asis
@item @t{void remove_sound();}
...
@xref{install_sound}.@*
@xref{allegro_exit}.@*
@node set_volume, set_hardware_volume, remove_sound, Sound
@subsection set_volume
@ftable @asis
@item @t{void set_volume(int digi_volume, int midi_volume);}
...
See also:@*
@xref{install_sound}.@*
@xref{set_hardware_volume}.@*
@node set_hardware_volume, get_volume, set_volume, Sound
@subsection set_hardware_volume
@ftable @asis
@item @t{void set_hardware_volume(int digi_volume, int midi_volume);}
...
@xref{install_sound}.@*
@xref{set_volume}.@*
@node get_volume, get_hardware_volume, set_hardware_volume, Sound
@subsection get_volume
@ftable @asis
@item @t{void get_volume(int *digi_volume, int *midi_volume);}
...
See also:@*
@xref{set_volume}.@*
@xref{get_hardware_volume}.@*
@node get_hardware_volume, set_mixer_quality, get_volume, Sound
@subsection get_hardware_volume
@ftable @asis
@item @t{void get_hardware_volume(int *digi_volume, int *midi_volume);}
...
@xref{set_hardware_volume}.@*
@xref{get_volume}.@*
@node Mixer, Digital, Sound, API
@section Mixer routines
...
@end menu
@node set_mixer_quality, get_mixer_quality, get_hardware_volume, Mixer
@subsection set_mixer_quality
@ftable @asis
@item @t{void set_mixer_quality(int quality);}
...
@xref{Standard config variables}.@*
@node get_mixer_quality, get_mixer_frequency, set_mixer_quality, Mixer
@subsection get_mixer_quality
@ftable @asis
@item @t{int get_mixer_quality(void);}
...
@xref{set_mixer_quality}.@*
@xref{Standard config variables}.@*
@node get_mixer_frequency, get_mixer_bits, get_mixer_quality, Mixer
@subsection get_mixer_frequency
@ftable @asis
@item @t{int get_mixer_frequency(void);}
Returns the mixer frequency, in Hz.

@end ftable
See also:@*
@xref{Standard config variables}.@*
@node get_mixer_bits, get_mixer_channels, get_mixer_frequency, Mixer
@subsection get_mixer_bits
@ftable @asis
@item @t{int get_mixer_bits(void);}
Returns the mixer bit depth (8 or 16).

@end ftable
See also:@*
@xref{Standard config variables}.@*
@node get_mixer_channels, get_mixer_voices, get_mixer_bits, Mixer
@subsection get_mixer_channels
@ftable @asis
@item @t{int get_mixer_channels(void);}
...
See also:@*
@xref{Standard config variables}.@*
@node get_mixer_voices, get_mixer_buffer_length, get_mixer_channels, Mixer
@subsection get_mixer_voices
@ftable @asis
@item @t{int get_mixer_voices(void);}
Returns the number of voices allocated to the mixer.

@end ftable
See also:@*
@xref{reserve_voices}.@*
@node get_mixer_buffer_length, load_sample, get_mixer_voices, Mixer
@subsection get_mixer_buffer_length
@ftable @asis
@item @t{int get_mixer_buffer_length(void);}
...
See also:@*
@xref{Standard config variables}.@*
@node Digital, Music, Mixer, API
@section Digital sample routines
...
* voice_set_vibrato::
@end menu
@node load_sample, load_wav, get_mixer_buffer_length, Digital
@subsection load_sample
@ftable @asis
@item @t{SAMPLE *load_sample(const char *filename);}
...
if (!sample)
   abort_on_error("Couldn't load sample!");@end example
...
@xref{play_sample}.@*
@xref{save_sample}.@*
@xref{register_sample_file_type}.@*
@xref{Voice control}.@*
@xref{exsample}.@*
@xref{SAMPLE}.@*
@node load_wav, load_wav_pf, load_sample, Digital
@subsection load_wav
@ftable @asis
@item @t{SAMPLE *load_wav(const char *filename);}
Loads a sample from a RIFF WAV file. Example:
@example

SAMPLE *sample = load_wav("scream.wav");
if (!sample)
   abort_on_error("Couldn't scare user!");@end example
...
@xref{register_sample_file_type}.@*
@xref{SAMPLE}.@*
@node load_wav_pf, load_voc, load_wav, Digital
@subsection load_wav_pf
@ftable @asis
@item @t{SAMPLE *load_wav_pf(PACKFILE *f);}
...
if (!sample)
   abort_on_error("Error loading sound.wav");@end example
...
@xref{SAMPLE}.@*
@xref{PACKFILE}.@*
@node load_voc, load_voc_pf, load_wav_pf, Digital
@subsection load_voc
@ftable @asis
@item @t{SAMPLE *load_voc(const char *filename);}
Loads a sample from a Creative Labs VOC file. Example:
@example

SAMPLE *sample = load_voc("alarm.voc");
if (!sample)
   abort_on_error("Couldn't alert user!");@end example
...
@xref{register_sample_file_type}.@*
@xref{SAMPLE}.@*
@node load_voc_pf, save_sample, load_voc, Digital
@subsection load_voc_pf
@ftable @asis
@item @t{SAMPLE *load_voc_pf(PACKFILE *f);}
...
@xref{SAMPLE}.@*
@xref{PACKFILE}.@*
@node save_sample, create_sample, load_voc_pf, Digital
@subsection save_sample
@ftable @asis
@item @t{int save_sample(const char *filename, SAMPLE *spl);}
...
if (save_sample("sound.wav", sample) != 0)
   abort_on_error("Couldn't save sample!");@end example
...
@xref{register_sample_file_type}.@*
@xref{SAMPLE}.@*
@node create_sample, destroy_sample, save_sample, Digital
@subsection create_sample
@ftable @asis
@item @t{SAMPLE *create_sample(int bits, int stereo, int freq, int len);}
...
@xref{load_sample}.@*
@xref{destroy_sample}.@*
@xref{Structures, Structures and types defined by Allegro}.@*
@xref{SAMPLE}.@*
@node destroy_sample, lock_sample, create_sample, Digital
@subsection destroy_sample
@ftable @asis
@item @t{void destroy_sample(SAMPLE *spl);}
...
@xref{exsample}.@*
@xref{SAMPLE}.@*
@node lock_sample, register_sample_file_type, destroy_sample, Digital
@subsection lock_sample
@ftable @asis
@item @t{void lock_sample(SAMPLE *spl);}
...
@xref{create_sample}.@*
@xref{SAMPLE}.@*
@node register_sample_file_type, play_sample, lock_sample, Digital
@subsection register_sample_file_type
@ftable @asis
@item @t{void register_sample_file_type(const char *ext, SAMPLE *(*load)(const char *filename), int (*save)(const char *filename, SAMPLE *spl));}
...
@}
   ...
   register_sample_file_type("mp3", load_mp3, NULL);@end example
...
@xref{save_sample}.@*
@xref{SAMPLE}.@*
@node play_sample, adjust_sample, register_sample_file_type, Digital
@subsection play_sample
@ftable @asis
@item @t{int play_sample(const SAMPLE *spl, int vol, int pan, int freq, int loop);}
...
int sound = play_sample(scream, 255, 0, 2000, 0);@end example
...
@xref{exsprite}.@*
@xref{SAMPLE}.@*
@node adjust_sample, stop_sample, play_sample, Digital
@subsection adjust_sample
@ftable @asis
@item @t{void adjust_sample(const SAMPLE *spl, int vol, int pan, int freq, int loop);}
...
@xref{exsample}.@*
@xref{SAMPLE}.@*
@node stop_sample, Voice control, adjust_sample, Digital
@subsection stop_sample
@ftable @asis
@item @t{void stop_sample(const SAMPLE *spl);}
...
@xref{destroy_sample}.@*
@xref{SAMPLE}.@*
@node Voice control, allocate_voice, stop_sample, Digital
...
@xref{install_sound}.@*
@xref{allocate_voice}.@*
@xref{deallocate_voice}.@*
@xref{reallocate_voice}.@*
@xref{release_voice}.@*
@xref{voice_start}.@*
@xref{voice_set_priority}.@*
@xref{voice_check}.@*
@xref{voice_set_position}.@*
@xref{voice_set_playmode}.@*
@xref{voice_set_volume}.@*
@xref{voice_set_frequency}.@*
@xref{voice_set_pan}.@*
@xref{SAMPLE}.@*
@node allocate_voice, deallocate_voice, Voice control, Digital
@subsection allocate_voice
@ftable @asis
@item @t{int allocate_voice(const SAMPLE *spl);}
...
@xref{load_sample}.@*
@xref{SAMPLE}.@*
@node deallocate_voice, reallocate_voice, allocate_voice, Digital
@subsection deallocate_voice
@ftable @asis
@item @t{void deallocate_voice(int voice);}
...
@xref{allocate_voice}.@*
@xref{voice_stop}.@*
@node reallocate_voice, release_voice, deallocate_voice, Digital
@subsection reallocate_voice
@ftable @asis
@item @t{void reallocate_voice(int voice, const SAMPLE *spl);}
Switches an already-allocated voice to use a different sample. Calling 
reallocate_voice(voice, sample) is equivalent to:
@example

deallocate_voice(voice);
voice = allocate_voice(sample);@end example
...
@xref{load_sample}.@*
@xref{SAMPLE}.@*
@node release_voice, voice_start, reallocate_voice, Digital
@subsection release_voice
@ftable @asis
@item @t{void release_voice(int voice);}
...
@xref{allocate_voice}.@*
@xref{deallocate_voice}.@*
@node voice_start, voice_stop, release_voice, Digital
@subsection voice_start
@ftable @asis
@item @t{void voice_start(int voice);}
...
@xref{release_voice}.@*
@xref{exstream}.@*
@node voice_stop, voice_set_priority, voice_start, Digital
@subsection voice_stop
@ftable @asis
@item @t{void voice_stop(int voice);}
...
@xref{release_voice}.@*
@xref{exstream}.@*
@node voice_set_priority, voice_check, voice_stop, Digital
@subsection voice_set_priority
@ftable @asis
@item @t{void voice_set_priority(int voice, int priority);}
...
See also:@*
@xref{Voice control}.@*
@node voice_check, voice_get_position, voice_set_priority, Digital
@subsection voice_check
@ftable @asis
@item @t{SAMPLE *voice_check(int voice);}
...
@xref{allocate_voice}.@*
@xref{voice_start}.@*
@xref{voice_get_position}.@*
@xref{SAMPLE}.@*
@node voice_get_position, voice_set_position, voice_check, Digital
@subsection voice_get_position
@ftable @asis
@item @t{int voice_get_position(int voice);}
...
@xref{Voice control}.@*
@xref{voice_set_position}.@*
@node voice_set_position, voice_set_playmode, voice_get_position, Digital
@subsection voice_set_position
@ftable @asis
@item @t{void voice_set_position(int voice, int position);}
...
@xref{voice_get_position}.@*
@xref{voice_set_playmode}.@*
@node voice_set_playmode, voice_get_volume, voice_set_position, Digital
@subsection voice_set_playmode
@ftable @asis
@item @t{void voice_set_playmode(int voice, int playmode);}
...
See also:@*
@xref{Voice control}.@*
@node voice_get_volume, voice_set_volume, voice_set_playmode, Digital
@subsection voice_get_volume
@ftable @asis
@item @t{int voice_get_volume(int voice);}
...
@xref{Voice control}.@*
@xref{voice_set_volume}.@*
@node voice_set_volume, voice_ramp_volume, voice_get_volume, Digital
@subsection voice_set_volume
@ftable @asis
@item @t{void voice_set_volume(int voice, int volume);}
Sets the volume of the voice, range 0-255.

@end ftable
See also:@*
@xref{Voice control}.@*
@xref{voice_get_volume}.@*
@xref{voice_ramp_volume}.@*
@node voice_ramp_volume, voice_stop_volumeramp, voice_set_volume, Digital
@subsection voice_ramp_volume
@ftable @asis
@item @t{void voice_ramp_volume(int voice, int time, int endvol);}
...
@xref{Voice control}.@*
@xref{voice_set_volume}.@*
@node voice_stop_volumeramp, voice_get_frequency, voice_ramp_volume, Digital
@subsection voice_stop_volumeramp
@ftable @asis
@item @t{void voice_stop_volumeramp(int voice);}
Interrupts a volume ramp operation.

@end ftable
See also:@*
@xref{voice_ramp_volume}.@*
@node voice_get_frequency, voice_set_frequency, voice_stop_volumeramp, Digital
@subsection voice_get_frequency
@ftable @asis
@item @t{int voice_get_frequency(int voice);}
...
@xref{Voice control}.@*
@xref{voice_set_frequency}.@*
@node voice_set_frequency, voice_sweep_frequency, voice_get_frequency, Digital
@subsection voice_set_frequency
@ftable @asis
@item @t{void voice_set_frequency(int voice, int frequency);}
Sets the pitch of the voice, in Hz.

@end ftable
See also:@*
@xref{Voice control}.@*
@xref{voice_get_frequency}.@*
@xref{voice_sweep_frequency}.@*
@node voice_sweep_frequency, voice_stop_frequency_sweep, voice_set_frequency, Digital
@subsection voice_sweep_frequency
@ftable @asis
@item @t{void voice_sweep_frequency(int voice, int time, int endfreq);}
...
@xref{Voice control}.@*
@xref{voice_set_frequency}.@*
@node voice_stop_frequency_sweep, voice_get_pan, voice_sweep_frequency, Digital
@subsection voice_stop_frequency_sweep
@ftable @asis
@item @t{void voice_stop_frequency_sweep(int voice);}
Interrupts a frequency sweep operation.

@end ftable
See also:@*
@xref{voice_sweep_frequency}.@*
@node voice_get_pan, voice_set_pan, voice_stop_frequency_sweep, Digital
@subsection voice_get_pan
@ftable @asis
@item @t{int voice_get_pan(int voice);}
...
@xref{Voice control}.@*
@xref{voice_set_pan}.@*
@node voice_set_pan, voice_sweep_pan, voice_get_pan, Digital
@subsection voice_set_pan
@ftable @asis
@item @t{void voice_set_pan(int voice, int pan);}
...
@node voice_sweep_pan, voice_stop_pan_sweep, voice_set_pan, Digital
@subsection voice_sweep_pan
@ftable @asis
@item @t{void voice_sweep_pan(int voice, int time, int endpan);}
...
@xref{Voice control}.@*
@xref{voice_set_pan}.@*
@node voice_stop_pan_sweep, voice_set_echo, voice_sweep_pan, Digital
@subsection voice_stop_pan_sweep
@ftable @asis
@item @t{void voice_stop_pan_sweep(int voice);}
Interrupts a pan sweep operation.

@end ftable
See also:@*
@xref{voice_sweep_pan}.@*
@node voice_set_echo, voice_set_tremolo, voice_stop_pan_sweep, Digital
@subsection voice_set_echo
@ftable @asis
@item @t{void voice_set_echo(int voice, int strength, int delay);}
Sets the echo parameters for a voice (not currently implemented).

@end ftable
See also:@*
@xref{Voice control}.@*
@node voice_set_tremolo, voice_set_vibrato, voice_set_echo, Digital
@subsection voice_set_tremolo
@ftable @asis
@item @t{void voice_set_tremolo(int voice, int rate, int depth);}
Sets the tremolo parameters for a voice (not currently implemented).

@end ftable
See also:@*
@xref{Voice control}.@*
@node voice_set_vibrato, load_midi, voice_set_tremolo, Digital
@subsection voice_set_vibrato
@ftable @asis
@item @t{void voice_set_vibrato(int voice, int rate, int depth);}
...
See also:@*
@xref{Voice control}.@*
@node Music, Audio, Digital, API
@section Music routines (MIDI)
...
* load_ibk::
@end menu
@node load_midi, destroy_midi, voice_set_vibrato, Music
@subsection load_midi
@ftable @asis
@item @t{MIDI *load_midi(const char *filename);}
...
if (!music)
   abort_on_error("Couldn't load background music!");@end example
...
@xref{destroy_midi}.@*
@xref{play_midi}.@*
@xref{get_midi_length}.@*
@xref{exmidi}.@*
@xref{MIDI}.@*
@node destroy_midi, lock_midi, load_midi, Music
@subsection destroy_midi
@ftable @asis
@item @t{void destroy_midi(MIDI *midi);}
...
@xref{exmidi}.@*
@xref{MIDI}.@*
@node lock_midi, play_midi, destroy_midi, Music
@subsection lock_midi
@ftable @asis
@item @t{void lock_midi(MIDI *midi);}
...
@xref{load_midi}.@*
@xref{MIDI}.@*
@node play_midi, play_looped_midi, lock_midi, Music
@subsection play_midi
@ftable @asis
@item @t{int play_midi(MIDI *midi, int loop);}
...
@xref{midi_pos}.@*
@xref{midi_time}.@*
@xref{midi_msg_callback}.@*
@xref{exmidi}.@*
@xref{MIDI}.@*
@node play_looped_midi, stop_midi, play_midi, Music
@subsection play_looped_midi
@ftable @asis
@item @t{int play_looped_midi(MIDI *midi, int loop_start, int loop_end);}
...
@xref{play_midi}.@*
@xref{midi_pos}.@*
@xref{midi_loop_start}.@*
@xref{MIDI}.@*
@node stop_midi, midi_pause, play_looped_midi, Music
@subsection stop_midi
@ftable @asis
@item @t{void stop_midi();}
...
@xref{play_midi}.@*
@xref{midi_pause}.@*
@node midi_pause, midi_resume, stop_midi, Music
@subsection midi_pause
@ftable @asis
@item @t{void midi_pause();}
...
@xref{midi_seek}.@*
@xref{exmidi}.@*
@node midi_resume, midi_seek, midi_pause, Music
@subsection midi_resume
@ftable @asis
@item @t{void midi_resume();}
...
@xref{midi_pause}.@*
@xref{exmidi}.@*
@node midi_seek, get_midi_length, midi_resume, Music
@subsection midi_seek
@ftable @asis
@item @t{int midi_seek(int target);}
...
@xref{play_midi}.@*
@xref{midi_pos}.@*
@node get_midi_length, midi_out, midi_seek, Music
@subsection get_midi_length
@ftable @asis
@item @t{int get_midi_length(MIDI *midi);}
...
@xref{exmidi}.@*
@xref{MIDI}.@*
@node midi_out, load_midi_patches, get_midi_length, Music
@subsection midi_out
@ftable @asis
@item @t{void midi_out(unsigned char *data, int length);}
...
See also:@*
@xref{install_sound}.@*
@xref{load_midi_patches}.@*
@xref{midi_recorder}.@*
@node load_midi_patches, midi_pos, midi_out, Music
@subsection load_midi_patches
@ftable @asis
@item @t{int load_midi_patches();}
...
@xref{install_sound}.@*
@xref{midi_out}.@*
@node midi_pos, midi_time, load_midi_patches, Music
@subsection midi_pos
@ftable @asis
@item @t{extern volatile long midi_pos;}
...
@xref{midi_msg_callback}.@*
@xref{exmidi}.@*
@node midi_time, midi_loop_start, midi_pos, Music
@subsection midi_time
@ftable @asis
@item @t{extern volatile long midi_time;}
...
@xref{get_midi_length}.@*
@xref{exmidi}.@*
@node midi_loop_start, midi_msg_callback, midi_time, Music
@subsection midi_loop_start
@ftable @asis
@item @t{extern long midi_loop_start;}
@end ftable
@ftable @asis
@item @t{extern long midi_loop_end;}
...
See also:@*
@xref{play_looped_midi}.@*
@node midi_msg_callback, load_ibk, midi_loop_start, Music
@subsection midi_msg_callback
@ftable @asis
@item @t{extern void (*midi_msg_callback)(int msg, int byte1, int byte2);}
@end ftable
@ftable @asis
@item @t{extern void (*midi_meta_callback)(int type, const unsigned char *data, int length);}
@end ftable
@ftable @asis
@item @t{extern void (*midi_sysex_callback)(const unsigned char *data, int length);}
...
See also:@*
@xref{play_midi}.@*
@node load_ibk, play_audio_stream, midi_msg_callback, Music
@subsection load_ibk
@ftable @asis
@item @t{int load_ibk(char *filename, int drums);}
...
See also:@*
@xref{install_sound}.@*
@node Audio, Recording, Music, API
@section Audio stream routines
...
@end menu
@node play_audio_stream, stop_audio_stream, load_ibk, Audio
@subsection play_audio_stream
@ftable @asis
@item @t{AUDIOSTREAM *play_audio_stream(int len, int bits, int stereo, int freq, int vol, int pan);}
...
bytes = length * (bits / 8) * (stereo ? 2 : 1)@end example
...
@xref{stop_audio_stream}.@*
@xref{AUDIOSTREAM}.@*
@xref{Voice control}.@*
@xref{exstream}.@*
@xref{AUDIOSTREAM}.@*
@node stop_audio_stream, get_audio_stream_buffer, play_audio_stream, Audio
@subsection stop_audio_stream
@ftable @asis
@item @t{void stop_audio_stream(AUDIOSTREAM *stream);}
...
@xref{exstream}.@*
@xref{AUDIOSTREAM}.@*
@node get_audio_stream_buffer, free_audio_stream_buffer, stop_audio_stream, Audio
@subsection get_audio_stream_buffer
@ftable @asis
@item @t{void *get_audio_stream_buffer(AUDIOSTREAM *stream);}
...
See also:@*
@xref{play_audio_stream}.@*
@xref{free_audio_stream_buffer}.@*
@xref{exstream}.@*
@xref{AUDIOSTREAM}.@*
@node free_audio_stream_buffer, install_sound_input, get_audio_stream_buffer, Audio
@subsection free_audio_stream_buffer
@ftable @asis
@item @t{void free_audio_stream_buffer(AUDIOSTREAM *stream);}
...
@xref{exstream}.@*
@xref{AUDIOSTREAM}.@*
@node Recording, File, Audio, API
@section Recording routines
...
* midi_recorder::
@end menu
@node install_sound_input, remove_sound_input, free_audio_stream_buffer, Recording
@subsection install_sound_input
@ftable @asis
@item @t{int install_sound_input(int digi, int midi);}
...
@xref{MIDI_*/QNX}.@*
@xref{MIDI_*/MacOSX}.@*
@node remove_sound_input, get_sound_input_cap_bits, install_sound_input, Recording
@subsection remove_sound_input
@ftable @asis
@item @t{void remove_sound_input();}
...
@xref{remove_sound}.@*
@xref{allegro_exit}.@*
@node get_sound_input_cap_bits, get_sound_input_cap_stereo, remove_sound_input, Recording
@subsection get_sound_input_cap_bits
@ftable @asis
@item @t{int get_sound_input_cap_bits();}
...
24 = both eight and sixteen bit audio input are supported@end example
...
See also:@*
@xref{start_sound_input}.@*
@xref{get_sound_input_cap_parm}.@*
@xref{get_sound_input_cap_rate}.@*
@xref{get_sound_input_cap_stereo}.@*
@node get_sound_input_cap_stereo, get_sound_input_cap_rate, get_sound_input_cap_bits, Recording
@subsection get_sound_input_cap_stereo
@ftable @asis
@item @t{int get_sound_input_cap_stereo();}
...
@xref{get_sound_input_cap_rate}.@*
@node get_sound_input_cap_rate, get_sound_input_cap_parm, get_sound_input_cap_stereo, Recording
@subsection get_sound_input_cap_rate
@ftable @asis
@item @t{int get_sound_input_cap_rate(int bits, int stereo);}
...
@xref{get_sound_input_cap_bits}.@*
@xref{get_sound_input_cap_stereo}.@*
@node get_sound_input_cap_parm, set_sound_input_source, get_sound_input_cap_rate, Recording
@subsection get_sound_input_cap_parm
@ftable @asis
@item @t{int get_sound_input_cap_parm(int rate, int bits, int stereo);}
...
-n = Sampling rate not supported, but rate 'n'
     would work instead.@end example
...
@xref{get_sound_input_cap_rate}.@*
@xref{get_sound_input_cap_stereo}.@*
@node set_sound_input_source, start_sound_input, get_sound_input_cap_parm, Recording
@subsection set_sound_input_source
@ftable @asis
@item @t{int set_sound_input_source(int source);}
Selects the audio input source. The parameter should be one of the values:
@example

SOUND_INPUT_MIC
SOUND_INPUT_LINE
SOUND_INPUT_CD@end example
...
See also:@*
@xref{start_sound_input}.@*
@node start_sound_input, stop_sound_input, set_sound_input_source, Recording
@subsection start_sound_input
@ftable @asis
@item @t{int start_sound_input(int rate, int bits, int stereo);}
...
See also:@*
@xref{install_sound_input}.@*
@xref{read_sound_input}.@*
@xref{stop_sound_input}.@*
@xref{digi_recorder}.@*
@xref{set_sound_input_source}.@*
@xref{get_sound_input_cap_parm}.@*
@xref{get_sound_input_cap_bits}.@*
@xref{get_sound_input_cap_rate}.@*
@xref{get_sound_input_cap_stereo}.@*
@node stop_sound_input, read_sound_input, start_sound_input, Recording
@subsection stop_sound_input
@ftable @asis
@item @t{void stop_sound_input();}
...
See also:@*
@xref{start_sound_input}.@*
@node read_sound_input, digi_recorder, stop_sound_input, Recording
@subsection read_sound_input
@ftable @asis
@item @t{int read_sound_input(void *buffer);}
...
See also:@*
@xref{start_sound_input}.@*
@node digi_recorder, midi_recorder, read_sound_input, Recording
@subsection digi_recorder
@ftable @asis
@item @t{extern void (*digi_recorder)();}
...
@xref{install_sound_input}.@*
@xref{start_sound_input}.@*
@node midi_recorder, get_executable_name, digi_recorder, Recording
@subsection midi_recorder
@ftable @asis
@item @t{extern void (*midi_recorder)(unsigned char data);}
...
@xref{install_sound_input}.@*
@xref{midi_out}.@*
@node File, Datafile, Recording, API
@section File and compression routines
...
FA_ALL            - Match all attributes@end example
...
* lzss_read::
@end menu
@node get_executable_name, fix_filename_case, midi_recorder, File
@subsection get_executable_name
@ftable @asis
@item @t{void get_executable_name(char *buf, int size);}
...
@end ftable
@node fix_filename_case, fix_filename_slashes, get_executable_name, File
@subsection fix_filename_case
@ftable @asis
@item @t{char *fix_filename_case(char *path);}
...
@end ftable
See also:@*
@xref{fix_filename_slashes}.@*
@xref{canonicalize_filename}.@*
@node fix_filename_slashes, canonicalize_filename, fix_filename_case, File
@subsection fix_filename_slashes
@ftable @asis
@item @t{char *fix_filename_slashes(char *path);}
...
/* Under DOS we would have c:\dos\backup\weirdo\test.
   Under Unix we would have c:/dos/backup/weirdo/test. */@end example
...
@end ftable
See also:@*
@xref{fix_filename_case}.@*
@xref{canonicalize_filename}.@*
@node canonicalize_filename, make_absolute_filename, fix_filename_slashes, File
@subsection canonicalize_filename
@ftable @asis
@item @t{char *canonicalize_filename(char *dest, const char *filename, int size);}
...
@xref{fix_filename_case}.@*
@xref{fix_filename_slashes}.@*
@node make_absolute_filename, make_relative_filename, canonicalize_filename, File
@subsection make_absolute_filename
@ftable @asis
@item @t{char *make_absolute_filename(char *dest, const char *path, const char *filename, int size);}
...
make_absolute_filename(buf, "/usr/games/",
                       "../temp.txt", sizeof(buf));
/* This would create /usr/temp.txt */@end example
...
@end ftable
See also:@*
@xref{make_relative_filename}.@*
@xref{is_relative_filename}.@*
@xref{replace_filename}.@*
@xref{canonicalize_filename}.@*
@node make_relative_filename, is_relative_filename, make_absolute_filename, File
@subsection make_relative_filename
@ftable @asis
@item @t{char *make_relative_filename(char *dest, const char *path, const char *filename, int size);}
...
/* Under Unix buf would contain:
   ../../../nice/and/short.txt */@end example
...
@end ftable
See also:@*
@xref{make_absolute_filename}.@*
@xref{is_relative_filename}.@*
@xref{canonicalize_filename}.@*
@node is_relative_filename, replace_filename, make_relative_filename, File
@subsection is_relative_filename
@ftable @asis
@item @t{int is_relative_filename(const char *filename);}
...
@xref{make_absolute_filename}.@*
@xref{make_relative_filename}.@*
@node replace_filename, replace_extension, is_relative_filename, File
@subsection replace_filename
@ftable @asis
@item @t{char *replace_filename(char *dest, const char *path,  const char *filename, int size);}
...
...
get_executable_name(name, sizeof(name));
replace_filename(name, name, "sound.dat", sizeof(name));@end example
...
See also:@*
@xref{get_filename}.@*
@xref{replace_extension}.@*
@xref{append_filename}.@*
@xref{Available, Available Allegro examples}.@*
@node replace_extension, append_filename, replace_filename, File
@subsection replace_extension
@ftable @asis
@item @t{char *replace_extension(char *dest, const char *filename,  const char *ext, int size);}
...
@xref{get_extension}.@*
@xref{replace_filename}.@*
@node append_filename, get_filename, replace_extension, File
@subsection append_filename
@ftable @asis
@item @t{char *append_filename(char *dest, const char *path,  const char *filename, int size);}
...
append_filename(buf, "/home/user",
                "prog.bin", sizeof(buf));@end example
...
See also:@*
@xref{replace_filename}.@*
@node get_filename, get_extension, append_filename, File
@subsection get_filename
@ftable @asis
@item @t{char *get_filename(const char *path);}
...
@xref{replace_filename}.@*
@xref{exmidi}.@*
@node get_extension, put_backslash, get_filename, File
@subsection get_extension
@ftable @asis
@item @t{char *get_extension(const char *filename);}
...
allegro_message("The binary has the extension `%s'\n",
                get_extension(name));@end example
...
@xref{put_backslash}.@*
@xref{replace_extension}.@*
@node put_backslash, set_filename_encoding, get_extension, File
@subsection put_backslash
@ftable @asis
@item @t{void put_backslash(char *filename);}
...
@xref{get_extension}.@*
@xref{get_filename}.@*
@node set_filename_encoding, get_filename_encoding, put_backslash, File
@subsection set_filename_encoding
@ftable @asis
@item @t{void set_filename_encoding(int encoding)}
Sets the encoding to use for filenames. By default, UTF-8 is assumed.

@end ftable
See also:@*
@xref{get_filename_encoding}.@*
@node get_filename_encoding, file_exists, set_filename_encoding, File
@subsection get_filename_encoding
@ftable @asis
@item @t{int get_filename_encoding(void)}
Returns the encoding currently assumed for filenames.

@end ftable
See also:@*
@xref{set_filename_encoding}.@*
@node file_exists, exists, get_filename_encoding, File
@subsection file_exists
@ftable @asis
@item @t{int file_exists(const char *filename, int attrib, int *aret);}
...
@xref{file_size_ex}.@*
@xref{file_time}.@*
@node exists, file_size_ex, file_exists, File
@subsection exists
@ftable @asis
@item @t{int exists(const char *filename);}
...
@xref{file_size_ex}.@*
@xref{file_time}.@*
@node file_size_ex, file_time, exists, File
@subsection file_size_ex
@ftable @asis
@item @t{uint64_t file_size_ex(const char *filename);}
...
@xref{file_time}.@*
@xref{expackf}.@*
@node file_time, delete_file, file_size_ex, File
@subsection file_time
@ftable @asis
@item @t{time_t file_time(const char *filename);}
...
@xref{file_exists}.@*
@xref{file_size_ex}.@*
@node delete_file, for_each_file_ex, file_time, File
@subsection delete_file
@ftable @asis
@item @t{int delete_file(const char *filename);}
Removes a file from the disk. You can't delete directories, though.

Returns zero on success, non-zero on failure.

@end ftable
@node for_each_file_ex, al_findfirst, delete_file, File
@subsection for_each_file_ex
@ftable @asis
@item @t{int for_each_file_ex(const char *name, int in_attrib, int out_attrib, int (*callback)(const char *filename, int attrib, void *param), void *param);}
...
@xref{al_findnext}.@*
@xref{al_findclose}.@*
@node al_findfirst, al_findnext, for_each_file_ex, File
@subsection al_findfirst
@ftable @asis
@item @t{int al_findfirst(const char *pattern, struct al_ffblk *info, int attrib);}
...
@xref{al_ffblk_get_size}.@*
@xref{al_ffblk}.@*
@node al_findnext, al_findclose, al_findfirst, File
@subsection al_findnext
@ftable @asis
@item @t{int al_findnext(struct al_ffblk *info);}
...
@xref{al_findclose}.@*
@xref{al_ffblk}.@*
@node al_findclose, al_ffblk_get_size, al_findnext, File
@subsection al_findclose
@ftable @asis
@item @t{void al_findclose(struct al_ffblk *info);}
...
@xref{al_findnext}.@*
@xref{al_ffblk}.@*
@node al_ffblk_get_size, find_allegro_resource, al_findclose, File
@subsection al_ffblk_get_size
@ftable @asis
@item @t{uint64_t al_ffblk_get_size(struct al_ffblk *info);}
...
@xref{al_ffblk}.@*
@xref{al_ffblk}.@*
@node find_allegro_resource, set_allegro_resource_path, al_ffblk_get_size, File
@subsection find_allegro_resource
@ftable @asis
@item @t{int find_allegro_resource(char *dest, const char *resource,  const char *ext, const char *datafile,  const char *objectname, const char *envvar,  const char *subdir, int size);}
...
@node set_allegro_resource_path, packfile_password, find_allegro_resource, File
@subsection set_allegro_resource_path
@ftable @asis
@item @t{int set_allegro_resource_path(int priority, const char *path);}
...
@node packfile_password, pack_fopen, set_allegro_resource_path, File
@subsection packfile_password
@ftable @asis
@item @t{void packfile_password(const char *password);}
...
@xref{load_datafile}.@*
@xref{pack_fopen_vtable}.@*
@node pack_fopen, pack_fopen_vtable, packfile_password, File
@subsection pack_fopen
@ftable @asis
@item @t{PACKFILE *pack_fopen(const char *filename, const char *mode);}
...
if (!input_file)
   abort_on_error("Couldn't read `scores.dat'!");@end example
...
@xref{expackf}.@*
@xref{PACKFILE}.@*
@node pack_fopen_vtable, pack_fclose, pack_fopen, File
@subsection pack_fopen_vtable
@ftable @asis
@item @t{PACKFILE *pack_fopen_vtable(const PACKFILE_VTABLE *vtable, void *userdata);}
...
@xref{expackf}.@*
@xref{PACKFILE}.@*
@xref{PACKFILE_VTABLE}.@*
@node pack_fclose, pack_fseek, pack_fopen_vtable, File
@subsection pack_fclose
@ftable @asis
@item @t{int pack_fclose(PACKFILE *f);}
...
@xref{expackf}.@*
@xref{PACKFILE}.@*
@node pack_fseek, pack_feof, pack_fclose, File
@subsection pack_fseek
@ftable @asis
@item @t{int pack_fseek(PACKFILE *f, int offset);}
...
pack_fseek(input_file, 32);@end example
...
@xref{expackf}.@*
@xref{PACKFILE}.@*
@node pack_feof, pack_ferror, pack_fseek, File
@subsection pack_feof
@ftable @asis
@item @t{int pack_feof(PACKFILE *f);}
...
@xref{pack_ferror}.@*
@xref{PACKFILE}.@*
@node pack_ferror, pack_getc, pack_feof, File
@subsection pack_ferror
@ftable @asis
@item @t{int pack_ferror(PACKFILE *f);}
...
@xref{pack_fopen_chunk}.@*
@xref{PACKFILE}.@*
@node pack_getc, pack_ungetc, pack_ferror, File
@subsection pack_getc
@ftable @asis
@item @t{int pack_getc(PACKFILE *f);}
...
@xref{pack_fopen_chunk}.@*
@xref{PACKFILE}.@*
@node pack_ungetc, pack_putc, pack_getc, File
@subsection pack_ungetc
@ftable @asis
@item @t{int pack_ungetc(int c, PACKFILE *f);}
...
@xref{pack_fgets}.@*
@xref{PACKFILE}.@*
@node pack_putc, pack_igetw, pack_ungetc, File
@subsection pack_putc
@ftable @asis
@item @t{int pack_putc(int c, PACKFILE *f);}
...
@xref{pack_fopen_chunk}.@*
@xref{PACKFILE}.@*
@node pack_igetw, pack_iputw, pack_putc, File
@subsection pack_igetw
@ftable @asis
@item @t{int pack_igetw(PACKFILE *f);}
...
@xref{pack_getc}.@*
@xref{PACKFILE}.@*
@node pack_iputw, pack_igetl, pack_igetw, File
@subsection pack_iputw
@ftable @asis
@item @t{int pack_iputw(int c, PACKFILE *f);}
...
@xref{pack_putc}.@*
@xref{PACKFILE}.@*
@node pack_igetl, pack_iputl, pack_iputw, File
@subsection pack_igetl
@ftable @asis
@item @t{long pack_igetl(PACKFILE *f);}
...
@xref{pack_getc}.@*
@xref{PACKFILE}.@*
@node pack_iputl, pack_mgetw, pack_igetl, File
@subsection pack_iputl
@ftable @asis
@item @t{long pack_iputl(long c, PACKFILE *f);}
...
@xref{pack_putc}.@*
@xref{PACKFILE}.@*
@node pack_mgetw, pack_mputw, pack_iputl, File
@subsection pack_mgetw
@ftable @asis
@item @t{int pack_mgetw(PACKFILE *f);}
...
@xref{pack_getc}.@*
@xref{PACKFILE}.@*
@node pack_mputw, pack_mgetl, pack_mgetw, File
@subsection pack_mputw
@ftable @asis
@item @t{int pack_mputw(int c, PACKFILE *f);}
...
@xref{pack_putc}.@*
@xref{PACKFILE}.@*
@node pack_mgetl, pack_mputl, pack_mputw, File
@subsection pack_mgetl
@ftable @asis
@item @t{long pack_mgetl(PACKFILE *f);}
...
@xref{pack_getc}.@*
@xref{PACKFILE}.@*
@node pack_mputl, pack_fread, pack_mgetl, File
@subsection pack_mputl
@ftable @asis
@item @t{long pack_mputl(long c, PACKFILE *f);}
...
@xref{pack_putc}.@*
@xref{PACKFILE}.@*
@node pack_fread, pack_fwrite, pack_mputl, File
@subsection pack_fread
@ftable @asis
@item @t{long pack_fread(void *p, long n, PACKFILE *f);}
...
if (pack_fread(buf, 256, input_file) != 256)
   abort_on_error("Truncated input file!");@end example
...
@xref{expackf}.@*
@xref{PACKFILE}.@*
@node pack_fwrite, pack_fgets, pack_fread, File
@subsection pack_fwrite
@ftable @asis
@item @t{long pack_fwrite(const void *p, long n, PACKFILE *f);}
...
@xref{pack_feof}.@*
@xref{PACKFILE}.@*
@node pack_fgets, pack_fputs, pack_fwrite, File
@subsection pack_fgets
@ftable @asis
@item @t{char *pack_fgets(char *p, int max, PACKFILE *f);}
...
@xref{pack_ungetc}.@*
@xref{PACKFILE}.@*
@node pack_fputs, pack_fopen_chunk, pack_fgets, File
@subsection pack_fputs
@ftable @asis
@item @t{int pack_fputs(const char *p, PACKFILE *f);}
...
@xref{pack_putc}.@*
@xref{PACKFILE}.@*
@node pack_fopen_chunk, pack_fclose_chunk, pack_fputs, File
@subsection pack_fopen_chunk
@ftable @asis
@item @t{PACKFILE *pack_fopen_chunk(PACKFILE *f, int pack);}
...
@end ftable
See also:@*
@xref{pack_fclose_chunk}.@*
@xref{pack_fopen}.@*
@xref{PACKFILE}.@*
@node pack_fclose_chunk, create_lzss_pack_data, pack_fopen_chunk, File
@subsection pack_fclose_chunk
@ftable @asis
@item @t{PACKFILE *pack_fclose_chunk(PACKFILE *f);}
...
@xref{pack_fopen_chunk}.@*
@xref{PACKFILE}.@*
@node create_lzss_pack_data, free_lzss_pack_data, pack_fclose_chunk, File
@subsection create_lzss_pack_data
@ftable @asis
@item @t{LZSS_PACK_DATA *create_lzss_pack_data(void);}
...
@xref{LZSS_PACK_DATA}.@*
@node free_lzss_pack_data, lzss_write, create_lzss_pack_data, File
@subsection free_lzss_pack_data
@ftable @asis
@item @t{void free_lzss_pack_data(LZSS_PACK_DATA *dat);}
...
@xref{create_lzss_pack_data}.@*
@xref{LZSS_PACK_DATA}.@*
@node lzss_write, create_lzss_unpack_data, free_lzss_pack_data, File
@subsection lzss_write
@ftable @asis
@item @t{int lzss_write(PACKFILE *file, LZSS_PACK_DATA *dat, int size, unsigned char *buf, int last);}
...
@xref{PACKFILE}.@*
@xref{LZSS_PACK_DATA}.@*
@node create_lzss_unpack_data, free_lzss_unpack_data, lzss_write, File
@subsection create_lzss_unpack_data
@ftable @asis
@item @t{LZSS_UNPACK_DATA *create_lzss_unpack_data(void);}
...
@xref{LZSS_UNPACK_DATA}.@*
@node free_lzss_unpack_data, lzss_read, create_lzss_unpack_data, File
@subsection free_lzss_unpack_data
@ftable @asis
@item @t{void free_lzss_unpack_data(LZSS_UNPACK_DATA *dat);}
...
@xref{create_lzss_unpack_data}.@*
@xref{LZSS_UNPACK_DATA}.@*
@node lzss_read, load_datafile, free_lzss_unpack_data, File
@subsection lzss_read
@ftable @asis
@item @t{int lzss_read(PACKFILE *file, LZSS_UNPACK_DATA *dat, int s, unsigned char *buf);}
...
@xref{PACKFILE}.@*
@xref{LZSS_UNPACK_DATA}.@*
@node Datafile, Fixed, File, API
@section Datafile routines
...
@end menu
@node load_datafile, load_datafile_callback, lzss_read, Datafile
@subsection load_datafile
@ftable @asis
@item @t{DATAFILE *load_datafile(const char *filename);}
...
unload_datafile(dat);@end example
...
@end ftable
See also:@*
@xref{load_datafile_callback}.@*
@xref{unload_datafile}.@*
@xref{load_datafile_object}.@*
@xref{set_color_conversion}.@*
@xref{fixup_datafile}.@*
@xref{packfile_password}.@*
@xref{find_datafile_object}.@*
...
@xref{exunicod}.@*
@xref{DATAFILE}.@*
@node load_datafile_callback, unload_datafile, load_datafile, Datafile
@subsection load_datafile_callback
@ftable @asis
@item @t{DATAFILE *load_datafile_callback(const char *filename, void (*callback)(DATAFILE *d));}
...
@}
   ...
   dat = load_datafile_callback("data.dat", load_callback);@end example
...
@xref{register_datafile_object}.@*
@xref{DATAFILE}.@*
@node unload_datafile, load_datafile_object, load_datafile_callback, Datafile
@subsection unload_datafile
@ftable @asis
@item @t{void unload_datafile(DATAFILE *dat);}
...
@xref{exunicod}.@*
@xref{DATAFILE}.@*
@node load_datafile_object, unload_datafile_object, unload_datafile, Datafile
@subsection load_datafile_object
@ftable @asis
@item @t{DATAFILE *load_datafile_object(const char *filename,  const char *objectname);}
...
unload_datafile_object(music_object);@end example
...
@xref{Using datafiles}.@*
@xref{DATAFILE}.@*
@node unload_datafile_object, find_datafile_object, load_datafile_object, Datafile
@subsection unload_datafile_object
@ftable @asis
@item @t{void unload_datafile_object(DATAFILE *dat);}
...
@xref{load_datafile_object}.@*
@xref{DATAFILE}.@*
@node find_datafile_object, create_datafile_index, unload_datafile_object, Datafile
@subsection find_datafile_object
@ftable @asis
@item @t{DATAFILE *find_datafile_object(const DATAFILE *dat, const char *objectname);}
...
if (!level)
   abort_on_error("That level doesn't exist!");@end example
...
@xref{load_datafile_object}.@*
@xref{DATAFILE}.@*
@node create_datafile_index, load_datafile_object_indexed, find_datafile_object, Datafile
@subsection create_datafile_index
@ftable @asis
@item @t{DATAFILE_INDEX *create_datafile_index(const char *filename);}
...
destroy_datafile_index(index);@end example
...
@end ftable
See also:@*
@xref{destroy_datafile_index}.@*
@xref{load_datafile_object_indexed}.@*
@xref{Using datafiles}.@*
@node load_datafile_object_indexed, destroy_datafile_index, create_datafile_index, Datafile
@subsection load_datafile_object_indexed
@ftable @asis
@item @t{DATAFILE *load_datafile_object_indexed(const DATAFILE_INDEX *index, int item)}
...
@xref{unload_datafile_object}.@*
@xref{DATAFILE}.@*
@node destroy_datafile_index, get_datafile_property, load_datafile_object_indexed, Datafile
@subsection destroy_datafile_index
@ftable @asis
@item @t{void destroy_datafile_index(DATAFILE_INDEX *index)}
...
See also:@*
@xref{create_datafile_index}.@*
@node get_datafile_property, register_datafile_object, destroy_datafile_index, Datafile
@subsection get_datafile_property
@ftable @asis
@item @t{const char *get_datafile_property(const DATAFILE *dat, int type);}
...
if (name == empty_string)
   abort_on_error("Object doesn't have a name!");@end example
...
@xref{empty_string}.@*
@xref{DATAFILE}.@*
@node register_datafile_object, fixup_datafile, get_datafile_property, Datafile
@subsection register_datafile_object
@ftable @asis
@item @t{void register_datafile_object(int id, void *(*load)(PACKFILE *f, long size), void (*destroy)(void *data));}
...
@xref{PACKFILE}.@*
@node fixup_datafile, DAT_ID, register_datafile_object, Datafile
@subsection fixup_datafile
@ftable @asis
@item @t{void fixup_datafile(DATAFILE *data);}
...
@xref{Differences, Differences between platforms}.@*
@xref{DATAFILE}.@*
@node DAT_ID, Using datafiles, fixup_datafile, Datafile
@subsection DAT_ID
@ftable @asis
@item @t{Macro DAT_ID(a, b, c, d);}
...
See also:@*
@xref{register_datafile_object}.@*
@xref{get_datafile_property}.@*
@xref{Custom datafile objects}.@*
@xref{Using datafiles}.@*
@node Using datafiles, Custom datafile objects, DAT_ID, Datafile
@subsection Using datafiles
@ftable @asis
...
@node Custom datafile objects, itofix, Using datafiles, Datafile
@subsection Custom datafile objects
@ftable @asis
...
@node Fixed, 3D, Datafile, API
@section Fixed point math routines
...
* Fix class::
@end menu
@node itofix, fixtoi, Custom datafile objects, Fixed
@subsection itofix
@ftable @asis
@item @t{fixed itofix(int x);}
...
ASSERT(fixtoi(number) == 64000);@end example
...
@xref{exstars}.@*
@xref{fixed}.@*
@node fixtoi, fixfloor, itofix, Fixed
@subsection fixtoi
@ftable @asis
@item @t{int fixtoi(fixed x);}
...
result = fixtoi(itofix(100) / 6);@end example
...
@xref{exupdate}.@*
@xref{fixed}.@*
@node fixfloor, fixceil, fixtoi, Fixed
@subsection fixfloor
@ftable @asis
@item @t{int fixfloor(fixed x);}
...
result = fixfloor(itofix(100) / 6);@end example
...
@xref{fixceil}.@*
@xref{fixed}.@*
@node fixceil, ftofix, fixfloor, Fixed
@subsection fixceil
@ftable @asis
@item @t{int fixceil(fixed x);}
...
result = fixceil(itofix(100) / 6);@end example
...
@xref{fixfloor}.@*
@xref{fixed}.@*
@node ftofix, fixtof, fixceil, Fixed
@subsection ftofix
@ftable @asis
@item @t{fixed ftofix(double x);}
...
ASSERT(!errno); /* This will fail. */@end example
...
@xref{exupdate}.@*
@xref{fixed}.@*
@node fixtof, fixmul, ftofix, Fixed
@subsection fixtof
@ftable @asis
@item @t{double fixtof(fixed x);}
...
result = fixtof(itofix(100) / 6);@end example
...
@xref{exstars}.@*
@xref{fixed}.@*
@node fixmul, fixdiv, fixtof, Fixed
@subsection fixmul
@ftable @asis
@item @t{fixed fixmul(fixed x, fixed y);}
...
@xref{exupdate}.@*
@xref{fixed}.@*
@node fixdiv, fixadd, fixmul, Fixed
@subsection fixdiv
@ftable @asis
@item @t{fixed fixdiv(fixed x, fixed y);}
...
@xref{exfixed}.@*
@xref{fixed}.@*
@node fixadd, fixsub, fixdiv, Fixed
@subsection fixadd
@ftable @asis
@item @t{fixed fixadd(fixed x, fixed y);}
...
@xref{fixdiv}.@*
@xref{fixed}.@*
@node fixsub, Fixed point trig, fixadd, Fixed
@subsection fixsub
@ftable @asis
@item @t{fixed fixsub(fixed x, fixed y);}
...
@xref{fixdiv}.@*
@xref{fixed}.@*
@node Fixed point trig, fixtorad_r, fixsub, Fixed
@subsection Fixed point trig
@ftable @asis
@end ftable
...
@node fixtorad_r, radtofix_r, Fixed point trig, Fixed
@subsection fixtorad_r
@ftable @asis
@item @t{extern const fixed fixtorad_r;}
...
rad_angle = fixmul(binary_angle, fixtorad_r);@end example
...
@xref{radtofix_r}.@*
@xref{fixed}.@*
@node radtofix_r, fixsin, fixtorad_r, Fixed
@subsection radtofix_r
@ftable @asis
@item @t{extern const fixed radtofix_r;}
This constant gives a ratio which can be used to convert a fixed point
...
fixed rad_angle, binary_angle;
...
binary_angle = fixmul(rad_angle, radtofix_r);@end example
...
@xref{fixtorad_r}.@*
@xref{fixed}.@*
@node fixsin, fixcos, radtofix_r, Fixed
@subsection fixsin
@ftable @asis
@item @t{fixed fixsin(fixed x);}
...
@xref{exupdate}.@*
@xref{fixed}.@*
@node fixcos, fixtan, fixsin, Fixed
@subsection fixcos
@ftable @asis
@item @t{fixed fixcos(fixed x);}
...
ASSERT(result > 0.7 && result < 0.71);@end example
...
@xref{exupdate}.@*
@xref{fixed}.@*
@node fixtan, fixasin, fixcos, Fixed
@subsection fixtan
@ftable @asis
@item @t{fixed fixtan(fixed x);}
...
@xref{Fixed point trig}.@*
@xref{fixed}.@*
@node fixasin, fixacos, fixtan, Fixed
@subsection fixasin
@ftable @asis
@item @t{fixed fixasin(fixed x);}
...
@xref{Fixed point trig}.@*
@xref{fixed}.@*
@node fixacos, fixatan, fixasin, Fixed
@subsection fixacos
@ftable @asis
@item @t{fixed fixacos(fixed x);}
...
result = fixacos(itofix(-1));@end example
...
@xref{Fixed point trig}.@*
@xref{fixed}.@*
@node fixatan, fixatan2, fixacos, Fixed
@subsection fixatan
@ftable @asis
@item @t{fixed fixatan(fixed x);}
...
result = fixatan(ftofix(0.326));@end example
...
@xref{Fixed point trig}.@*
@xref{fixed}.@*
@node fixatan2, fixsqrt, fixatan, Fixed
@subsection fixatan2
@ftable @asis
@item @t{fixed fixatan2(fixed y, fixed x);}
...
@xref{exspline}.@*
@xref{fixed}.@*
@node fixsqrt, fixhypot, fixatan2, Fixed
@subsection fixsqrt
@ftable @asis
@item @t{fixed fixsqrt(fixed x);}
...
@xref{exspline}.@*
@xref{fixed}.@*
@node fixhypot, Fix class, fixsqrt, Fixed
@subsection fixhypot
@ftable @asis
@item @t{fixed fixhypot(fixed x, fixed y);}
...
@xref{Fixed point trig}.@*
@xref{fixed}.@*
@node Fix class, identity_matrix, fixhypot, Fixed
@subsection Fix class
@ftable @asis
@end ftable
...
@node 3D, Quaternion, Fixed, API
@section 3D math routines
 ...
 */
persp_project_f (cx, cy, cz, &sx, &sy);@end example
...
* persp_project::
@end menu
@node identity_matrix, get_translation_matrix, Fix class, 3D
@subsection identity_matrix
@ftable @asis
@item @t{extern MATRIX identity_matrix;}
@end ftable
@ftable @asis
@item @t{extern MATRIX_f identity_matrix_f;}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_translation_matrix, get_scaling_matrix, identity_matrix, 3D
@subsection get_translation_matrix
@ftable @asis
@item @t{void get_translation_matrix(MATRIX *m, fixed x, fixed y, fixed z);}
@end ftable
@ftable @asis
@item @t{void get_translation_matrix_f(MATRIX_f *m, float x, float y, float z);}
...
@xref{qtranslate_matrix}.@*
@xref{exstars}.@*
@xref{fixed}.@*
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_scaling_matrix, get_x_rotate_matrix, get_translation_matrix, 3D
@subsection get_scaling_matrix
@ftable @asis
@item @t{void get_scaling_matrix(MATRIX *m, fixed x, fixed y, fixed z);}
@end ftable
@ftable @asis
@item @t{void get_scaling_matrix_f(MATRIX_f *m, float x, float y, float z);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_x_rotate_matrix, get_y_rotate_matrix, get_scaling_matrix, 3D
@subsection get_x_rotate_matrix
@ftable @asis
@item @t{void get_x_rotate_matrix(MATRIX *m, fixed r);}
@end ftable
@ftable @asis
@item @t{void get_x_rotate_matrix_f(MATRIX_f *m, float r);}
...
See also:@*
@xref{apply_matrix}.@*
@xref{get_rotation_matrix}.@*
@xref{get_y_rotate_matrix}.@*
@xref{get_z_rotate_matrix}.@*
@xref{fixed}.@*
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_y_rotate_matrix, get_z_rotate_matrix, get_x_rotate_matrix, 3D
@subsection get_y_rotate_matrix
@ftable @asis
@item @t{void get_y_rotate_matrix(MATRIX *m, fixed r);}
@end ftable
@ftable @asis
@item @t{void get_y_rotate_matrix_f(MATRIX_f *m, float r);}
...
@xref{apply_matrix}.@*
@xref{get_rotation_matrix}.@*
@xref{get_x_rotate_matrix}.@*
@xref{get_z_rotate_matrix}.@*
@xref{fixed}.@*
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_z_rotate_matrix, get_rotation_matrix, get_y_rotate_matrix, 3D
@subsection get_z_rotate_matrix
@ftable @asis
@item @t{void get_z_rotate_matrix(MATRIX *m, fixed r);}
@end ftable
@ftable @asis
@item @t{void get_z_rotate_matrix_f(MATRIX_f *m, float r);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_rotation_matrix, get_align_matrix, get_z_rotate_matrix, 3D
@subsection get_rotation_matrix
@ftable @asis
@item @t{void get_rotation_matrix(MATRIX *m, fixed x, fixed y, fixed z);}
@end ftable
@ftable @asis
@item @t{void get_rotation_matrix_f(MATRIX_f *m, float x, float y, float z);}
...
@xref{apply_matrix}.@*
@xref{get_transformation_matrix}.@*
@xref{get_vector_rotation_matrix}.@*
@xref{get_x_rotate_matrix}.@*
@xref{get_y_rotate_matrix}.@*
@xref{get_z_rotate_matrix}.@*
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_align_matrix, get_align_matrix_f, get_rotation_matrix, 3D
@subsection get_align_matrix
@ftable @asis
@item @t{void get_align_matrix(MATRIX *m, fixed xfront, yfront, zfront,  fixed xup, fixed yup, fixed zup);}
...
@xref{fixed}.@*
@xref{MATRIX}.@*
@node get_align_matrix_f, get_vector_rotation_matrix, get_align_matrix, 3D
@subsection get_align_matrix_f
@ftable @asis
@item @t{void get_align_matrix_f(MATRIX *m, float xfront, yfront, zfront,  float xup, yup, zup);}
...
@xref{get_align_matrix}.@*
@xref{MATRIX}.@*
@node get_vector_rotation_matrix, get_transformation_matrix, get_align_matrix_f, 3D
@subsection get_vector_rotation_matrix
@ftable @asis
@item @t{void get_vector_rotation_matrix(MATRIX *m, fixed x, y, z, fixed a);}
@end ftable
@ftable @asis
@item @t{void get_vector_rotation_matrix_f(MATRIX_f *m, float x, y, z, float a);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node get_transformation_matrix, get_transformation_matrix_f, get_vector_rotation_matrix, 3D
@subsection get_transformation_matrix
@ftable @asis
@item @t{void get_transformation_matrix(MATRIX *m, fixed scale, fixed xrot, yrot, zrot, x, y, z);}
Constructs a transformation matrix which will rotate points around all 
three axes by the specified amounts (given in binary, 256 degrees to a 
...
@xref{fixed}.@*
@xref{MATRIX}.@*
@node get_transformation_matrix_f, get_camera_matrix, get_transformation_matrix, 3D
@subsection get_transformation_matrix_f
@ftable @asis
@item @t{void get_transformation_matrix_f(MATRIX_f *m, float scale, float xrot, yrot, zrot, x, y, z);}
...
@xref{exzbuf}.@*
@xref{MATRIX_f}.@*
@node get_camera_matrix, get_camera_matrix_f, get_transformation_matrix_f, 3D
@subsection get_camera_matrix
@ftable @asis
@item @t{void get_camera_matrix(MATRIX *m, fixed x, y, z, xfront, yfront, zfront, fixed xup, yup, zup, fov, aspect);}
...
@xref{apply_matrix}.@*
@xref{get_align_matrix}.@*
@xref{set_projection_viewport}.@*
@xref{persp_project}.@*
@xref{fixed}.@*
@xref{MATRIX}.@*
@node get_camera_matrix_f, qtranslate_matrix, get_camera_matrix, 3D
@subsection get_camera_matrix_f
@ftable @asis
@item @t{void get_camera_matrix_f(MATRIX_f *m, float x, y, z, xfront, yfront, zfront, float xup, yup, zup, fov, aspect);}
...
@xref{exquat}.@*
@xref{MATRIX_f}.@*
@node qtranslate_matrix, qscale_matrix, get_camera_matrix_f, 3D
@subsection qtranslate_matrix
@ftable @asis
@item @t{void qtranslate_matrix(MATRIX *m, fixed x, fixed y, fixed z);}
@end ftable
@ftable @asis
@item @t{void qtranslate_matrix_f(MATRIX_f *m, float x, float y, float z);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node qscale_matrix, matrix_mul, qtranslate_matrix, 3D
@subsection qscale_matrix
@ftable @asis
@item @t{void qscale_matrix(MATRIX *m, fixed scale);}
@end ftable
@ftable @asis
@item @t{void qscale_matrix_f(MATRIX_f *m, float scale);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node matrix_mul, vector_length, qscale_matrix, 3D
@subsection matrix_mul
@ftable @asis
@item @t{void matrix_mul(const MATRIX *m1, const MATRIX *m2, MATRIX *out);}
@end ftable
@ftable @asis
@item @t{void matrix_mul_f(const MATRIX_f *m1, const MATRIX_f *m2, MATRIX_f *out);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node vector_length, normalize_vector, matrix_mul, 3D
@subsection vector_length
@ftable @asis
@item @t{fixed vector_length(fixed x, fixed y, fixed z);}
@end ftable
@ftable @asis
@item @t{float vector_length_f(float x, float y, float z);}
...
@xref{fixed}.@*
@node normalize_vector, dot_product, vector_length, 3D
@subsection normalize_vector
@ftable @asis
@item @t{void normalize_vector(fixed *x, fixed *y, fixed *z);}
@end ftable
@ftable @asis
@item @t{void normalize_vector_f(float *x, float *y, float *z);}
...
@xref{exstars}.@*
@xref{fixed}.@*
@node dot_product, cross_product, normalize_vector, 3D
@subsection dot_product
@ftable @asis
@item @t{fixed dot_product(fixed x1, y1, z1, x2, y2, z2);}
@end ftable
@ftable @asis
@item @t{float dot_product_f(float x1, y1, z1, x2, y2, z2);}
...
@xref{exstars}.@*
@xref{fixed}.@*
@node cross_product, polygon_z_normal, dot_product, 3D
@subsection cross_product
@ftable @asis
@item @t{void cross_product(fixed x1, y1, z1, x2, y2, z2, *xout, *yout, *zout);}
@end ftable
@ftable @asis
@item @t{void cross_product_f(float x1, y1, z1, x2, y2, z2, *xout, *yout, *zout);}
...
See also:@*
@xref{dot_product}.@*
@xref{polygon_z_normal}.@*
@xref{normalize_vector}.@*
@xref{exstars}.@*
@xref{fixed}.@*
@node polygon_z_normal, apply_matrix, cross_product, 3D
@subsection polygon_z_normal
@ftable @asis
@item @t{fixed polygon_z_normal(const V3D *v1, const V3D *v2, const V3D *v3);}
@end ftable
@ftable @asis
@item @t{float polygon_z_normal_f(const V3D_f *v1, const V3D_f *v2, const V3D_f *v3);}
...
@xref{V3D}.@*
@xref{V3D_f}.@*
@node apply_matrix, set_projection_viewport, polygon_z_normal, 3D
@subsection apply_matrix
@ftable @asis
@item @t{void apply_matrix(const MATRIX *m, fixed x, y, z, *xout, *yout, *zout);}
@end ftable
@ftable @asis
@item @t{void apply_matrix_f(const MATRIX_f *m, float x, y, z, *xout, *yout, *zout);}
...
@xref{MATRIX}.@*
@xref{MATRIX_f}.@*
@node set_projection_viewport, persp_project, apply_matrix, 3D
@subsection set_projection_viewport
@ftable @asis
@item @t{void set_projection_viewport(int x, int y, int w, int h);}
...
@xref{exstars}.@*
@xref{exzbuf}.@*
@node persp_project, identity_quat, set_projection_viewport, 3D
@subsection persp_project
@ftable @asis
@item @t{void persp_project(fixed x, fixed y, fixed z, fixed *xout, fixed *yout);}
@end ftable
@ftable @asis
@item @t{void persp_project_f(float x, float y, float z, float *xout, float *yout);}
...
@xref{exstars}.@*
@xref{fixed}.@*
@node Quaternion, GUI, 3D, API
@section Quaternion math routines
...
* quat_slerp::
@end menu
@node identity_quat, get_x_rotate_quat, persp_project, Quaternion
@subsection identity_quat
@ftable @asis
@item @t{extern QUAT identity_quat;}
Global variable containing the 'do nothing' identity quaternion. 
Multiplying by the identity quaternion has no effect.

@end ftable
@xref{QUAT}.@*
@node get_x_rotate_quat, get_rotation_quat, identity_quat, Quaternion
@subsection get_x_rotate_quat
@ftable @asis
@item @t{void get_x_rotate_quat(QUAT *q, float r);}
@end ftable
@ftable @asis
@item @t{void get_y_rotate_quat(QUAT *q, float r);}
@end ftable
@ftable @asis
@item @t{void get_z_rotate_quat(QUAT *q, float r);}
...
@end ftable
@xref{QUAT}.@*
@node get_rotation_quat, get_vector_rotation_quat, get_x_rotate_quat, Quaternion
@subsection get_rotation_quat
@ftable @asis
@item @t{void get_rotation_quat(QUAT *q, float x, float y, float z);}
...
@xref{exquat}.@*
@xref{QUAT}.@*
@node get_vector_rotation_quat, quat_to_matrix, get_rotation_quat, Quaternion
@subsection get_vector_rotation_quat
@ftable @asis
@item @t{void get_vector_rotation_quat(QUAT *q, float x, y, z, float a);}
...
@end ftable
@xref{QUAT}.@*
@node quat_to_matrix, matrix_to_quat, get_vector_rotation_quat, Quaternion
@subsection quat_to_matrix
@ftable @asis
@item @t{void quat_to_matrix(const QUAT *q, MATRIX_f *m);}
...
@xref{MATRIX_f}.@*
@xref{QUAT}.@*
@node matrix_to_quat, quat_mul, quat_to_matrix, Quaternion
@subsection matrix_to_quat
@ftable @asis
@item @t{void matrix_to_quat(const MATRIX_f *m, QUAT *q);}
...
@xref{MATRIX_f}.@*
@xref{QUAT}.@*
@node quat_mul, apply_quat, matrix_to_quat, Quaternion
@subsection quat_mul
@ftable @asis
@item @t{void quat_mul(const QUAT *p, const QUAT *q, QUAT *out);}
...
@end ftable
@xref{QUAT}.@*
@node apply_quat, quat_interpolate, quat_mul, Quaternion
@subsection apply_quat
@ftable @asis
@item @t{void apply_quat(const QUAT *q, float x, y, z, *xout, *yout, *zout);}
...
@end ftable
@xref{QUAT}.@*
@node quat_interpolate, quat_slerp, apply_quat, Quaternion
@subsection quat_interpolate
@ftable @asis
@item @t{void quat_interpolate(const QUAT *from, const QUAT *to, float t, QUAT *out);}
...
@xref{exquat}.@*
@xref{QUAT}.@*
@node quat_slerp, d_clear_proc, quat_interpolate, Quaternion
@subsection quat_slerp
@ftable @asis
@item @t{void quat_slerp(const QUAT *from, const QUAT *to, float t, QUAT *out, int how);}
...
@end ftable
@xref{QUAT}.@*
@node GUI, Platform, Quaternion, API
@section GUI routines
...
* gui_shadow_box_proc::
@end menu
@node d_clear_proc, d_box_proc, quat_slerp, GUI
@subsection d_clear_proc
@ftable @asis
@item @t{int d_clear_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_box_proc, d_bitmap_proc, d_clear_proc, GUI
@subsection d_box_proc
@ftable @asis
@item @t{int d_box_proc(int msg, DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{int d_shadow_box_proc(int msg, DIALOG *d, int c);}
...
@xref{exrgbhsv}.@*
@xref{DIALOG}.@*
@node d_bitmap_proc, d_text_proc, d_box_proc, GUI
@subsection d_bitmap_proc
@ftable @asis
@item @t{int d_bitmap_proc(int msg, DIALOG *d, int c);}
...
@xref{exrgbhsv}.@*
@xref{DIALOG}.@*
@node d_text_proc, d_button_proc, d_bitmap_proc, GUI
@subsection d_text_proc
@ftable @asis
@item @t{int d_text_proc(int msg, DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{int d_ctext_proc(int msg, DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{int d_rtext_proc(int msg, DIALOG *d, int c);}
...
@xref{exrgbhsv}.@*
@xref{DIALOG}.@*
@node d_button_proc, d_check_proc, d_text_proc, GUI
@subsection d_button_proc
@ftable @asis
@item @t{int d_button_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_check_proc, d_radio_proc, d_button_proc, GUI
@subsection d_check_proc
@ftable @asis
@item @t{int d_check_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_radio_proc, d_icon_proc, d_check_proc, GUI
@subsection d_radio_proc
@ftable @asis
@item @t{int d_radio_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_icon_proc, d_keyboard_proc, d_radio_proc, GUI
@subsection d_icon_proc
@ftable @asis
@item @t{int d_icon_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_keyboard_proc, d_edit_proc, d_icon_proc, GUI
@subsection d_keyboard_proc
@ftable @asis
@item @t{int d_keyboard_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_edit_proc, d_list_proc, d_keyboard_proc, GUI
@subsection d_edit_proc
@ftable @asis
@item @t{int d_edit_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_list_proc, d_text_list_proc, d_edit_proc, GUI
@subsection d_list_proc
@ftable @asis
@item @t{int d_list_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_text_list_proc, d_textbox_proc, d_list_proc, GUI
@subsection d_text_list_proc
@ftable @asis
@item @t{int d_text_list_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_textbox_proc, d_slider_proc, d_text_list_proc, GUI
@subsection d_textbox_proc
@ftable @asis
@item @t{int d_textbox_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_slider_proc, d_menu_proc, d_textbox_proc, GUI
@subsection d_slider_proc
@ftable @asis
@item @t{int d_slider_proc(int msg, DIALOG *d, int c);}
...
@xref{exrgbhsv}.@*
@xref{DIALOG}.@*
@node d_menu_proc, d_yield_proc, d_slider_proc, GUI
@subsection d_menu_proc
@ftable @asis
@item @t{int d_menu_proc(int msg, DIALOG *d, int c);}
...
@xref{GUI menus}.@*
@xref{active_menu}.@*
@xref{gui_menu_draw_menu}.@*
@xref{exgui}.@*
@xref{DIALOG}.@*
@node d_yield_proc, GUI variables, d_menu_proc, GUI
@subsection d_yield_proc
@ftable @asis
@item @t{int d_yield_proc(int msg, DIALOG *d, int c);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node GUI variables, gui_mouse_focus, d_yield_proc, GUI
...
@node gui_mouse_focus, gui_fg_color, GUI variables, GUI
@subsection gui_mouse_focus
@ftable @asis
@item @t{extern int gui_mouse_focus;}
If set, the input focus follows the mouse pointer around the dialog, 
otherwise a click is required to move it.

@end ftable
@node gui_fg_color, gui_mg_color, gui_mouse_focus, GUI
@subsection gui_fg_color
@ftable @asis
@item @t{extern int gui_fg_color;}
@end ftable
@ftable @asis
@item @t{extern int gui_bg_color;}
...
See also:@*
@xref{gui_mg_color}.@*
@xref{set_dialog_color}.@*
@xref{exgui}.@*
@node gui_mg_color, gui_font_baseline, gui_fg_color, GUI
@subsection gui_mg_color
@ftable @asis
@item @t{extern int gui_mg_color;}
...
@xref{set_dialog_color}.@*
@xref{exgui}.@*
@node gui_font_baseline, gui_mouse_x, gui_mg_color, GUI
@subsection gui_font_baseline
@ftable @asis
@item @t{extern int gui_font_baseline;}
...
@end ftable
@node gui_mouse_x, GUI font, gui_font_baseline, GUI
@subsection gui_mouse_x
@ftable @asis
@item @t{extern int (*gui_mouse_x)();}
@end ftable
@ftable @asis
@item @t{extern int (*gui_mouse_y)();}
@end ftable
@ftable @asis
@item @t{extern int (*gui_mouse_z)();}
@end ftable
@ftable @asis
@item @t{extern int (*gui_mouse_b)();}
...
@end ftable
@node GUI font, gui_textout_ex, gui_mouse_x, GUI
@subsection GUI font
@ftable @asis
@end ftable
...
@node gui_textout_ex, gui_strlen, GUI font, GUI
@subsection gui_textout_ex
@ftable @asis
@item @t{int gui_textout_ex(BITMAP *bmp, const char *s, int x, y, color, bg, centre);}
...
@xref{gui_strlen}.@*
@xref{BITMAP}.@*
@node gui_strlen, gui_set_screen, gui_textout_ex, GUI
@subsection gui_strlen
@ftable @asis
@item @t{int gui_strlen(const char *s);}
...
See also:@*
@xref{gui_textout_ex}.@*
@node gui_set_screen, gui_get_screen, gui_strlen, GUI
@subsection gui_set_screen
@ftable @asis
@item @t{void gui_set_screen(BITMAP *bmp);}
...
@xref{gui_get_screen}.@*
@xref{BITMAP}.@*
@node gui_get_screen, position_dialog, gui_set_screen, GUI
@subsection gui_get_screen
@ftable @asis
@item @t{BITMAP *gui_get_screen(void);}
...
@xref{gui_set_screen}.@*
@xref{BITMAP}.@*
@node position_dialog, centre_dialog, gui_get_screen, GUI
@subsection position_dialog
@ftable @asis
@item @t{void position_dialog(DIALOG *dialog, int x, int y);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node centre_dialog, set_dialog_color, position_dialog, GUI
@subsection centre_dialog
@ftable @asis
@item @t{void centre_dialog(DIALOG *dialog);}
Moves an array of dialog objects so that it is centered in the screen.

@end ftable
See also:@*
@xref{position_dialog}.@*
@xref{set_dialog_color}.@*
@xref{DIALOG}.@*
@node set_dialog_color, find_dialog_focus, centre_dialog, GUI
@subsection set_dialog_color
@ftable @asis
@item @t{void set_dialog_color(DIALOG *dialog, int fg, int bg);}
...
@xref{exgui}.@*
@xref{DIALOG}.@*
@node find_dialog_focus, offer_focus, set_dialog_color, GUI
@subsection find_dialog_focus
@ftable @asis
@item @t{int find_dialog_focus(DIALOG *dialog);}
...
@xref{offer_focus}.@*
@xref{DIALOG}.@*
@node offer_focus, object_message, find_dialog_focus, GUI
@subsection offer_focus
@ftable @asis
@item @t{int offer_focus(DIALOG *dialog, int obj, int *focus_obj, int force);}
...
@xref{DIALOG}.@*
@node object_message, dialog_message, offer_focus, GUI
@subsection object_message
@ftable @asis
@item @t{int object_message(DIALOG *dialog, int msg, int c);}
...
@xref{exrgbhsv}.@*
@xref{DIALOG}.@*
@node dialog_message, broadcast_dialog_message, object_message, GUI
@subsection dialog_message
@ftable @asis
@item @t{int dialog_message(DIALOG *dialog, int msg, int c, int *obj);}
...
See also:@*
@xref{object_message}.@*
@xref{broadcast_dialog_message}.@*
@xref{DIALOG}.@*
@node broadcast_dialog_message, do_dialog, dialog_message, GUI
@subsection broadcast_dialog_message
@ftable @asis
@item @t{int broadcast_dialog_message(int msg, int c);}
...
@xref{dialog_message}.@*
@xref{active_dialog}.@*
@node do_dialog, popup_dialog, broadcast_dialog_message, GUI
@subsection do_dialog
@ftable @asis
@item @t{int do_dialog(DIALOG *dialog, int focus_obj);}
...
@xref{exrgbhsv}.@*
@xref{DIALOG}.@*
@node popup_dialog, init_dialog, do_dialog, GUI
@subsection popup_dialog
@ftable @asis
@item @t{int popup_dialog(DIALOG *dialog, int focus_obj);}
...
@xref{do_dialog}.@*
@xref{DIALOG}.@*
@node init_dialog, update_dialog, popup_dialog, GUI
@subsection init_dialog
@ftable @asis
@item @t{DIALOG_PLAYER *init_dialog(DIALOG *dialog, int focus_obj);}
...
return shutdown_dialog(player);@end example
...
@xref{DIALOG}.@*
@xref{DIALOG_PLAYER}.@*
@node update_dialog, shutdown_dialog, init_dialog, GUI
@subsection update_dialog
@ftable @asis
@item @t{int update_dialog(DIALOG_PLAYER *player);}
...
@xref{init_dialog}.@*
@xref{DIALOG_PLAYER}.@*
@node shutdown_dialog, active_dialog, update_dialog, GUI
@subsection shutdown_dialog
@ftable @asis
@item @t{int shutdown_dialog(DIALOG_PLAYER *player);}
...
@xref{init_dialog}.@*
@xref{DIALOG_PLAYER}.@*
@node active_dialog, GUI menus, shutdown_dialog, GUI
@subsection active_dialog
@ftable @asis
@item @t{extern DIALOG *active_dialog;}
...
@xref{broadcast_dialog_message}.@*
@xref{DIALOG}.@*
@node GUI menus, do_menu, active_dialog, GUI
@subsection GUI menus
@ftable @asis
@end ftable
...
@xref{d_menu_proc}.@*
@xref{gui_menu_draw_menu}.@*
@node do_menu, init_menu, GUI menus, GUI
@subsection do_menu
@ftable @asis
@item @t{int do_menu(MENU *menu, int x, int y);}
...
@xref{update_menu}.@*
@xref{MENU}.@*
@node init_menu, update_menu, do_menu, GUI
@subsection init_menu
@ftable @asis
@item @t{MENU_PLAYER *init_menu(MENU *menu, int x, int y);}
This function provides lower level access to the same functionality as 
...
return shutdown_menu(player);@end example
...
@xref{MENU}.@*
@xref{MENU_PLAYER}.@*
@node update_menu, shutdown_menu, init_menu, GUI
@subsection update_menu
@ftable @asis
@item @t{int update_menu(MENU_PLAYER *player);}
...
@xref{do_menu}.@*
@xref{MENU_PLAYER}.@*
@node shutdown_menu, active_menu, update_menu, GUI
@subsection shutdown_menu
@ftable @asis
@item @t{int shutdown_menu(MENU_PLAYER *player);}
...
@xref{update_menu}.@*
@xref{MENU_PLAYER}.@*
@node active_menu, gui_menu_draw_menu, shutdown_menu, GUI
@subsection active_menu
@ftable @asis
@item @t{extern MENU *active_menu;}
...
@xref{exgui}.@*
@xref{MENU}.@*
@node gui_menu_draw_menu, alert, active_menu, GUI
@subsection gui_menu_draw_menu
@ftable @asis
@item @t{extern void (*gui_menu_draw_menu)(int x, int y, int w, int h);}
@end ftable
@ftable @asis
@item @t{extern void (*gui_menu_draw_menu_item)(MENU *m, int x, int y, int w, int h, int bar, int sel);}
...
@xref{GUI menus}.@*
@xref{MENU}.@*
@node alert, alert3, gui_menu_draw_menu, GUI
@subsection alert
@ftable @asis
@item @t{int alert(const char *s1, *s2, *s3, const char *b1, *b2, int c1, c2);}
...
@xref{expackf}.@*
@xref{exspline}.@*
@node alert3, file_select_ex, alert, GUI
@subsection alert3
@ftable @asis
@item @t{int alert3(const char *s1, *s2, *s3, const char *b1, *b2, *b3, int c1, c2, c3);}
...
@xref{alert}.@*
@xref{gui_fg_color}.@*
@node file_select_ex, gfx_mode_select, alert3, GUI
@subsection file_select_ex
@ftable @asis
@item @t{int file_select_ex(const char *message, char *path, const char *ext, int size, int w, int h);}
...
See also:@*
@xref{gui_fg_color}.@*
@node gfx_mode_select, gfx_mode_select_ex, file_select_ex, GUI
@subsection gfx_mode_select
@ftable @asis
@item @t{int gfx_mode_select(int *card, int *w, int *h);}
...
@end ftable
See also:@*
@xref{gfx_mode_select_ex}.@*
@xref{gfx_mode_select_filter}.@*
@xref{set_gfx_mode}.@*
@xref{gui_fg_color}.@*
@node gfx_mode_select_ex, gfx_mode_select_filter, gfx_mode_select, GUI
@subsection gfx_mode_select_ex
@ftable @asis
@item @t{int gfx_mode_select_ex(int *card, int *w, int *h, int *color_depth);}
...
@xref{exupdate}.@*
@xref{exzbuf}.@*
@node gfx_mode_select_filter, gui_shadow_box_proc, gfx_mode_select_ex, GUI
@subsection gfx_mode_select_filter
@ftable @asis
@item @t{int gfx_mode_select_filter(int *card, int *w, int *h, int *color_depth, int (*filter)(int, int, int, int));}
...
@xref{set_gfx_mode}.@*
@xref{gui_fg_color}.@*
@node gui_shadow_box_proc, JOY_TYPE_*/DOS, gfx_mode_select_filter, GUI
@subsection gui_shadow_box_proc
@ftable @asis
@item @t{extern int (*gui_shadow_box_proc)(int msg, struct DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{extern int (*gui_ctext_proc)(int msg, struct DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{extern int (*gui_button_proc)(int msg, struct DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{extern int (*gui_edit_proc)(int msg, struct DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{extern int (*gui_list_proc)(int msg, struct DIALOG *d, int c);}
@end ftable
@ftable @asis
@item @t{extern int (*gui_text_list_proc)(int msg, struct DIALOG *d, int c);}
...
@end menu
@node DOS, Windows, Platform, Platform
@section DOS specifics
...
* i_love_bill::
@end menu
@node JOY_TYPE_*/DOS, GFX_*/DOS, gui_shadow_box_proc, DOS
@subsection JOY_TYPE_*/DOS
@ftable @asis
@item @t{Drivers JOY_TYPE_*/DOS}
...
See also:@*
@xref{install_joystick}.@*
@node GFX_*/DOS, DIGI_*/DOS, JOY_TYPE_*/DOS, DOS
@subsection GFX_*/DOS
@ftable @asis
@item @t{Drivers GFX_*/DOS}
...
See also:@*
@xref{set_gfx_mode}.@*
@node DIGI_*/DOS, MIDI_*/DOS, GFX_*/DOS, DOS
@subsection DIGI_*/DOS
@ftable @asis
@item @t{Drivers DIGI_*/DOS}
...
DIGI_WINSOUNDSYS     - Windows Sound System@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node MIDI_*/DOS, DOS integration routines, DIGI_*/DOS, DOS
@subsection MIDI_*/DOS
@ftable @asis
@item @t{Drivers MIDI_*/DOS}
...
MIDI_AWE32           - AWE32 (EMU8000 chip)@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node DOS integration routines, i_love_bill, MIDI_*/DOS, DOS
@subsection DOS integration routines
@ftable @asis

@end ftable
@node i_love_bill, JOY_TYPE_*/Windows, DOS integration routines, DOS
@subsection i_love_bill
@ftable @asis
@item @t{extern int i_love_bill;}
...
@xref{allegro_init}.@*
@xref{os_type}.@*
@node Windows, Unix, DOS, Platform
...
@end menu
@node JOY_TYPE_*/Windows, GFX_*/Windows, i_love_bill, Windows
@subsection JOY_TYPE_*/Windows
@ftable @asis
@item @t{Drivers JOY_TYPE_*/Windows}
...
See also:@*
@xref{install_joystick}.@*
@node GFX_*/Windows, DIGI_*/Windows, JOY_TYPE_*/Windows, Windows
@subsection GFX_*/Windows
@ftable @asis
@item @t{Drivers GFX_*/Windows}
...
See also:@*
@xref{set_gfx_mode}.@*
@node DIGI_*/Windows, MIDI_*/Windows, GFX_*/Windows, Windows
@subsection DIGI_*/Windows
@ftable @asis
@item @t{Drivers DIGI_*/Windows}
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node MIDI_*/Windows, Windows integration routines, DIGI_*/Windows, Windows
@subsection MIDI_*/Windows
@ftable @asis
@item @t{Drivers MIDI_*/Windows}
...
MIDI_DIGMID          - sample-based software wavetable player@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node Windows integration routines, win_get_window, MIDI_*/Windows, Windows
@subsection Windows integration routines
@ftable @asis
...
@node win_get_window, win_set_window, Windows integration routines, Windows
@subsection win_get_window
@ftable @asis
@item @t{HWND win_get_window(void);}
...
@end ftable
@node win_set_window, win_set_wnd_create_proc, win_get_window, Windows
@subsection win_set_window
@ftable @asis
@item @t{void win_set_window(HWND wnd);}
...
@end ftable
@node win_set_wnd_create_proc, win_get_dc, win_set_window, Windows
@subsection win_set_wnd_create_proc
@ftable @asis
@item @t{void win_set_wnd_create_proc(HWND (*proc)(WNDPROC));}
...
@end ftable
@node win_get_dc, win_release_dc, win_set_wnd_create_proc, Windows
@subsection win_get_dc
@ftable @asis
@item @t{HDC win_get_dc(BITMAP *bmp);}
Retrieves a handle to the device context of a DirectX video or system
bitmap.

@end ftable
@xref{BITMAP}.@*
@node win_release_dc, GDI routines, win_get_dc, Windows
@subsection win_release_dc
@ftable @asis
@item @t{void win_release_dc(BITMAP *bmp, HDC dc);}
Releases a handle to the device context of the bitmap that was
previously retrieved with win_get_dc().

@end ftable
@xref{BITMAP}.@*
@node GDI routines, set_gdi_color_format, win_release_dc, Windows
@subsection GDI routines
@ftable @asis
...
@node set_gdi_color_format, set_palette_to_hdc, GDI routines, Windows
@subsection set_gdi_color_format
@ftable @asis
@item @t{void set_gdi_color_format(void);}
...
@end ftable
@node set_palette_to_hdc, convert_palette_to_hpalette, set_gdi_color_format, Windows
@subsection set_palette_to_hdc
@ftable @asis
@item @t{void set_palette_to_hdc(HDC dc, PALETTE pal);}
Selects and realizes an Allegro palette on the specified device context.

@end ftable
@xref{PALETTE}.@*
@node convert_palette_to_hpalette, convert_hpalette_to_palette, set_palette_to_hdc, Windows
@subsection convert_palette_to_hpalette
@ftable @asis
@item @t{HPALETTE convert_palette_to_hpalette(PALETTE pal);}
...
@xref{PALETTE}.@*
@node convert_hpalette_to_palette, convert_bitmap_to_hbitmap, convert_palette_to_hpalette, Windows
@subsection convert_hpalette_to_palette
@ftable @asis
@item @t{void convert_hpalette_to_palette(HPALETTE hpal, PALETTE pal);}
...
@xref{PALETTE}.@*
@node convert_bitmap_to_hbitmap, convert_hbitmap_to_bitmap, convert_hpalette_to_palette, Windows
@subsection convert_bitmap_to_hbitmap
@ftable @asis
@item @t{HBITMAP convert_bitmap_to_hbitmap(BITMAP *bitmap);}
...
@xref{BITMAP}.@*
@node convert_hbitmap_to_bitmap, draw_to_hdc, convert_bitmap_to_hbitmap, Windows
@subsection convert_hbitmap_to_bitmap
@ftable @asis
@item @t{BITMAP *convert_hbitmap_to_bitmap(HBITMAP bitmap);}
...
@xref{BITMAP}.@*
@node draw_to_hdc, blit_to_hdc, convert_hbitmap_to_bitmap, Windows
@subsection draw_to_hdc
@ftable @asis
@item @t{void draw_to_hdc(HDC dc, BITMAP *bitmap, int x, int y);}
...
See also:@*
@xref{blit_to_hdc}.@*
@xref{stretch_blit_to_hdc}.@*
@xref{draw_sprite}.@*
@xref{BITMAP}.@*
@node blit_to_hdc, stretch_blit_to_hdc, draw_to_hdc, Windows
@subsection blit_to_hdc
@ftable @asis
@item @t{void blit_to_hdc(BITMAP *bitmap, HDC dc, int sx, sy, dx, dy, w, h);}
...
@xref{blit}.@*
@xref{BITMAP}.@*
@node stretch_blit_to_hdc, blit_from_hdc, blit_to_hdc, Windows
@subsection stretch_blit_to_hdc
@ftable @asis
@item @t{void stretch_blit_to_hdc(BITMAP *bitmap, HDC dc, int sx, sy, sw, sh, int dx, dy, dw, dh);}
Blits an Allegro memory bitmap to a Windows device context, using the 
...
@xref{draw_to_hdc}.@*
@xref{blit_to_hdc}.@*
@xref{stretch_blit_from_hdc}.@*
@xref{stretch_blit}.@*
@xref{BITMAP}.@*
@node blit_from_hdc, stretch_blit_from_hdc, stretch_blit_to_hdc, Windows
@subsection blit_from_hdc
@ftable @asis
@item @t{void blit_from_hdc(HDC hdc, BITMAP *bitmap, int sx, sy, dx, dy, w, h);}
...
@xref{blit}.@*
@xref{BITMAP}.@*
@node stretch_blit_from_hdc, JOY_TYPE_*/Linux, blit_from_hdc, Windows
@subsection stretch_blit_from_hdc
@ftable @asis
@item @t{void stretch_blit_from_hdc(HDC hcd, BITMAP *bitmap, int sx, sy, sw, sh, int dx, dy, dw, dh);}
Blits from a Windows device context to an Allegro memory bitmap, using 
...
@xref{stretch_blit}.@*
@xref{BITMAP}.@*
@node Unix, BeOS, Windows, Platform
...
* allegro_icon::
@end menu
@node JOY_TYPE_*/Linux, GFX_*/Linux, stretch_blit_from_hdc, Unix
@subsection JOY_TYPE_*/Linux
@ftable @asis
@item @t{Drivers JOY_TYPE_*/Linux}
...
See also:@*
@xref{install_joystick}.@*
@node GFX_*/Linux, GFX_*/X, JOY_TYPE_*/Linux, Unix
@subsection GFX_*/Linux
@ftable @asis
@item @t{Drivers GFX_*/Linux}
...
@xref{set_gfx_mode}.@*
@xref{GFX_*/X}.@*
@node GFX_*/X, DIGI_*/Unix, GFX_*/Linux, Unix
@subsection GFX_*/X
@ftable @asis
@item @t{Drivers GFX_*/X}
...
@xref{set_gfx_mode}.@*
@xref{GFX_*/Linux}.@*
@node DIGI_*/Unix, MIDI_*/Unix, GFX_*/X, Unix
@subsection DIGI_*/Unix
@ftable @asis
@item @t{Drivers DIGI_*/Unix}
...
DIGI_JACK            - JACK sound driver@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node MIDI_*/Unix, Unix integration routines, DIGI_*/Unix, Unix
@subsection MIDI_*/Unix
@ftable @asis
@item @t{Drivers MIDI_*/Unix}
...
MIDI_DIGMID          - sample-based software wavetable player
MIDI_ALSA            - ALSA RawMIDI driver@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node Unix integration routines, xwin_set_window_name, MIDI_*/Unix, Unix
@subsection Unix integration routines
@ftable @asis

@end ftable
@node xwin_set_window_name, allegro_icon, Unix integration routines, Unix
@subsection xwin_set_window_name
@ftable @asis
@item @t{void xwin_set_window_name(const char *name, const char *group);}
...
See also:@*
@xref{set_window_title}.@*
@node allegro_icon, GFX_*/BeOS, xwin_set_window_name, Unix
@subsection allegro_icon
@ftable @asis
@item @t{extern void *allegro_icon;}
...
@end ftable
@node BeOS, QNX, Unix, Platform
@section BeOS specifics
...
* MIDI_*/BeOS::
@end menu
@node GFX_*/BeOS, DIGI_*/BeOS, allegro_icon, BeOS
@subsection GFX_*/BeOS
@ftable @asis
@item @t{Drivers GFX_*/BeOS}
...
See also:@*
@xref{set_gfx_mode}.@*
@node DIGI_*/BeOS, MIDI_*/BeOS, GFX_*/BeOS, BeOS
@subsection DIGI_*/BeOS
@ftable @asis
@item @t{Drivers DIGI_*/BeOS}
The BeOS sound functions support the following digital sound cards:
@example

DIGI_AUTODETECT      - let Allegro pick a digital sound driver
DIGI_NONE            - no digital sound
DIGI_BEOS            - BeOS digital output@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node MIDI_*/BeOS, GFX_*/QNX, DIGI_*/BeOS, BeOS
@subsection MIDI_*/BeOS
@ftable @asis
@item @t{Drivers MIDI_*/BeOS}
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node QNX, MacOS, BeOS, Platform
@section QNX specifics
...
* qnx_get_window::
@end menu
@node GFX_*/QNX, DIGI_*/QNX, MIDI_*/BeOS, QNX
@subsection GFX_*/QNX
@ftable @asis
@item @t{Drivers GFX_*/QNX}
...
See also:@*
@xref{set_gfx_mode}.@*
@node DIGI_*/QNX, MIDI_*/QNX, GFX_*/QNX, QNX
@subsection DIGI_*/QNX
@ftable @asis
@item @t{Drivers DIGI_*/QNX}
The QNX sound functions support the following digital sound cards:
@example

DIGI_AUTODETECT      - let Allegro pick a digital sound driver
DIGI_NONE            - no digital sound
DIGI_ALSA            - ALSA sound driver@end example
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node MIDI_*/QNX, QNX integration routines, DIGI_*/QNX, QNX
@subsection MIDI_*/QNX
@ftable @asis
@item @t{Drivers MIDI_*/QNX}
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node QNX integration routines, qnx_get_window, MIDI_*/QNX, QNX
@subsection QNX integration routines
@ftable @asis
...
@node qnx_get_window, GFX_*/MacOSX, QNX integration routines, QNX
@subsection qnx_get_window
@ftable @asis
@item @t{PtWidget_t qnx_get_window(void);}
Retrieves a handle to the window used by Allegro. Note that Allegro
uses an underlying window even though you don't set any graphics mode,
unless you have installed the neutral system driver (SYSTEM_NONE).
...
@end ftable
@node MacOS, Differences, QNX, Platform
@section MacOS X specifics
...
* MIDI_*/MacOSX::
@end menu
@node GFX_*/MacOSX, DIGI_*/MacOSX, qnx_get_window, MacOS
@subsection GFX_*/MacOSX
@ftable @asis
@item @t{Drivers GFX_*/MacOSX}
...
See also:@*
@xref{set_gfx_mode}.@*
@node DIGI_*/MacOSX, MIDI_*/MacOSX, GFX_*/MacOSX, MacOS
@subsection DIGI_*/MacOSX
@ftable @asis
@item @t{Drivers DIGI_*/MacOSX}
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node MIDI_*/MacOSX, ASSERT, DIGI_*/MacOSX, MacOS
@subsection MIDI_*/MacOSX
@ftable @asis
@item @t{Drivers MIDI_*/MacOSX}
...
@xref{install_sound}.@*
@xref{install_sound_input}.@*
@node Differences, Miscellaneous, MacOS, Platform
...
@node Miscellaneous, Reducing, Differences, Top
...
@end menu
@node Reducing, Debugging, Miscellaneous, Miscellaneous
@section Reducing your executable size
...
@node Debugging, Makefile, Reducing, Miscellaneous
@section Debugging
...
* al_trace::
@end menu
@node ASSERT, TRACE, MIDI_*/MacOSX, Debugging
@subsection ASSERT
@ftable @asis
@item @t{void ASSERT(condition);}
...
@xref{al_assert}.@*
@xref{TRACE}.@*
@xref{register_assert_handler}.@*
@xref{expackf}.@*
@node TRACE, register_assert_handler, ASSERT, Debugging
@subsection TRACE
@ftable @asis
@item @t{void TRACE(char *msg, ...);}
Debugging helper macro. Normally compiles away to nothing, but if you 
defined the preprocessor symbol DEBUGMODE before including Allegro headers,
...
@xref{al_trace}.@*
@xref{ASSERT}.@*
@xref{register_trace_handler}.@*
@node register_assert_handler, register_trace_handler, TRACE, Debugging
@subsection register_assert_handler
@ftable @asis
@item @t{void register_assert_handler(int (*handler)(const char *msg));}
...
...
   ...
   ASSERT(0); /* This won't crash the program now. */@end example
...
@xref{ASSERT}.@*
@xref{register_trace_handler}.@*
@node register_trace_handler, al_assert, register_assert_handler, Debugging
@subsection register_trace_handler
@ftable @asis
@item @t{void register_trace_handler(int (*handler)(const char *msg));}
...
@xref{TRACE}.@*
@xref{register_assert_handler}.@*
@node al_assert, al_trace, register_trace_handler, Debugging
@subsection al_assert
@ftable @asis
@item @t{void al_assert(const char *file, int line);}
...
@xref{al_trace}.@*
@xref{register_assert_handler}.@*
@node al_trace, exhello, al_assert, Debugging
@subsection al_trace
@ftable @asis
@item @t{void al_trace(const char *msg, ...);}
...
@xref{al_assert}.@*
@xref{register_trace_handler}.@*
@node Makefile, Available, Debugging, Miscellaneous
...
@node Available, Tools, Makefile, Miscellaneous
@section Available Allegro examples
...
* expackf::
@end menu
@node exhello, exmem, al_trace, Available
@subsection exhello
@ftable @asis
@item @t{Example exhello}
...
@xref{set_palette}.@*
@xref{textout_centre_ex}.@*
@node exmem, expal, exhello, Available
@subsection exmem
@ftable @asis
@item @t{Example exmem}
...
@xref{set_gfx_mode}.@*
@xref{set_palette}.@*
@node expal, expat, exmem, Available
@subsection expal
@ftable @asis
@item @t{Example expal}
...
@xref{set_palette}.@*
@xref{show_mouse}.@*
@node expat, exflame, expal, Available
@subsection expat
@ftable @asis
@item @t{Example expat}
...
@xref{text_length}.@*
@xref{textout_ex}.@*
@node exflame, exdbuf, expat, Available
@subsection exflame
@ftable @asis
@item @t{Example exflame}
...
@xref{set_palette}.@*
@xref{textout_ex}.@*
@node exdbuf, exflip, exflame, Available
@subsection exdbuf
@ftable @asis
@item @t{Example exdbuf}
...
@xref{set_palette}.@*
@xref{textprintf_ex}.@*
@node exflip, exfixed, exdbuf, Available
@subsection exflip
@ftable @asis
@item @t{Example exflip}
...
@xref{show_video_bitmap}.@*
@xref{textprintf_ex}.@*
@node exfixed, exfont, exflip, Available
@subsection exfixed
@ftable @asis
@item @t{Example exfixed}
...
@xref{ftofix}.@*
@xref{itofix}.@*
@node exfont, exmouse, exfixed, Available
@subsection exfont
@ftable @asis
@item @t{Example exfont}
...
@xref{set_palette}.@*
@xref{textout_centre_ex}.@*
@node exmouse, extimer, exfont, Available
@subsection exmouse
@ftable @asis
@item @t{Example exmouse}
...
@xref{keypressed}.@*
@xref{makecol}.@*
@xref{mouse_x, mouse_b}.@*
@xref{mouse_x, mouse_w}.@*
@xref{mouse_x}.@*
@xref{mouse_x, mouse_y}.@*
@xref{mouse_x, mouse_z}.@*
@xref{palette_color}.@*
@xref{poll_mouse}.@*
@xref{readkey}.@*
@xref{release_screen}.@*
...
@xref{textprintf_right_ex}.@*
@xref{vsync}.@*
@node extimer, exkeys, exmouse, Available
@subsection extimer
@ftable @asis
@item @t{Example extimer}
...
@xref{set_palette}.@*
@xref{textprintf_centre_ex}.@*
@node exkeys, exjoy, extimer, Available
@subsection exkeys
@ftable @asis
@item @t{Example exkeys}
...
@xref{usprintf}.@*
@xref{ustrzncpy}.@*
@node exjoy, exsample, exkeys, Available
@subsection exjoy
@ftable @asis
@item @t{Example exjoy}
...
@xref{textprintf_centre_ex}.@*
@xref{textprintf_ex}.@*
@node exsample, exmidi, exjoy, Available
@subsection exsample
@ftable @asis
@item @t{Example exsample}
...
@xref{set_palette}.@*
@xref{textprintf_centre_ex}.@*
@node exmidi, exgui, exsample, Available
@subsection exmidi
@ftable @asis
@item @t{Example exmidi}
...
@xref{text_length}.@*
@xref{textprintf_centre_ex}.@*
@node exgui, excustom, exmidi, Available
@subsection exgui
@ftable @asis
@item @t{Example exgui}
...
@xref{d_check_proc}.@*
@xref{d_clear_proc}.@*
@xref{d_text_proc, d_ctext_proc}.@*
@xref{d_edit_proc}.@*
@xref{d_icon_proc}.@*
@xref{d_keyboard_proc}.@*
@xref{d_list_proc}.@*
@xref{d_menu_proc}.@*
@xref{d_radio_proc}.@*
@xref{d_text_proc, d_rtext_proc}.@*
@xref{d_box_proc, d_shadow_box_proc}.@*
@xref{d_slider_proc}.@*
@xref{d_text_list_proc}.@*
@xref{d_text_proc}.@*
@xref{d_textbox_proc}.@*
@xref{d_yield_proc}.@*
@xref{do_dialog}.@*
@xref{gui_fg_color, gui_bg_color}.@*
@xref{gui_fg_color}.@*
@xref{gui_mg_color}.@*
@xref{install_keyboard}.@*
@xref{install_mouse}.@*
...
@xref{ustrzcpy}.@*
@xref{uszprintf}.@*
@node excustom, exunicod, exgui, Available
@subsection excustom
@ftable @asis
@item @t{Example excustom}
...
@xref{set_palette}.@*
@xref{unload_datafile}.@*
@node exunicod, exbitmap, excustom, Available
@subsection exunicod
@ftable @asis
@item @t{Example exunicod}
...
@xref{ustrsize}.@*
@xref{ustrsizez}.@*
@node exbitmap, exscale, exunicod, Available
@subsection exbitmap
@ftable @asis
@item @t{Example exbitmap}
...
@xref{set_gfx_mode}.@*
@xref{set_palette}.@*
@node exscale, exconfig, exbitmap, Available
@subsection exscale
@ftable @asis
@item @t{Example exscale}
...
@xref{stretch_blit}.@*
@xref{vsync}.@*
@node exconfig, exdata, exscale, Available
@subsection exconfig
@ftable @asis
@item @t{Example exconfig}
...
@xref{ustrdup}.@*
@xref{ustricmp}.@*
@node exdata, exsprite, exconfig, Available
@subsection exdata
@ftable @asis
@item @t{Example exdata}
...
@xref{textout_ex}.@*
@xref{unload_datafile}.@*
@node exsprite, exexedat, exdata, Available
@subsection exsprite
@ftable @asis
@item @t{Example exsprite}
...
@xref{destroy_bitmap}.@*
@xref{draw_sprite}.@*
@xref{draw_sprite_v_flip, draw_sprite_h_flip}.@*
@xref{draw_sprite_v_flip}.@*
@xref{draw_sprite_v_flip, draw_sprite_vh_flip}.@*
@xref{fixed}.@*
@xref{font}.@*
@xref{hline}.@*
@xref{install_int_ex}.@*
...
@xref{unload_datafile}.@*
@xref{vsync}.@*
@node exexedat, extrans, exsprite, Available
@subsection exexedat
@ftable @asis
@item @t{Example exexedat}
...
@xref{textout_ex}.@*
@xref{unload_datafile}.@*
@node extrans, extruec, exexedat, Available
@subsection extrans
@ftable @asis
@item @t{Example extrans}
...
@xref{set_write_alpha_blender}.@*
@xref{stretch_blit}.@*
@node extruec, excolmap, extrans, Available
@subsection extruec
@ftable @asis
@item @t{Example extruec}
...
@xref{textprintf_ex}.@*
@xref{vline}.@*
@node excolmap, exrgbhsv, extruec, Available
@subsection excolmap
@ftable @asis
@item @t{Example excolmap}
...
@xref{textout_centre_ex}.@*
@xref{vsync}.@*
@node exrgbhsv, exshade, excolmap, Available
@subsection exrgbhsv
@ftable @asis
@item @t{Example exrgbhsv}
...
@xref{key}.@*
@xref{makecol}.@*
@xref{makecol8, makecol32}.@*
@xref{makecol8}.@*
@xref{object_message}.@*
@xref{rgb_map}.@*
@xref{hsv_to_rgb, rgb_to_hsv}.@*
@xref{screen}.@*
@xref{set_color}.@*
@xref{set_color_depth}.@*
@xref{set_gfx_mode}.@*
...
@xref{vline}.@*
@xref{vsync}.@*
@node exshade, exblend, exrgbhsv, Available
@subsection exshade
@ftable @asis
@item @t{Example exshade}
...
@xref{show_mouse}.@*
@xref{textout_ex}.@*
@node exblend, exxfade, exshade, Available
@subsection exblend
@ftable @asis
@item @t{Example exblend}
...
@xref{textprintf_ex}.@*
@xref{vsync}.@*
@node exxfade, exalpha, exblend, Available
@subsection exxfade
@ftable @asis
@item @t{Example exxfade}
...
@xref{set_trans_blender}.@*
@xref{vsync}.@*
@node exalpha, exlights, exxfade, Available
@subsection exalpha
@ftable @asis
@item @t{Example exalpha}
...
@xref{stretch_blit}.@*
@xref{textprintf_ex}.@*
@node exlights, ex3d, exalpha, Available
@subsection exlights
@ftable @asis
@item @t{Example exlights}
...
@xref{fixsqrt}.@*
@xref{fixtoi}.@*
@xref{getr_depth, getb_depth}.@*
@xref{getr_depth, getg_depth}.@*
@xref{getpixel}.@*
@xref{getr_depth}.@*
@xref{hsv_to_rgb}.@*
@xref{install_keyboard}.@*
...
@xref{set_color_depth}.@*
@xref{set_gfx_mode}.@*
@node ex3d, excamera, exlights, Available
@subsection ex3d
@ftable @asis
@item @t{Example ex3d}
...
@xref{POLYTYPE_ATEX}.@*
@xref{POLYTYPE_ATEX_LIT}.@*
@xref{POLYTYPE_ATEX_MASK}.@*
@xref{POLYTYPE_ATEX_MASK_LIT}.@*
@xref{POLYTYPE_ATEX_MASK_TRANS}.@*
@xref{POLYTYPE_ATEX_TRANS}.@*
@xref{POLYTYPE_FLAT}.@*
@xref{POLYTYPE_GCOL}.@*
@xref{POLYTYPE_GRGB}.@*
@xref{POLYTYPE_PTEX}.@*
@xref{POLYTYPE_ATEX_LIT, POLYTYPE_PTEX_LIT}.@*
@xref{POLYTYPE_ATEX_MASK, POLYTYPE_PTEX_MASK}.@*
@xref{POLYTYPE_ATEX_MASK_LIT, POLYTYPE_PTEX_MASK_LIT}.@*
@xref{POLYTYPE_ATEX_MASK_TRANS, POLYTYPE_PTEX_MASK_TRANS}.@*
@xref{POLYTYPE_ATEX_TRANS, POLYTYPE_PTEX_TRANS}.@*
@xref{RGB}.@*
@xref{RGB_MAP}.@*
@xref{SCREEN_W, SCREEN_H}.@*
@xref{SCREEN_W}.@*
...
@xref{textprintf_ex}.@*
@xref{vsync}.@*
@node excamera, exquat, ex3d, Available
@subsection excamera
@ftable @asis
@item @t{Example excamera}
...
@xref{allegro_init}.@*
@xref{allegro_message}.@*
@xref{apply_matrix, apply_matrix_f}.@*
@xref{blit}.@*
@xref{clear_to_color}.@*
@xref{clip3d_f}.@*
@xref{create_bitmap}.@*
...
@xref{destroy_bitmap}.@*
@xref{font}.@*
@xref{get_camera_matrix_f}.@*
@xref{get_vector_rotation_matrix, get_vector_rotation_matrix_f}.@*
@xref{install_int_ex}.@*
@xref{install_keyboard}.@*
@xref{install_timer}.@*
@xref{key}.@*
@xref{key_shifts}.@*
@xref{makecol}.@*
@xref{persp_project, persp_project_f}.@*
@xref{poll_keyboard}.@*
@xref{polygon}.@*
@xref{polygon3d, polygon3d_f}.@*
@xref{rect}.@*
...
@xref{textprintf_ex}.@*
@xref{vsync}.@*
@node exquat, exstars, excamera, Available
@subsection exquat
@ftable @asis
@item @t{Example exquat}
...
@xref{get_camera_matrix_f}.@*
@xref{get_rotation_matrix}.@*
@xref{get_rotation_matrix, get_rotation_matrix_f}.@*
@xref{get_rotation_quat}.@*
@xref{install_keyboard}.@*
@xref{keypressed}.@*
@xref{line}.@*
@xref{matrix_mul, matrix_mul_f}.@*
@xref{palette_color}.@*
@xref{persp_project, persp_project_f}.@*
@xref{quat_interpolate}.@*
@xref{quat_to_matrix}.@*
@xref{readkey}.@*
@xref{release_bitmap}.@*
@xref{rest}.@*
...
@xref{set_projection_viewport}.@*
@xref{textout_ex}.@*
@node exstars, exscn3d, exquat, Available
@subsection exstars
@ftable @asis
@item @t{Example exstars}
...
@xref{triangle}.@*
@xref{vsync}.@*
@node exscn3d, exzbuf, exstars, Available
@subsection exscn3d
@ftable @asis
@item @t{Example exscn3d}
...
@xref{font}.@*
@xref{get_rotation_matrix, get_rotation_matrix_f}.@*
@xref{get_translation_matrix, get_translation_matrix_f}.@*
@xref{gfx_mode_select_ex}.@*
@xref{install_int}.@*
@xref{install_keyboard}.@*
@xref{install_mouse}.@*
...
@xref{palette_color}.@*
@xref{persp_project, persp_project_f}.@*
@xref{polygon_z_normal, polygon_z_normal_f}.@*
@xref{render_scene}.@*
@xref{scene_polygon3d, scene_polygon3d_f}.@*
@xref{screen}.@*
@xref{set_color_depth}.@*
@xref{set_gfx_mode}.@*
@xref{set_palette}.@*
@xref{set_projection_viewport}.@*
@xref{textprintf_ex}.@*
@node exzbuf, exscroll, exscn3d, Available
@subsection exzbuf
@ftable @asis
@item @t{Example exzbuf}
...
@xref{destroy_zbuffer}.@*
@xref{font}.@*
@xref{get_transformation_matrix_f}.@*
@xref{gfx_mode_select_ex}.@*
@xref{install_int}.@*
@xref{install_keyboard}.@*
@xref{install_mouse}.@*
...
@xref{textprintf_ex}.@*
@xref{vsync}.@*
@node exscroll, ex3buf, exzbuf, Available
@subsection exscroll
@ftable @asis
@item @t{Example exscroll}
...
@xref{set_palette}.@*
@xref{vline}.@*
@node ex3buf, ex12bit, exscroll, Available
@subsection ex3buf
@ftable @asis
@item @t{Example ex3buf}
...
@xref{triangle}.@*
@xref{ustrzcpy}.@*
@node ex12bit, exaccel, ex3buf, Available
@subsection ex12bit
@ftable @asis
@item @t{Example ex12bit}
...
@itemize @bullet
@item The horizontal width is halved, so you get resolutions
like 320x480, 400x600, and 512x768.

@item Because each dot is spread over two actual pixels, the
display will be darker than in a normal video mode.

@item Any bitmap data will obviously need converting to the
correct 12 bit format: regular 15 or 16 bit images won't
display correctly...

@item Although this works like a truecolor mode, it is
actually using a 256 color palette, so palette fades are
still possible!

@item This code only works in linear screen modes (don't try
Mode-X).@end itemize
...
@xref{textout_ex}.@*
@xref{textprintf_ex}.@*
@node exaccel, exspline, ex12bit, Available
@subsection exaccel
@ftable @asis
@item @t{Example exaccel}
...
@xref{textout_ex}.@*
@xref{textprintf_ex}.@*
@node exspline, exsyscur, exaccel, Available
@subsection exspline
@ftable @asis
@item @t{Example exspline}
...
@xref{vsync}.@*
@xref{xor_mode}.@*
@node exsyscur, exupdate, exspline, Available
@subsection exsyscur
@ftable @asis
@item @t{Example exsyscur}
...
@xref{text_height}.@*
@xref{textprintf_centre_ex}.@*
@node exupdate, exswitch, exsyscur, Available
@subsection exupdate
@ftable @asis
@item @t{Example exupdate}
...
@xref{vsync}.@*
@xref{xor_mode}.@*
@node exswitch, exstream, exupdate, Available
@subsection exswitch
@ftable @asis
@item @t{Example exswitch}
...
@xref{textout_centre_ex}.@*
@xref{textprintf_centre_ex}.@*
@node exstream, expackf, exswitch, Available
@subsection exstream
@ftable @asis
@item @t{Example exstream}
...
@xref{voice_start}.@*
@xref{voice_stop}.@*
@node expackf, , exstream, Available
@subsection expackf
@ftable @asis
@item @t{Example expackf}
...
@xref{textprintf_centre_ex}.@*
@xref{textprintf_ex}.@*
@node Tools, Additional, Available, Top
@chapter Tools
@menu
* Additional::              Additional programs included with Allegro
@end menu
@node Additional, Community, Tools, Tools
@section Additional programs included with Allegro
...
@node Community, Conclusion, Additional, Top
@chapter Community
...
@node Conclusion, Index, Community, Top
@chapter Conclusion
